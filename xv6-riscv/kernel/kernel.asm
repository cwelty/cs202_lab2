...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  while(n > 0){
    ...
    80000214:	416080e7          	jalr	1046(ra) # 80002626 <either_copyout>
...
consoleintr(int c)
{
  ...
  switch(c){
    ...
    8000044a:	fc8080e7          	jalr	-56(ra) # 8000240e <wakeup>
    ...
    80000850:	06e78c63          	beq	a5,a4,800008c8 <uartstart+0x88>
{
    ...
    800008a4:	b6e080e7          	jalr	-1170(ra) # 8000240e <wakeup>
...
forkret(void)
{
  ...
  usertrapret();
    ...
    80001ab0:	d7e080e7          	jalr	-642(ra) # 8000282a <usertrapret>
}
    ...
    80001aca:	b18080e7          	jalr	-1256(ra) # 800035de <fsinit>
...
0000000080001d3a <userinit>:
{
  ...
  p->cwd = namei("/");
    ...
    80001d9c:	274080e7          	jalr	628(ra) # 8000400c <namei>
...
0000000080001e54 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    80001ef6:	7b0080e7          	jalr	1968(ra) # 800046a2 <filedup>
  ...
  np->cwd = idup(p->cwd);
    ...
    80001f18:	904080e7          	jalr	-1788(ra) # 80003818 <idup>
...
for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001fe6:	a0e1                	j	800020ae <scheduler+0x11e>
            max_stride = p->pass;
...
if (p->state == RUNNABLE){
    ...
    8000206c:	02f71c63          	bne	a4,a5,800020a4 <scheduler+0x114>
    p->pass = p->pass + p->stride;
    80002070:	18893783          	ld	a5,392(s2)
    80002074:	18093703          	ld	a4,384(s2)
    80002078:	97ba                	add	a5,a5,a4
    8000207a:	18f93423          	sd	a5,392(s2)
    p->state = RUNNING;
    8000207e:	4791                	li	a5,4
    80002080:	00f92c23          	sw	a5,24(s2)
    p->ticks += 1;
    80002084:	17893783          	ld	a5,376(s2)
    80002088:	0785                	addi	a5,a5,1
    8000208a:	16f93c23          	sd	a5,376(s2)
    c->proc = p;
    8000208e:	032d3823          	sd	s2,48(s10)
    swtch(&c->context, &p->context);
    80002092:	06090593          	addi	a1,s2,96
    80002096:	856e                	mv	a0,s11
    80002098:	00000097          	auipc	ra,0x0
    8000209c:	6e8080e7          	jalr	1768(ra) # 80002780 <swtch>
    c->proc = 0;
    800020a0:	020d3823          	sd	zero,48(s10)
    release(&p->lock);
    800020a4:	8526                	mv	a0,s1
    800020a6:	fffff097          	auipc	ra,0xfffff
    800020aa:	bf2080e7          	jalr	-1038(ra) # 80000c98 <release>
    struct proc *minProc = 0;
    800020ae:	4c81                	li	s9,0
if(p->state == RUNNABLE) {
    800020b0:	4a0d                	li	s4,3
    800020b2:	b771                	j	8000203e <scheduler+0xae>

00000000800020b4 <set_tickets>:
{
    ...
    800020c6:	964080e7          	jalr	-1692(ra) # 80001a26 <myproc>
    800020ca:	84aa                	mv	s1,a0
	acquire(&p->lock);
    800020cc:	fffff097          	auipc	ra,0xfffff
    800020d0:	b18080e7          	jalr	-1256(ra) # 80000be4 <acquire>
	p->tickets = tickets;
    800020d4:	1724b823          	sd	s2,368(s1)
  p->stride = MAX_STRIDE_C /  p->tickets;
    800020d8:	66a9                	lui	a3,0xa
    800020da:	c4068693          	addi	a3,a3,-960 # 9c40 <_entry-0x7fff63c0>
    800020de:	0326d6b3          	divu	a3,a3,s2
    800020e2:	18d4b023          	sd	a3,384(s1)
    printf("%d has been given %d tickets for a stride of %d\n", p->name, tickets, p->stride);
    800020e6:	864a                	mv	a2,s2
    800020e8:	15848593          	addi	a1,s1,344
...
0000000080002112 <sched_statistics>:
{
  ...
  struct proc *p = myproc();
    ...
    80002122:	908080e7          	jalr	-1784(ra) # 80001a26 <myproc>
    80002126:	84aa                	mv	s1,a0
  acquire(&p->lock);
    80002128:	fffff097          	auipc	ra,0xfffff
    8000212c:	abc080e7          	jalr	-1348(ra) # 80000be4 <acquire>
  uint64 tickets = p->tickets;
    80002130:	1704b903          	ld	s2,368(s1)
  printf("Current process\'s number of ticks: %d\n", ticks);
    80002134:	1784b583          	ld	a1,376(s1)
    80002138:	00006517          	auipc	a0,0x6
    8000213c:	1c050513          	addi	a0,a0,448 # 800082f8 <digits+0x2b8>
    80002140:	ffffe097          	auipc	ra,0xffffe
    80002144:	448080e7          	jalr	1096(ra) # 80000588 <printf>
  printf("Current process\'s number of tickets: %d\n\n", tickets);
    80002148:	85ca                	mv	a1,s2
    8000214a:	00006517          	auipc	a0,0x6
    8000214e:	1d650513          	addi	a0,a0,470 # 80008320 <digits+0x2e0>
    80002152:	ffffe097          	auipc	ra,0xffffe
    80002156:	436080e7          	jalr	1078(ra) # 80000588 <printf>
  release(&p->lock);
...
0000000080002170 <sched>:
{
  ...
  struct proc *p = myproc();
    ...
    80002182:	8a8080e7          	jalr	-1880(ra) # 80001a26 <myproc>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    800021e8:	59c080e7          	jalr	1436(ra) # 80002780 <swtch>
...
0000000080002246 <yield>:
{
  ...
  struct proc *p = myproc();
    ...
    80002254:	7d6080e7          	jalr	2006(ra) # 80001a26 <myproc>
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  struct proc *p = myproc();
    ...
    80002298:	792080e7          	jalr	1938(ra) # 80001a26 <myproc>
...
00000000800022e6 <wait>:
{
  ...
  struct proc *p = myproc();
    ...
    80002304:	726080e7          	jalr	1830(ra) # 80001a26 <myproc>
  ...
  acquire(&wait_lock);
    ...
    for(np = proc; np < &proc[NPROC]; np++){
    800023a0:	19048493          	addi	s1,s1,400
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    8000242e:	00015917          	auipc	s2,0x15
    80002432:	6a290913          	addi	s2,s2,1698 # 80017ad0 <tickslock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    80002446:	19048493          	addi	s1,s1,400
    8000244a:	03248463          	beq	s1,s2,80002472 <wakeup+0x64>
    if(p != myproc()){
    8000244e:	fffff097          	auipc	ra,0xfffff
    80002452:	5d8080e7          	jalr	1496(ra) # 80001a26 <myproc>
    80002456:	fea488e3          	beq	s1,a0,80002446 <wakeup+0x38>
      acquire(&p->lock);
    8000245a:	8526                	mv	a0,s1
    8000245c:	ffffe097          	auipc	ra,0xffffe
    80002460:	788080e7          	jalr	1928(ra) # 80000be4 <acquire>
      if(p->state == SLEEPING && p->chan == chan) {
    80002464:	4c9c                	lw	a5,24(s1)
    80002466:	fd379be3          	bne	a5,s3,8000243c <wakeup+0x2e>
    8000246a:	709c                	ld	a5,32(s1)
    8000246c:	fd4798e3          	bne	a5,s4,8000243c <wakeup+0x2e>
...
0000000080002484 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    8000249a:	23a48493          	addi	s1,s1,570 # 800116d0 <proc>
      pp->parent = initproc;
    8000249e:	00007a17          	auipc	s4,0x7
    800024a2:	b8aa0a13          	addi	s4,s4,-1142 # 80009028 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    800024a6:	00015997          	auipc	s3,0x15
    800024aa:	62a98993          	addi	s3,s3,1578 # 80017ad0 <tickslock>
...
00000000800024de <exit>:
{
  ...
  struct proc *p = myproc();
    ...
    800024f4:	536080e7          	jalr	1334(ra) # 80001a26 <myproc>
    800024f8:	89aa                	mv	s3,a0
  if(p == initproc)
    800024fa:	00007797          	auipc	a5,0x7
    800024fe:	b2e7b783          	ld	a5,-1234(a5) # 80009028 <initproc>
    80002502:	0d050493          	addi	s1,a0,208
    80002506:	15050913          	addi	s2,a0,336
    8000250a:	02a79363          	bne	a5,a0,80002530 <exit+0x52>
    panic("init exiting");
    8000250e:	00006517          	auipc	a0,0x6
    80002512:	e8a50513          	addi	a0,a0,-374 # 80008398 <digits+0x358>
    80002516:	ffffe097          	auipc	ra,0xffffe
    8000251a:	028080e7          	jalr	40(ra) # 8000053e <panic>
      fileclose(f);
    8000251e:	00002097          	auipc	ra,0x2
    80002522:	1d6080e7          	jalr	470(ra) # 800046f4 <fileclose>
      p->ofile[fd] = 0;
  ...
  begin_op();
    ...
    8000253a:	cf2080e7          	jalr	-782(ra) # 80004228 <begin_op>
  iput(p->cwd);
    8000253e:	1509b503          	ld	a0,336(s3)
    80002542:	00001097          	auipc	ra,0x1
    80002546:	4ce080e7          	jalr	1230(ra) # 80003a10 <iput>
  end_op();
    8000254a:	00002097          	auipc	ra,0x2
    8000254e:	d5e080e7          	jalr	-674(ra) # 800042a8 <end_op>
  p->cwd = 0;
    80002552:	1409b823          	sd	zero,336(s3)
  acquire(&wait_lock);
    80002556:	0000f497          	auipc	s1,0xf
    8000255a:	d6248493          	addi	s1,s1,-670 # 800112b8 <wait_lock>
    8000255e:	8526                	mv	a0,s1
    80002560:	ffffe097          	auipc	ra,0xffffe
    80002564:	684080e7          	jalr	1668(ra) # 80000be4 <acquire>
  reparent(p);
  ...
  release(&wait_lock);
    ...
    80002598:	704080e7          	jalr	1796(ra) # 80000c98 <release>
  sched();
    8000259c:	00000097          	auipc	ra,0x0
    800025a0:	bd4080e7          	jalr	-1068(ra) # 80002170 <sched>
  panic("zombie exit");
    800025a4:	00006517          	auipc	a0,0x6
    800025a8:	e0450513          	addi	a0,a0,-508 # 800083a8 <digits+0x368>
    800025ac:	ffffe097          	auipc	ra,0xffffe
    800025b0:	f92080e7          	jalr	-110(ra) # 8000053e <panic>

00000000800025b4 <kill>:
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800025c8:	10c48493          	addi	s1,s1,268 # 800116d0 <proc>
    800025cc:	00015997          	auipc	s3,0x15
    800025d0:	50498993          	addi	s3,s3,1284 # 80017ad0 <tickslock>
    acquire(&p->lock);
    800025d4:	8526                	mv	a0,s1
    800025d6:	ffffe097          	auipc	ra,0xffffe
    800025da:	60e080e7          	jalr	1550(ra) # 80000be4 <acquire>
    if(p->pid == pid){
    800025de:	589c                	lw	a5,48(s1)
    800025e0:	01278d63          	beq	a5,s2,800025fa <kill+0x46>
        p->state = RUNNABLE;
      }
      release(&p->lock);
      return 0;
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800025f2:	ff3491e3          	bne	s1,s3,800025d4 <kill+0x20>
  }
  return -1;
    800025f6:	557d                	li	a0,-1
    800025f8:	a829                	j	80002612 <kill+0x5e>
      p->killed = 1;
    800025fa:	4785                	li	a5,1
    800025fc:	d49c                	sw	a5,40(s1)
      if(p->state == SLEEPING){
    800025fe:	4c98                	lw	a4,24(s1)
    80002600:	4789                	li	a5,2
    80002602:	00f70f63          	beq	a4,a5,80002620 <kill+0x6c>
      release(&p->lock);
    80002606:	8526                	mv	a0,s1
    80002608:	ffffe097          	auipc	ra,0xffffe
    8000260c:	690080e7          	jalr	1680(ra) # 80000c98 <release>
      return 0;
    ...
    80002622:	cc9c                	sw	a5,24(s1)
    80002624:	b7cd                	j	80002606 <kill+0x52>
...
either_copyout(int user_dst, uint64 dst, void *src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    80002642:	3e8080e7          	jalr	1000(ra) # 80001a26 <myproc>
  if(user_dst){
    ...
    80002674:	6d0080e7          	jalr	1744(ra) # 80000d40 <memmove>
    return 0;
...
either_copyin(void *dst, int user_src, uint64 src, uint64 len)
{
  ...
  struct proc *p = myproc();
    ...
    80002698:	392080e7          	jalr	914(ra) # 80001a26 <myproc>
  if(user_src){
    ...
    800026aa:	058080e7          	jalr	88(ra) # 800016fe <copyin>
  } else {
...
procdump(void)
{
  ...
  printf("\n");
    ...
    800026ec:	c6050513          	addi	a0,a0,-928 # 80008348 <digits+0x308>
    800026f0:	ffffe097          	auipc	ra,0xffffe
    800026f4:	e98080e7          	jalr	-360(ra) # 80000588 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    800026f8:	0000f497          	auipc	s1,0xf
    800026fc:	13048493          	addi	s1,s1,304 # 80011828 <proc+0x158>
    80002700:	00015917          	auipc	s2,0x15
    80002704:	52890913          	addi	s2,s2,1320 # 80017c28 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    8000270e:	cae98993          	addi	s3,s3,-850 # 800083b8 <digits+0x378>
    printf("%d %s %s", p->pid, state, p->name);
    80002712:	00006a97          	auipc	s5,0x6
    80002716:	caea8a93          	addi	s5,s5,-850 # 800083c0 <digits+0x380>
    printf("\n");
    8000271a:	00006a17          	auipc	s4,0x6
    8000271e:	c2ea0a13          	addi	s4,s4,-978 # 80008348 <digits+0x308>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
    80002722:	00006b97          	auipc	s7,0x6
    80002726:	cd6b8b93          	addi	s7,s7,-810 # 800083f8 <states.1757>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800027f6:	c3658593          	addi	a1,a1,-970 # 80008428 <states.1757+0x30>
    800027fa:	00015517          	auipc	a0,0x15
    800027fe:	2d650513          	addi	a0,a0,726 # 80017ad0 <tickslock>
...
trapinithart(void)
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    8000281c:	4f878793          	addi	a5,a5,1272 # 80005d10 <kernelvec>
...
usertrapret(void)
{
  ...
  struct proc *p = myproc();
    ...
    80002836:	1f4080e7          	jalr	500(ra) # 80001a26 <myproc>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    800028d6:	1fe48493          	addi	s1,s1,510 # 80017ad0 <tickslock>
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002944:	4d8080e7          	jalr	1240(ra) # 80005e18 <plic_claim>
    ...
    80002960:	ad450513          	addi	a0,a0,-1324 # 80008430 <states.1757+0x38>
    ...
    80002972:	4ce080e7          	jalr	1230(ra) # 80005e3c <plic_complete>
    return 1;
    ...
    80002988:	998080e7          	jalr	-1640(ra) # 8000631c <virtio_disk_intr>
    8000298c:	b7c5                	j	8000296c <devintr+0x5e>
    if(cpuid() == 0){
    8000298e:	fffff097          	auipc	ra,0xfffff
    80002992:	06c080e7          	jalr	108(ra) # 800019fa <cpuid>
...
00000000800029b0 <usertrap>:
{
  ...
  asm volatile("csrw stvec, %0" : : "r" (x));
    ...
    800029ca:	34a78793          	addi	a5,a5,842 # 80005d10 <kernelvec>
    800029ce:	10579073          	csrw	stvec,a5
  struct proc *p = myproc();
    800029d2:	fffff097          	auipc	ra,0xfffff
    800029d6:	054080e7          	jalr	84(ra) # 80001a26 <myproc>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80002a5e:	a1650513          	addi	a0,a0,-1514 # 80008470 <states.1757+0x78>
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002a76:	a2e50513          	addi	a0,a0,-1490 # 800084a0 <states.1757+0xa8>
...
0000000080002aa4 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002af6:	9ce50513          	addi	a0,a0,-1586 # 800084c0 <states.1757+0xc8>
    80002afa:	ffffe097          	auipc	ra,0xffffe
    80002afe:	a44080e7          	jalr	-1468(ra) # 8000053e <panic>
    panic("kerneltrap: interrupts enabled");
    80002b02:	00006517          	auipc	a0,0x6
    80002b06:	9e650513          	addi	a0,a0,-1562 # 800084e8 <states.1757+0xf0>
    ...
    80002b18:	9f450513          	addi	a0,a0,-1548 # 80008508 <states.1757+0x110>
  ...
  if(which_dev == 2 && myproc() != 0 && myproc()->state == RUNNING)
    ...
    80002b6a:	6e0080e7          	jalr	1760(ra) # 80002246 <yield>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002b90:	9dc70713          	addi	a4,a4,-1572 # 80008568 <states.1757+0x170>
  ...
  panic("argraw");
    ...
    80002bcc:	97850513          	addi	a0,a0,-1672 # 80008540 <states.1757+0x148>
...
0000000080002bd8 <fetchaddr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002bec:	e3e080e7          	jalr	-450(ra) # 80001a26 <myproc>
...
0000000080002c2a <fetchstr>:
{
  ...
  struct proc *p = myproc();
    ...
    80002c42:	de8080e7          	jalr	-536(ra) # 80001a26 <myproc>
...
syscall(void)
{
  ...
  struct proc *p = myproc();
    ...
    80002cf6:	d34080e7          	jalr	-716(ra) # 80001a26 <myproc>
    80002cfa:	84aa                	mv	s1,a0
  p->syscallCount++;
    80002cfc:	16853783          	ld	a5,360(a0)
    80002d00:	0785                	addi	a5,a5,1
    80002d02:	16f53423          	sd	a5,360(a0)
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002d14:	4755                	li	a4,21
    80002d16:	00f76f63          	bltu	a4,a5,80002d34 <syscall+0x4e>
    80002d1a:	00369713          	slli	a4,a3,0x3
    80002d1e:	00006797          	auipc	a5,0x6
    80002d22:	86278793          	addi	a5,a5,-1950 # 80008580 <syscalls>
    80002d26:	97ba                	add	a5,a5,a4
    80002d28:	639c                	ld	a5,0(a5)
    80002d2a:	c789                	beqz	a5,80002d34 <syscall+0x4e>
    p->trapframe->a0 = syscalls[num]();
    80002d2c:	9782                	jalr	a5
    80002d2e:	06a93823          	sd	a0,112(s2)
    80002d32:	a839                	j	80002d50 <syscall+0x6a>
  } else {
    printf("%d %s: unknown sys call %d\n",
    80002d34:	15848613          	addi	a2,s1,344
    80002d38:	588c                	lw	a1,48(s1)
    80002d3a:	00006517          	auipc	a0,0x6
    80002d3e:	80e50513          	addi	a0,a0,-2034 # 80008548 <states.1757+0x150>
...
uint64 sys_info(void){
    ...
    80002d6e:	f08080e7          	jalr	-248(ra) # 80002c72 <argint>
	printf("The value of n is %d\n", n);
    80002d72:	fec42583          	lw	a1,-20(s0)
    80002d76:	00006517          	auipc	a0,0x6
    80002d7a:	8c250513          	addi	a0,a0,-1854 # 80008638 <syscalls+0xb8>
    80002d7e:	ffffe097          	auipc	ra,0xffffe
    80002d82:	80a080e7          	jalr	-2038(ra) # 80000588 <printf>
	if (n == 1){
    80002d86:	fec42783          	lw	a5,-20(s0)
    80002d8a:	4705                	li	a4,1
    80002d8c:	00e78d63          	beq	a5,a4,80002da6 <sys_info+0x4a>
		process_count_print();
	}
	else if (n == 2){
    80002d90:	4709                	li	a4,2
    80002d92:	00e78f63          	beq	a5,a4,80002db0 <sys_info+0x54>
		syscall_count_print();
	}
  else if (n == 3){
    80002d96:	470d                	li	a4,3
    80002d98:	02e78163          	beq	a5,a4,80002dba <sys_info+0x5e>
    ...
    80002daa:	b2e080e7          	jalr	-1234(ra) # 800018d4 <process_count_print>
    80002dae:	b7fd                	j	80002d9c <sys_info+0x40>
		syscall_count_print();
    80002db0:	fffff097          	auipc	ra,0xfffff
    80002db4:	cae080e7          	jalr	-850(ra) # 80001a5e <syscall_count_print>
    80002db8:	b7d5                	j	80002d9c <sys_info+0x40>
    mem_pages_count_print();
    80002dba:	fffff097          	auipc	ra,0xfffff
    80002dbe:	b5e080e7          	jalr	-1186(ra) # 80001918 <mem_pages_count_print>
    80002dc2:	bfe9                	j	80002d9c <sys_info+0x40>
...
sys_exit(void)
{
  ...
  if(argint(0, &n) < 0)
    ...
    80002dd6:	ea0080e7          	jalr	-352(ra) # 80002c72 <argint>
    return -1;
    80002dda:	57fd                	li	a5,-1
  if(argint(0, &n) < 0)
    80002ddc:	00054963          	bltz	a0,80002dee <sys_exit+0x2a>
  exit(n);
    80002de0:	fec42503          	lw	a0,-20(s0)
    80002de4:	fffff097          	auipc	ra,0xfffff
    80002de8:	6fa080e7          	jalr	1786(ra) # 800024de <exit>
...
sys_getpid(void)
{
  ...
  return myproc()->pid;
    ...
    80002e04:	c26080e7          	jalr	-986(ra) # 80001a26 <myproc>
}
    80002e08:	5908                	lw	a0,48(a0)
    80002e0a:	60a2                	ld	ra,8(sp)
    80002e0c:	6402                	ld	s0,0(sp)
    80002e0e:	0141                	addi	sp,sp,16
    80002e10:	8082                	ret

0000000080002e12 <sys_fork>:
...
sys_fork(void)
{
  ...
  return fork();
    ...
    80002e1e:	03a080e7          	jalr	58(ra) # 80001e54 <fork>
}
...
sys_wait(void)
{
  ...
  uint64 p;
  if(argaddr(0, &p) < 0)
    80002e32:	fe840593          	addi	a1,s0,-24
    80002e36:	4501                	li	a0,0
    80002e38:	00000097          	auipc	ra,0x0
    80002e3c:	e5c080e7          	jalr	-420(ra) # 80002c94 <argaddr>
    80002e40:	87aa                	mv	a5,a0
    return -1;
    80002e42:	557d                	li	a0,-1
  if(argaddr(0, &p) < 0)
    80002e44:	0007c863          	bltz	a5,80002e54 <sys_wait+0x2a>
  return wait(p);
    80002e48:	fe843503          	ld	a0,-24(s0)
    80002e4c:	fffff097          	auipc	ra,0xfffff
    80002e50:	49a080e7          	jalr	1178(ra) # 800022e6 <wait>
}
...
sys_sbrk(void)
{
  ...
  if(argint(0, &n) < 0)
    80002e66:	fdc40593          	addi	a1,s0,-36
    80002e6a:	4501                	li	a0,0
    80002e6c:	00000097          	auipc	ra,0x0
    80002e70:	e06080e7          	jalr	-506(ra) # 80002c72 <argint>
    80002e74:	87aa                	mv	a5,a0
    return -1;
    80002e76:	557d                	li	a0,-1
  if(argint(0, &n) < 0)
    80002e78:	0207c063          	bltz	a5,80002e98 <sys_sbrk+0x3c>
  addr = myproc()->sz;
    80002e7c:	fffff097          	auipc	ra,0xfffff
    80002e80:	baa080e7          	jalr	-1110(ra) # 80001a26 <myproc>
    80002e84:	4524                	lw	s1,72(a0)
  if(growproc(n) < 0)
    80002e86:	fdc42503          	lw	a0,-36(s0)
    80002e8a:	fffff097          	auipc	ra,0xfffff
    80002e8e:	f56080e7          	jalr	-170(ra) # 80001de0 <growproc>
    80002e92:	00054863          	bltz	a0,80002ea2 <sys_sbrk+0x46>
    return -1;
  return addr;
    ...
    80002ea4:	bfd5                	j	80002e98 <sys_sbrk+0x3c>
...
sys_sleep(void)
{
    ...
    80002eae:	f04a                	sd	s2,32(sp)
    80002eb0:	ec4e                	sd	s3,24(sp)
  ...
  if(argint(0, &n) < 0)
    ...
    80002ebe:	db8080e7          	jalr	-584(ra) # 80002c72 <argint>
    return -1;
    80002ec2:	57fd                	li	a5,-1
  if(argint(0, &n) < 0)
    80002ec4:	06054563          	bltz	a0,80002f2e <sys_sleep+0x88>
  acquire(&tickslock);
    80002ec8:	00015517          	auipc	a0,0x15
    80002ecc:	c0850513          	addi	a0,a0,-1016 # 80017ad0 <tickslock>
    80002ed0:	ffffe097          	auipc	ra,0xffffe
    80002ed4:	d14080e7          	jalr	-748(ra) # 80000be4 <acquire>
  ticks0 = ticks;
    80002ed8:	00006917          	auipc	s2,0x6
    80002edc:	15892903          	lw	s2,344(s2) # 80009030 <ticks>
  while(ticks - ticks0 < n){
    80002ee0:	fcc42783          	lw	a5,-52(s0)
    80002ee4:	cf85                	beqz	a5,80002f1c <sys_sleep+0x76>
    if(myproc()->killed){
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
    80002ee6:	00015997          	auipc	s3,0x15
    80002eea:	bea98993          	addi	s3,s3,-1046 # 80017ad0 <tickslock>
    80002eee:	00006497          	auipc	s1,0x6
    80002ef2:	14248493          	addi	s1,s1,322 # 80009030 <ticks>
    if(myproc()->killed){
    80002ef6:	fffff097          	auipc	ra,0xfffff
    80002efa:	b30080e7          	jalr	-1232(ra) # 80001a26 <myproc>
    80002efe:	551c                	lw	a5,40(a0)
    80002f00:	ef9d                	bnez	a5,80002f3e <sys_sleep+0x98>
    sleep(&ticks, &tickslock);
    80002f02:	85ce                	mv	a1,s3
    80002f04:	8526                	mv	a0,s1
    80002f06:	fffff097          	auipc	ra,0xfffff
    80002f0a:	37c080e7          	jalr	892(ra) # 80002282 <sleep>
  while(ticks - ticks0 < n){
    80002f0e:	409c                	lw	a5,0(s1)
    80002f10:	412787bb          	subw	a5,a5,s2
    80002f14:	fcc42703          	lw	a4,-52(s0)
    80002f18:	fce7efe3          	bltu	a5,a4,80002ef6 <sys_sleep+0x50>
  }
  release(&tickslock);
    80002f1c:	00015517          	auipc	a0,0x15
    80002f20:	bb450513          	addi	a0,a0,-1100 # 80017ad0 <tickslock>
    80002f24:	ffffe097          	auipc	ra,0xffffe
    80002f28:	d74080e7          	jalr	-652(ra) # 80000c98 <release>
  return 0;
...
sys_kill(void)
{
  ...
  if(argint(0, &pid) < 0)
    ...
    80002f64:	d12080e7          	jalr	-750(ra) # 80002c72 <argint>
    80002f68:	87aa                	mv	a5,a0
    return -1;
    80002f6a:	557d                	li	a0,-1
  if(argint(0, &pid) < 0)
    80002f6c:	0007c863          	bltz	a5,80002f7c <sys_kill+0x2a>
  return kill(pid);
    80002f70:	fec42503          	lw	a0,-20(s0)
    80002f74:	fffff097          	auipc	ra,0xfffff
    80002f78:	640080e7          	jalr	1600(ra) # 800025b4 <kill>
}
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002f92:	b4250513          	addi	a0,a0,-1214 # 80017ad0 <tickslock>
    80002f96:	ffffe097          	auipc	ra,0xffffe
    80002f9a:	c4e080e7          	jalr	-946(ra) # 80000be4 <acquire>
  xticks = ticks;
    80002f9e:	00006497          	auipc	s1,0x6
    80002fa2:	0924a483          	lw	s1,146(s1) # 80009030 <ticks>
  release(&tickslock);
    80002fa6:	00015517          	auipc	a0,0x15
    80002faa:	b2a50513          	addi	a0,a0,-1238 # 80017ad0 <tickslock>
    80002fae:	ffffe097          	auipc	ra,0xffffe
    80002fb2:	cea080e7          	jalr	-790(ra) # 80000c98 <release>
  return xticks;
}
    80002fb6:	02049513          	slli	a0,s1,0x20
    80002fba:	9101                	srli	a0,a0,0x20
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002fda:	67a58593          	addi	a1,a1,1658 # 80008650 <syscalls+0xd0>
    80002fde:	00015517          	auipc	a0,0x15
    80002fe2:	b0a50513          	addi	a0,a0,-1270 # 80017ae8 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002ff2:	afa78793          	addi	a5,a5,-1286 # 8001fae8 <bcache+0x8000>
    80002ff6:	0001d717          	auipc	a4,0x1d
    80002ffa:	d5a70713          	addi	a4,a4,-678 # 8001fd50 <bcache+0x8268>
    80002ffe:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80003002:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80003006:	00015497          	auipc	s1,0x15
    8000300a:	afa48493          	addi	s1,s1,-1286 # 80017b00 <bcache+0x18>
    ...
    80003016:	646a0a13          	addi	s4,s4,1606 # 80008658 <syscalls+0xd8>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000306a:	a8250513          	addi	a0,a0,-1406 # 80017ae8 <bcache>
    8000306e:	ffffe097          	auipc	ra,0xffffe
    80003072:	b76080e7          	jalr	-1162(ra) # 80000be4 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80003076:	0001d497          	auipc	s1,0x1d
    8000307a:	d2a4b483          	ld	s1,-726(s1) # 8001fda0 <bcache+0x82b8>
    8000307e:	0001d797          	auipc	a5,0x1d
    80003082:	cd278793          	addi	a5,a5,-814 # 8001fd50 <bcache+0x8268>
    ...
    800030aa:	a4250513          	addi	a0,a0,-1470 # 80017ae8 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    800030c4:	0001d497          	auipc	s1,0x1d
    800030c8:	cd44b483          	ld	s1,-812(s1) # 8001fd98 <bcache+0x82b0>
    800030cc:	0001d797          	auipc	a5,0x1d
    800030d0:	c8478793          	addi	a5,a5,-892 # 8001fd50 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    800030e8:	57c50513          	addi	a0,a0,1404 # 80008660 <syscalls+0xe0>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80003178:	50450513          	addi	a0,a0,1284 # 80008678 <syscalls+0xf8>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    800031b0:	93c50513          	addi	a0,a0,-1732 # 80017ae8 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    800031d8:	91478793          	addi	a5,a5,-1772 # 8001fae8 <bcache+0x8000>
    800031dc:	2b87b703          	ld	a4,696(a5)
    800031e0:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    800031e2:	0001d717          	auipc	a4,0x1d
    800031e6:	b6e70713          	addi	a4,a4,-1170 # 8001fd50 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    800031fa:	8f250513          	addi	a0,a0,-1806 # 80017ae8 <bcache>
    ...
    80003216:	46e50513          	addi	a0,a0,1134 # 80008680 <syscalls+0x100>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80003232:	8ba50513          	addi	a0,a0,-1862 # 80017ae8 <bcache>
  ...
  release(&bcache.lock);
    ...
    80003248:	8a450513          	addi	a0,a0,-1884 # 80017ae8 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000326e:	87e50513          	addi	a0,a0,-1922 # 80017ae8 <bcache>
  ...
  release(&bcache.lock);
    80003280:	00015517          	auipc	a0,0x15
    80003284:	86850513          	addi	a0,a0,-1944 # 80017ae8 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    800032b0:	f187a783          	lw	a5,-232(a5) # 800201c4 <sb+0x1c>
  ...
  brelse(bp);
    ...
    8000330a:	38250513          	addi	a0,a0,898 # 80008688 <syscalls+0x108>
...
0000000080003316 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    80003334:	e7c7a783          	lw	a5,-388(a5) # 800201ac <sb+0x4>
    80003338:	cbd1                	beqz	a5,800033cc <balloc+0xb6>
    8000333a:	8baa                	mv	s7,a0
    8000333c:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    8000333e:	0001db17          	auipc	s6,0x1d
    80003342:	e6ab0b13          	addi	s6,s6,-406 # 800201a8 <sb>
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    800033b8:	0586c683          	lbu	a3,88(a3)
  ...
  panic("balloc: out of blocks");
    ...
    800033d0:	2d450513          	addi	a0,a0,724 # 800086a0 <syscalls+0x120>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    80003516:	1a650513          	addi	a0,a0,422 # 800086b8 <syscalls+0x138>
...
0000000080003522 <iget>:
{
  ...
  acquire(&itable.lock);
    80003536:	0001d517          	auipc	a0,0x1d
    8000353a:	c9250513          	addi	a0,a0,-878 # 800201c8 <itable>
    8000353e:	ffffd097          	auipc	ra,0xffffd
    80003542:	6a6080e7          	jalr	1702(ra) # 80000be4 <acquire>
  empty = 0;
    80003546:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80003548:	0001d497          	auipc	s1,0x1d
    8000354c:	c9848493          	addi	s1,s1,-872 # 800201e0 <itable+0x18>
    80003550:	0001e697          	auipc	a3,0x1e
    80003554:	72068693          	addi	a3,a3,1824 # 80021c70 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003580:	c4c50513          	addi	a0,a0,-948 # 800201c8 <itable>
  ...
  release(&itable.lock);
    ...
    800035b0:	c1c50513          	addi	a0,a0,-996 # 800201c8 <itable>
    ...
    800035d2:	10250513          	addi	a0,a0,258 # 800086d0 <syscalls+0x150>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    800035fa:	0001d997          	auipc	s3,0x1d
    800035fe:	bae98993          	addi	s3,s3,-1106 # 800201a8 <sb>
  ...
  initlog(dev, &sb);
    8000362e:	0001d597          	auipc	a1,0x1d
    80003632:	b7a58593          	addi	a1,a1,-1158 # 800201a8 <sb>
    ...
    80003652:	09250513          	addi	a0,a0,146 # 800086e0 <syscalls+0x160>
...
000000008000365e <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003670:	08c58593          	addi	a1,a1,140 # 800086f8 <syscalls+0x178>
    80003674:	0001d517          	auipc	a0,0x1d
    80003678:	b5450513          	addi	a0,a0,-1196 # 800201c8 <itable>
    8000367c:	ffffd097          	auipc	ra,0xffffd
    80003680:	4d8080e7          	jalr	1240(ra) # 80000b54 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003684:	0001d497          	auipc	s1,0x1d
    80003688:	b6c48493          	addi	s1,s1,-1172 # 800201f0 <itable+0x28>
    8000368c:	0001e997          	auipc	s3,0x1e
    80003690:	5f498993          	addi	s3,s3,1524 # 80021c80 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003694:	00005917          	auipc	s2,0x5
    80003698:	06c90913          	addi	s2,s2,108 # 80008700 <syscalls+0x180>
...
00000000800036be <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    800036d4:	0001d717          	auipc	a4,0x1d
    800036d8:	ae072703          	lw	a4,-1312(a4) # 800201b4 <sb+0xc>
    ...
    800036e8:	0001da17          	auipc	s4,0x1d
    800036ec:	ac0a0a13          	addi	s4,s4,-1344 # 800201a8 <sb>
  ...
  panic("ialloc: no inodes");
    ...
    80003736:	fd650513          	addi	a0,a0,-42 # 80008708 <syscalls+0x188>
...
000000008000378c <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    800037a4:	a205a583          	lw	a1,-1504(a1) # 800201c0 <sb+0x18>
...
0000000080003818 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    80003828:	9a450513          	addi	a0,a0,-1628 # 800201c8 <itable>
  ...
  release(&itable.lock);
    ...
    8000383e:	98e50513          	addi	a0,a0,-1650 # 800201c8 <itable>
...
0000000080003856 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    8000388a:	e9a50513          	addi	a0,a0,-358 # 80008720 <syscalls+0x1a0>
    ...
    800038a0:	9245a583          	lw	a1,-1756(a1) # 800201c0 <sb+0x18>
    ...
    8000390c:	e2050513          	addi	a0,a0,-480 # 80008728 <syscalls+0x1a8>
...
0000000080003918 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80003958:	de450513          	addi	a0,a0,-540 # 80008738 <syscalls+0x1b8>
...
0000000080003a10 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    80003a22:	7aa50513          	addi	a0,a0,1962 # 800201c8 <itable>
  ...
  release(&itable.lock);
    ...
    80003a40:	78c50513          	addi	a0,a0,1932 # 800201c8 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003a74:	75850513          	addi	a0,a0,1880 # 800201c8 <itable>
    ...
    80003b0c:	0ed7e963          	bltu	a5,a3,80003bfe <readi+0xf4>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    ...
    80003b6e:	abc080e7          	jalr	-1348(ra) # 80002626 <either_copyout>
    ...
    80003c04:	10d7e863          	bltu	a5,a3,80003d14 <writei+0x112>
{
  ...
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    ...
    80003c66:	a1a080e7          	jalr	-1510(ra) # 8000267c <either_copyin>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003d68:	9dc50513          	addi	a0,a0,-1572 # 80008740 <syscalls+0x1c0>
    80003d6c:	ffffc097          	auipc	ra,0xffffc
    80003d70:	7d2080e7          	jalr	2002(ra) # 8000053e <panic>
      panic("dirlookup read");
    80003d74:	00005517          	auipc	a0,0x5
    80003d78:	9e450513          	addi	a0,a0,-1564 # 80008758 <syscalls+0x1d8>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    80003e1a:	c10080e7          	jalr	-1008(ra) # 80001a26 <myproc>
...
0000000080003f4a <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003ff0:	77c50513          	addi	a0,a0,1916 # 80008768 <syscalls+0x1e8>
    80003ff4:	ffffc097          	auipc	ra,0xffffc
    80003ff8:	54a080e7          	jalr	1354(ra) # 8000053e <panic>
    panic("dirlink");
    80003ffc:	00005517          	auipc	a0,0x5
    80004000:	87c50513          	addi	a0,a0,-1924 # 80008878 <syscalls+0x2f8>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    80004052:	0001e917          	auipc	s2,0x1e
    80004056:	c1e90913          	addi	s2,s2,-994 # 80021c70 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000407a:	c2a78793          	addi	a5,a5,-982 # 80021ca0 <log+0x30>
    ...
    8000408e:	c1a60613          	addi	a2,a2,-998 # 80021ca4 <log+0x34>
...
00000000800040c0 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800040c4:	bdc7a783          	lw	a5,-1060(a5) # 80021c9c <log+0x2c>
    800040c8:	0af05d63          	blez	a5,80004182 <install_trans+0xc2>
{
    ...
    800040e2:	0001ea97          	auipc	s5,0x1e
    800040e6:	bbea8a93          	addi	s5,s5,-1090 # 80021ca0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    800040ea:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    800040ec:	0001e997          	auipc	s3,0x1e
    800040f0:	b8498993          	addi	s3,s3,-1148 # 80021c70 <log>
...
0000000080004184 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    8000419a:	ada48493          	addi	s1,s1,-1318 # 80021c70 <log>
    8000419e:	00004597          	auipc	a1,0x4
    800041a2:	5da58593          	addi	a1,a1,1498 # 80008778 <syscalls+0x1f8>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800041d6:	0001e697          	auipc	a3,0x1e
    800041da:	aca68693          	addi	a3,a3,-1334 # 80021ca0 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    8000420e:	a807a923          	sw	zero,-1390(a5) # 80021c9c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    80004234:	0001e517          	auipc	a0,0x1e
    80004238:	a3c50513          	addi	a0,a0,-1476 # 80021c70 <log>
    8000423c:	ffffd097          	auipc	ra,0xffffd
    80004240:	9a8080e7          	jalr	-1624(ra) # 80000be4 <acquire>
  while(1){
    if(log.committing){
    80004244:	0001e497          	auipc	s1,0x1e
    80004248:	a2c48493          	addi	s1,s1,-1492 # 80021c70 <log>
      sleep(&log, &log.lock);
    ...
    80004258:	02e080e7          	jalr	46(ra) # 80002282 <sleep>
    if(log.committing){
    ...
    80004284:	002080e7          	jalr	2(ra) # 80002282 <sleep>
    80004288:	bfd1                	j	8000425c <begin_op+0x34>
    } else {
      log.outstanding += 1;
    8000428a:	0001e517          	auipc	a0,0x1e
    8000428e:	9e650513          	addi	a0,a0,-1562 # 80021c70 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    800042be:	9b648493          	addi	s1,s1,-1610 # 80021c70 <log>
  ...
  if(log.outstanding == 0){
    ...
    do_commit = 1;
    log.committing = 1;
    800042de:	0001e497          	auipc	s1,0x1e
    800042e2:	99248493          	addi	s1,s1,-1646 # 80021c70 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800042fe:	97648493          	addi	s1,s1,-1674 # 80021c70 <log>
    ...
    80004316:	0fc080e7          	jalr	252(ra) # 8000240e <wakeup>
    release(&log.lock);
    ...
    8000433a:	44a50513          	addi	a0,a0,1098 # 80008780 <syscalls+0x200>
    8000433e:	ffffc097          	auipc	ra,0xffffc
    80004342:	200080e7          	jalr	512(ra) # 8000053e <panic>
    wakeup(&log);
    80004346:	0001e497          	auipc	s1,0x1e
    8000434a:	92a48493          	addi	s1,s1,-1750 # 80021c70 <log>
    8000434e:	8526                	mv	a0,s1
    80004350:	ffffe097          	auipc	ra,0xffffe
    80004354:	0be080e7          	jalr	190(ra) # 8000240e <wakeup>
  release(&log.lock);
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80004364:	0001ea97          	auipc	s5,0x1e
    80004368:	93ca8a93          	addi	s5,s5,-1732 # 80021ca0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    8000436c:	0001ea17          	auipc	s4,0x1e
    80004370:	904a0a13          	addi	s4,s4,-1788 # 80021c70 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    log.lh.n = 0;
    800043ee:	0001e797          	auipc	a5,0x1e
    800043f2:	8a07a723          	sw	zero,-1874(a5) # 80021c9c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    8000440e:	0001e917          	auipc	s2,0x1e
    80004412:	86290913          	addi	s2,s2,-1950 # 80021c70 <log>
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    ...
    8000442a:	0001e797          	auipc	a5,0x1e
    8000442e:	8627a783          	lw	a5,-1950(a5) # 80021c8c <log+0x1c>
    80004432:	37fd                	addiw	a5,a5,-1
    80004434:	04f65e63          	bge	a2,a5,80004490 <log_write+0x90>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80004438:	0001e797          	auipc	a5,0x1e
    8000443c:	8587a783          	lw	a5,-1960(a5) # 80021c90 <log+0x20>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000444c:	0001e717          	auipc	a4,0x1e
    80004450:	85470713          	addi	a4,a4,-1964 # 80021ca0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    8000446c:	80878793          	addi	a5,a5,-2040 # 80021c70 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80004484:	7f070713          	addi	a4,a4,2032 # 80021c70 <log>
    ...
    80004494:	30050513          	addi	a0,a0,768 # 80008790 <syscalls+0x210>
    80004498:	ffffc097          	auipc	ra,0xffffc
    8000449c:	0a6080e7          	jalr	166(ra) # 8000053e <panic>
    panic("log_write outside of trans");
    800044a0:	00004517          	auipc	a0,0x4
    800044a4:	30850513          	addi	a0,a0,776 # 800087a8 <syscalls+0x228>
  ...
  log.lh.block[i] = b->blockno;
    ...
    800044bc:	7b870713          	addi	a4,a4,1976 # 80021c70 <log>
  ...
  release(&log.lock);
    ...
    800044ce:	7a650513          	addi	a0,a0,1958 # 80021c70 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800044fa:	2d258593          	addi	a1,a1,722 # 800087c8 <syscalls+0x248>
...
acquiresleep(struct sleeplock *lk)
{
  ...
  while (lk->locked) {
    ...
    80004548:	d3e080e7          	jalr	-706(ra) # 80002282 <sleep>
  while (lk->locked) {
  ...
  lk->pid = myproc()->pid;
    ...
    80004558:	4d2080e7          	jalr	1234(ra) # 80001a26 <myproc>
...
releasesleep(struct sleeplock *lk)
{
  ...
  wakeup(lk);
    ...
    800045a0:	e72080e7          	jalr	-398(ra) # 8000240e <wakeup>
  release(&lk->lk);
...
holdingsleep(struct sleeplock *lk)
{
  ...
  r = lk->locked && (lk->pid == myproc()->pid);
    ...
    80004600:	42a080e7          	jalr	1066(ra) # 80001a26 <myproc>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    8000461c:	1c058593          	addi	a1,a1,448 # 800087d8 <syscalls+0x258>
    80004620:	0001d517          	auipc	a0,0x1d
    80004624:	79850513          	addi	a0,a0,1944 # 80021db8 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80004646:	77650513          	addi	a0,a0,1910 # 80021db8 <ftable>
    8000464a:	ffffc097          	auipc	ra,0xffffc
    8000464e:	59a080e7          	jalr	1434(ra) # 80000be4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80004652:	0001d497          	auipc	s1,0x1d
    80004656:	77e48493          	addi	s1,s1,1918 # 80021dd0 <ftable+0x18>
    8000465a:	0001e717          	auipc	a4,0x1e
    8000465e:	71670713          	addi	a4,a4,1814 # 80022d70 <ftable+0xfb8>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    80004672:	74a50513          	addi	a0,a0,1866 # 80021db8 <ftable>
  ...
  return 0;
    ...
    8000468a:	73250513          	addi	a0,a0,1842 # 80021db8 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800046b2:	70a50513          	addi	a0,a0,1802 # 80021db8 <ftable>
  ...
  release(&ftable.lock);
    ...
    800046cc:	6f050513          	addi	a0,a0,1776 # 80021db8 <ftable>
  ...
  return f;
    ...
    800046e8:	0fc50513          	addi	a0,a0,252 # 800087e0 <syscalls+0x260>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000470c:	6b050513          	addi	a0,a0,1712 # 80021db8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004746:	67650513          	addi	a0,a0,1654 # 80021db8 <ftable>
...
filestat(struct file *f, uint64 addr)
{
  ...
  struct proc *p = myproc();
    ...
    800047d2:	258080e7          	jalr	600(ra) # 80001a26 <myproc>
  struct stat st;
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    800048c2:	45a70713          	addi	a4,a4,1114 # 80021d18 <devsw>
    ...
    800048d8:	f2450513          	addi	a0,a0,-220 # 800087f8 <syscalls+0x278>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004962:	3ba70713          	addi	a4,a4,954 # 80021d18 <devsw>
  ...
  return ret;
    ...
    80004a0c:	e0050513          	addi	a0,a0,-512 # 80008808 <syscalls+0x288>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004a7c:	da058593          	addi	a1,a1,-608 # 80008818 <syscalls+0x298>
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  if(writable){
    ...
    80004b26:	8ec080e7          	jalr	-1812(ra) # 8000240e <wakeup>
  } else {
    pi->readopen = 0;
    wakeup(&pi->nwrite);
  }
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80004b5c:	8b6080e7          	jalr	-1866(ra) # 8000240e <wakeup>
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004b92:	e98080e7          	jalr	-360(ra) # 80001a26 <myproc>
  ...
  return i;
    ...
    80004be4:	82e080e7          	jalr	-2002(ra) # 8000240e <wakeup>
      sleep(&pi->nwrite, &pi->lock);
    80004be8:	85de                	mv	a1,s7
    80004bea:	8562                	mv	a0,s8
    80004bec:	ffffd097          	auipc	ra,0xffffd
    80004bf0:	696080e7          	jalr	1686(ra) # 80002282 <sleep>
  ...
  wakeup(&pi->nread);
    ...
    80004c54:	7be080e7          	jalr	1982(ra) # 8000240e <wakeup>
  release(&pi->lock);
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  struct proc *pr = myproc();
    ...
    80004c86:	da4080e7          	jalr	-604(ra) # 80001a26 <myproc>
  ...
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
    ...
    80004cbc:	5ca080e7          	jalr	1482(ra) # 80002282 <sleep>
  while(pi->nread == pi->nwrite && pi->writeopen){  //DOC: pipe-empty
  ...
  wakeup(&pi->nwrite);  //DOC: piperead-wakeup
    ...
    80004d1e:	6f4080e7          	jalr	1780(ra) # 8000240e <wakeup>
  release(&pi->lock);
...
exec(char *path, char **argv)
{
  ...
  struct proc *p = myproc();
    ...
    80004d86:	ca4080e7          	jalr	-860(ra) # 80001a26 <myproc>
 ...
 bad:
  ...
  if((pagetable = proc_pagetable(p)) == 0)
    ...
    80004e22:	cf8080e7          	jalr	-776(ra) # 80001b16 <proc_pagetable>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004e48:	9dc50513          	addi	a0,a0,-1572 # 80008820 <syscalls+0x2a0>
  ...
  p = myproc();
    ...
    80004eb4:	b76080e7          	jalr	-1162(ra) # 80001a26 <myproc>
  ...
  proc_freepagetable(oldpagetable, oldsz);
    ...
    8000500c:	baa080e7          	jalr	-1110(ra) # 80001bb2 <proc_freepagetable>
  return argc; // this ends up in a0, the first argument to main(argc, argv)
    ...
    80005024:	b92080e7          	jalr	-1134(ra) # 80001bb2 <proc_freepagetable>
  if(ip){
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(argint(n, &fd) < 0)
    ...
    800050f6:	b80080e7          	jalr	-1152(ra) # 80002c72 <argint>
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    8000510c:	91e080e7          	jalr	-1762(ra) # 80001a26 <myproc>
...
fdalloc(struct file *f)
{
  ...
  struct proc *p = myproc();
    ...
    80005156:	8d4080e7          	jalr	-1836(ra) # 80001a26 <myproc>
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    8000527a:	5ca50513          	addi	a0,a0,1482 # 80008840 <syscalls+0x2c0>
    ...
    800052a0:	5b458593          	addi	a1,a1,1460 # 80008850 <syscalls+0x2d0>
    ...
    800052ba:	5a258593          	addi	a1,a1,1442 # 80008858 <syscalls+0x2d8>
    ...
    800052d0:	59450513          	addi	a0,a0,1428 # 80008860 <syscalls+0x2e0>
    800052d4:	ffffb097          	auipc	ra,0xffffb
    800052d8:	26a080e7          	jalr	618(ra) # 8000053e <panic>
    panic("create: dirlink");
    800052dc:	00003517          	auipc	a0,0x3
    800052e0:	59450513          	addi	a0,a0,1428 # 80008870 <syscalls+0x2f0>
...
000000008000533e <sys_read>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    80005366:	910080e7          	jalr	-1776(ra) # 80002c72 <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    8000537a:	91e080e7          	jalr	-1762(ra) # 80002c94 <argaddr>
    return -1;
...
00000000800053a4 <sys_write>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800053cc:	8aa080e7          	jalr	-1878(ra) # 80002c72 <argint>
    return -1;
  ...
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argaddr(1, &p) < 0)
    ...
    800053e0:	8b8080e7          	jalr	-1864(ra) # 80002c94 <argaddr>
    return -1;
...
000000008000540a <sys_close>:
{
  ...
  myproc()->ofile[fd] = 0;
    ...
    8000542e:	5fc080e7          	jalr	1532(ra) # 80001a26 <myproc>
...
0000000080005458 <sys_fstat>:
{
  ...
  if(argfd(0, 0, &f) < 0 || argaddr(1, &st) < 0)
    ...
    80005480:	818080e7          	jalr	-2024(ra) # 80002c94 <argaddr>
    return -1;
...
00000000800054a6 <sys_link>:
{
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800054c0:	7fa080e7          	jalr	2042(ra) # 80002cb6 <argstr>
    return -1;
  ...
  if(argstr(0, old, MAXPATH) < 0 || argstr(1, new, MAXPATH) < 0)
    ...
    800054d8:	7e2080e7          	jalr	2018(ra) # 80002cb6 <argstr>
    return -1;
...
00000000800055f0 <sys_unlink>:
{
  ...
  if(argstr(0, path, MAXPATH) < 0)
    ...
    8000560c:	6ae080e7          	jalr	1710(ra) # 80002cb6 <argstr>
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    8000563c:	21858593          	addi	a1,a1,536 # 80008850 <syscalls+0x2d0>
    ...
    80005654:	20858593          	addi	a1,a1,520 # 80008858 <syscalls+0x2d8>
  ...
  return 0;
    ...
    80005714:	17050513          	addi	a0,a0,368 # 80008880 <syscalls+0x300>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80005760:	13c50513          	addi	a0,a0,316 # 80008898 <syscalls+0x318>
    80005764:	ffffb097          	auipc	ra,0xffffb
    80005768:	dda080e7          	jalr	-550(ra) # 8000053e <panic>
    panic("unlink: writei");
    8000576c:	00003517          	auipc	a0,0x3
    80005770:	14450513          	addi	a0,a0,324 # 800088b0 <syscalls+0x330>
...
sys_open(void)
{
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    800057de:	4dc080e7          	jalr	1244(ra) # 80002cb6 <argstr>
    return -1;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    ...
    800057f2:	484080e7          	jalr	1156(ra) # 80002c72 <argint>
...
sys_mkdir(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005978:	342080e7          	jalr	834(ra) # 80002cb6 <argstr>
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    800059d8:	2e2080e7          	jalr	738(ra) # 80002cb6 <argstr>
    ...
    800059ea:	28c080e7          	jalr	652(ra) # 80002c72 <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    800059fc:	27a080e7          	jalr	634(ra) # 80002c72 <argint>
     argint(1, &major) < 0 ||
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005a52:	fd8080e7          	jalr	-40(ra) # 80001a26 <myproc>
  ...
  if(argstr(0, path, MAXPATH) < 0 || (ip = namei(path)) == 0){
    ...
    80005a6e:	24c080e7          	jalr	588(ra) # 80002cb6 <argstr>
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005b0a:	1b0080e7          	jalr	432(ra) # 80002cb6 <argstr>
    return -1;
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005b1e:	17a080e7          	jalr	378(ra) # 80002c94 <argaddr>
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005b5a:	082080e7          	jalr	130(ra) # 80002bd8 <fetchaddr>
    ...
    80005b82:	0ac080e7          	jalr	172(ra) # 80002c2a <fetchstr>
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005c06:	e24080e7          	jalr	-476(ra) # 80001a26 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005c16:	082080e7          	jalr	130(ra) # 80002c94 <argaddr>
    return -1;
...
0000000080005d10 <kernelvec>:
    ...
    80005d50:	d55fc0ef          	jal	ra,80002aa4 <kerneltrap>
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005ed6:	53c080e7          	jalr	1340(ra) # 8000240e <wakeup>
}
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  while(1){
    ...
    80006116:	170080e7          	jalr	368(ra) # 80002282 <sleep>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80006260:	026080e7          	jalr	38(ra) # 80002282 <sleep>
  while(b->disk == 1) {
...
virtio_disk_intr()
{
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  while(disk.used_idx != disk.used->idx){
    ...
    8000639e:	074080e7          	jalr	116(ra) # 8000240e <wakeup>
