...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	d2a50513          	addi	a0,a0,-726 # 5d68 <malloc+0xec>
      46:	00006097          	auipc	ra,0x6
      4a:	b7e080e7          	jalr	-1154(ra) # 5bc4 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	d0850513          	addi	a0,a0,-760 # 5d88 <malloc+0x10c>
      88:	00006097          	auipc	ra,0x6
      8c:	b3c080e7          	jalr	-1220(ra) # 5bc4 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	cf850513          	addi	a0,a0,-776 # 5da0 <malloc+0x124>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	cfa50513          	addi	a0,a0,-774 # 5dc0 <malloc+0x144>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	cc250513          	addi	a0,a0,-830 # 5da8 <malloc+0x12c>
      ee:	00006097          	auipc	ra,0x6
      f2:	ad6080e7          	jalr	-1322(ra) # 5bc4 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	cce50513          	addi	a0,a0,-818 # 5dd0 <malloc+0x154>
     10a:	00006097          	auipc	ra,0x6
     10e:	aba080e7          	jalr	-1350(ra) # 5bc4 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	ccc50513          	addi	a0,a0,-820 # 5df8 <malloc+0x17c>
     134:	00005097          	auipc	ra,0x5
     138:	75e080e7          	jalr	1886(ra) # 5892 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	cb850513          	addi	a0,a0,-840 # 5df8 <malloc+0x17c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	cb458593          	addi	a1,a1,-844 # 5e08 <malloc+0x18c>
     15c:	00005097          	auipc	ra,0x5
     160:	706080e7          	jalr	1798(ra) # 5862 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	c9050513          	addi	a0,a0,-880 # 5df8 <malloc+0x17c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	c9458593          	addi	a1,a1,-876 # 5e10 <malloc+0x194>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	c6450513          	addi	a0,a0,-924 # 5df8 <malloc+0x17c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c4e50513          	addi	a0,a0,-946 # 5e18 <malloc+0x19c>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	9f2080e7          	jalr	-1550(ra) # 5bc4 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	bc450513          	addi	a0,a0,-1084 # 5e40 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	bb0a8a93          	addi	s5,s5,-1104 # 5e40 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b3e50513          	addi	a0,a0,-1218 # 5e50 <malloc+0x1d4>
     31a:	00006097          	auipc	ra,0x6
     31e:	8aa080e7          	jalr	-1878(ra) # 5bc4 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	b3c50513          	addi	a0,a0,-1220 # 5e70 <malloc+0x1f4>
     33c:	00006097          	auipc	ra,0x6
     340:	888080e7          	jalr	-1912(ra) # 5bc4 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	b18a0a13          	addi	s4,s4,-1256 # 5e88 <malloc+0x20c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	a7450513          	addi	a0,a0,-1420 # 5e90 <malloc+0x214>
     424:	00005097          	auipc	ra,0x5
     428:	7a0080e7          	jalr	1952(ra) # 5bc4 <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	a6e50513          	addi	a0,a0,-1426 # 5ea8 <malloc+0x22c>
     442:	00005097          	auipc	ra,0x5
     446:	782080e7          	jalr	1922(ra) # 5bc4 <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	a8050513          	addi	a0,a0,-1408 # 5ed8 <malloc+0x25c>
     460:	00005097          	auipc	ra,0x5
     464:	764080e7          	jalr	1892(ra) # 5bc4 <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	a9650513          	addi	a0,a0,-1386 # 5f08 <malloc+0x28c>
     47a:	00005097          	auipc	ra,0x5
     47e:	74a080e7          	jalr	1866(ra) # 5bc4 <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	a8850513          	addi	a0,a0,-1400 # 5f18 <malloc+0x29c>
     498:	00005097          	auipc	ra,0x5
     49c:	72c080e7          	jalr	1836(ra) # 5bc4 <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	a7aa0a13          	addi	s4,s4,-1414 # 5f48 <malloc+0x2cc>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	93aa8a93          	addi	s5,s5,-1734 # 5e10 <malloc+0x194>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	9d450513          	addi	a0,a0,-1580 # 5f50 <malloc+0x2d4>
     584:	00005097          	auipc	ra,0x5
     588:	640080e7          	jalr	1600(ra) # 5bc4 <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	9ce50513          	addi	a0,a0,-1586 # 5f68 <malloc+0x2ec>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	622080e7          	jalr	1570(ra) # 5bc4 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	95450513          	addi	a0,a0,-1708 # 5f08 <malloc+0x28c>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	608080e7          	jalr	1544(ra) # 5bc4 <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	9ca50513          	addi	a0,a0,-1590 # 5f98 <malloc+0x31c>
     5d6:	00005097          	auipc	ra,0x5
     5da:	5ee080e7          	jalr	1518(ra) # 5bc4 <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	9c450513          	addi	a0,a0,-1596 # 5fb0 <malloc+0x334>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	5d0080e7          	jalr	1488(ra) # 5bc4 <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	7c658593          	addi	a1,a1,1990 # 5e08 <malloc+0x18c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	79a50513          	addi	a0,a0,1946 # 5df8 <malloc+0x17c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	76e50513          	addi	a0,a0,1902 # 5df8 <malloc+0x17c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	75a50513          	addi	a0,a0,1882 # 5df8 <malloc+0x17c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	96458593          	addi	a1,a1,-1692 # 6040 <malloc+0x3c4>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	6da50513          	addi	a0,a0,1754 # 5df8 <malloc+0x17c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	87e50513          	addi	a0,a0,-1922 # 5fe0 <malloc+0x364>
     76a:	00005097          	auipc	ra,0x5
     76e:	45a080e7          	jalr	1114(ra) # 5bc4 <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	88250513          	addi	a0,a0,-1918 # 6000 <malloc+0x384>
     786:	00005097          	auipc	ra,0x5
     78a:	43e080e7          	jalr	1086(ra) # 5bc4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	87e50513          	addi	a0,a0,-1922 # 6010 <malloc+0x394>
     79a:	00005097          	auipc	ra,0x5
     79e:	42a080e7          	jalr	1066(ra) # 5bc4 <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	88250513          	addi	a0,a0,-1918 # 6030 <malloc+0x3b4>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	40e080e7          	jalr	1038(ra) # 5bc4 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	84e50513          	addi	a0,a0,-1970 # 6010 <malloc+0x394>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	3fa080e7          	jalr	1018(ra) # 5bc4 <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	86850513          	addi	a0,a0,-1944 # 6048 <malloc+0x3cc>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	3dc080e7          	jalr	988(ra) # 5bc4 <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	86a50513          	addi	a0,a0,-1942 # 6068 <malloc+0x3ec>
     806:	00005097          	auipc	ra,0x5
     80a:	3be080e7          	jalr	958(ra) # 5bc4 <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	85650513          	addi	a0,a0,-1962 # 6088 <malloc+0x40c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	86698993          	addi	s3,s3,-1946 # 60b0 <malloc+0x434>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	896a8a93          	addi	s5,s5,-1898 # 60e8 <malloc+0x46c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	7f050513          	addi	a0,a0,2032 # 6088 <malloc+0x40c>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	7b450513          	addi	a0,a0,1972 # 6088 <malloc+0x40c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	79250513          	addi	a0,a0,1938 # 6090 <malloc+0x414>
     906:	00005097          	auipc	ra,0x5
     90a:	2be080e7          	jalr	702(ra) # 5bc4 <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	7a450513          	addi	a0,a0,1956 # 60c0 <malloc+0x444>
     924:	00005097          	auipc	ra,0x5
     928:	2a0080e7          	jalr	672(ra) # 5bc4 <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	7be50513          	addi	a0,a0,1982 # 60f8 <malloc+0x47c>
     942:	00005097          	auipc	ra,0x5
     946:	282080e7          	jalr	642(ra) # 5bc4 <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	7ca50513          	addi	a0,a0,1994 # 6120 <malloc+0x4a4>
     95e:	00005097          	auipc	ra,0x5
     962:	266080e7          	jalr	614(ra) # 5bc4 <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	7ce50513          	addi	a0,a0,1998 # 6140 <malloc+0x4c4>
     97a:	00005097          	auipc	ra,0x5
     97e:	24a080e7          	jalr	586(ra) # 5bc4 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	7ca50513          	addi	a0,a0,1994 # 6158 <malloc+0x4dc>
     996:	00005097          	auipc	ra,0x5
     99a:	22e080e7          	jalr	558(ra) # 5bc4 <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	7b850513          	addi	a0,a0,1976 # 6178 <malloc+0x4fc>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	40c90913          	addi	s2,s2,1036 # bde0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	76650513          	addi	a0,a0,1894 # 6178 <malloc+0x4fc>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	3ba90913          	addi	s2,s2,954 # bde0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	72650513          	addi	a0,a0,1830 # 6180 <malloc+0x504>
     a62:	00005097          	auipc	ra,0x5
     a66:	162080e7          	jalr	354(ra) # 5bc4 <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	72850513          	addi	a0,a0,1832 # 61a0 <malloc+0x524>
     a80:	00005097          	auipc	ra,0x5
     a84:	144080e7          	jalr	324(ra) # 5bc4 <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	73450513          	addi	a0,a0,1844 # 61c8 <malloc+0x54c>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	128080e7          	jalr	296(ra) # 5bc4 <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	6b850513          	addi	a0,a0,1720 # 6178 <malloc+0x4fc>
     ...
     af0:	6fc50513          	addi	a0,a0,1788 # 61e8 <malloc+0x56c>
     af4:	00005097          	auipc	ra,0x5
     af8:	0d0080e7          	jalr	208(ra) # 5bc4 <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	70650513          	addi	a0,a0,1798 # 6210 <malloc+0x594>
     b12:	00005097          	auipc	ra,0x5
     b16:	0b2080e7          	jalr	178(ra) # 5bc4 <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	70050513          	addi	a0,a0,1792 # 6228 <malloc+0x5ac>
     b30:	00005097          	auipc	ra,0x5
     b34:	094080e7          	jalr	148(ra) # 5bc4 <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	70c50513          	addi	a0,a0,1804 # 6250 <malloc+0x5d4>
     b4c:	00005097          	auipc	ra,0x5
     b50:	078080e7          	jalr	120(ra) # 5bc4 <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	6f650513          	addi	a0,a0,1782 # 6268 <malloc+0x5ec>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	70e58593          	addi	a1,a1,1806 # 6298 <malloc+0x61c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	6c250513          	addi	a0,a0,1730 # 6268 <malloc+0x5ec>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	6ac50513          	addi	a0,a0,1708 # 6268 <malloc+0x5ec>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	69650513          	addi	a0,a0,1686 # 6268 <malloc+0x5ec>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	6fa58593          	addi	a1,a1,1786 # 62e0 <malloc+0x664>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	1de58593          	addi	a1,a1,478 # bde0 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	61a50513          	addi	a0,a0,1562 # 6268 <malloc+0x5ec>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	60a50513          	addi	a0,a0,1546 # 6278 <malloc+0x5fc>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f4e080e7          	jalr	-178(ra) # 5bc4 <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	61650513          	addi	a0,a0,1558 # 62a0 <malloc+0x624>
     c92:	00005097          	auipc	ra,0x5
     c96:	f32080e7          	jalr	-206(ra) # 5bc4 <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	61a50513          	addi	a0,a0,1562 # 62c0 <malloc+0x644>
     cae:	00005097          	auipc	ra,0x5
     cb2:	f16080e7          	jalr	-234(ra) # 5bc4 <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	62650513          	addi	a0,a0,1574 # 62e8 <malloc+0x66c>
     cca:	00005097          	auipc	ra,0x5
     cce:	efa080e7          	jalr	-262(ra) # 5bc4 <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	62a50513          	addi	a0,a0,1578 # 6308 <malloc+0x68c>
     ce6:	00005097          	auipc	ra,0x5
     cea:	ede080e7          	jalr	-290(ra) # 5bc4 <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	62e50513          	addi	a0,a0,1582 # 6328 <malloc+0x6ac>
     d02:	00005097          	auipc	ra,0x5
     d06:	ec2080e7          	jalr	-318(ra) # 5bc4 <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	53a58593          	addi	a1,a1,1338 # 6298 <malloc+0x61c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	5d258593          	addi	a1,a1,1490 # 6350 <malloc+0x6d4>
     d86:	00005517          	auipc	a0,0x5
     d8a:	5c250513          	addi	a0,a0,1474 # 6348 <malloc+0x6cc>
  ...
  unlink("lf1");
     ...
     d9e:	5ae50513          	addi	a0,a0,1454 # 6348 <malloc+0x6cc>
     da2:	00005097          	auipc	ra,0x5
     da6:	af0080e7          	jalr	-1296(ra) # 5892 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	59c50513          	addi	a0,a0,1436 # 6348 <malloc+0x6cc>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	58e50513          	addi	a0,a0,1422 # 6350 <malloc+0x6d4>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	00658593          	addi	a1,a1,6 # bde0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	55658593          	addi	a1,a1,1366 # 6350 <malloc+0x6d4>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	54050513          	addi	a0,a0,1344 # 6350 <malloc+0x6d4>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a7a080e7          	jalr	-1414(ra) # 5892 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	52858593          	addi	a1,a1,1320 # 6348 <malloc+0x6cc>
     e28:	00005517          	auipc	a0,0x5
     e2c:	52850513          	addi	a0,a0,1320 # 6350 <malloc+0x6d4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	50c58593          	addi	a1,a1,1292 # 6348 <malloc+0x6cc>
     e44:	00005517          	auipc	a0,0x5
     e48:	61450513          	addi	a0,a0,1556 # 6458 <malloc+0x7dc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	4f250513          	addi	a0,a0,1266 # 6358 <malloc+0x6dc>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d56080e7          	jalr	-682(ra) # 5bc4 <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	4ee50513          	addi	a0,a0,1262 # 6370 <malloc+0x6f4>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d3a080e7          	jalr	-710(ra) # 5bc4 <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	4ea50513          	addi	a0,a0,1258 # 6388 <malloc+0x70c>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d1e080e7          	jalr	-738(ra) # 5bc4 <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	4ee50513          	addi	a0,a0,1262 # 63a8 <malloc+0x72c>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	d02080e7          	jalr	-766(ra) # 5bc4 <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	50250513          	addi	a0,a0,1282 # 63d8 <malloc+0x75c>
     ede:	00005097          	auipc	ra,0x5
     ee2:	ce6080e7          	jalr	-794(ra) # 5bc4 <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	4fe50513          	addi	a0,a0,1278 # 63f0 <malloc+0x774>
     efa:	00005097          	auipc	ra,0x5
     efe:	cca080e7          	jalr	-822(ra) # 5bc4 <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	4fa50513          	addi	a0,a0,1274 # 6408 <malloc+0x78c>
     f16:	00005097          	auipc	ra,0x5
     f1a:	cae080e7          	jalr	-850(ra) # 5bc4 <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	50650513          	addi	a0,a0,1286 # 6430 <malloc+0x7b4>
     f32:	00005097          	auipc	ra,0x5
     f36:	c92080e7          	jalr	-878(ra) # 5bc4 <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	51a50513          	addi	a0,a0,1306 # 6460 <malloc+0x7e4>
     f4e:	00005097          	auipc	ra,0x5
     f52:	c76080e7          	jalr	-906(ra) # 5bc4 <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	4d4a0a13          	addi	s4,s4,1236 # 6480 <malloc+0x804>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	48250513          	addi	a0,a0,1154 # 6480 <malloc+0x804>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	41a50513          	addi	a0,a0,1050 # 6488 <malloc+0x80c>
    1076:	00005097          	auipc	ra,0x5
    107a:	b4e080e7          	jalr	-1202(ra) # 5bc4 <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	41a50513          	addi	a0,a0,1050 # 64a8 <malloc+0x82c>
    1096:	00005097          	auipc	ra,0x5
    109a:	b2e080e7          	jalr	-1234(ra) # 5bc4 <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	41e50513          	addi	a0,a0,1054 # 64c8 <malloc+0x84c>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	b12080e7          	jalr	-1262(ra) # 5bc4 <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	40c98993          	addi	s3,s3,1036 # 64e8 <malloc+0x86c>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	3e050513          	addi	a0,a0,992 # 64f8 <malloc+0x87c>
    1120:	00005097          	auipc	ra,0x5
    1124:	aa4080e7          	jalr	-1372(ra) # 5bc4 <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	4784b483          	ld	s1,1144(s1) # 85b8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	addi	s1,s1,848 # c350 <buf+0x570>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	c1c98993          	addi	s3,s3,-996 # 5da0 <malloc+0x124>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	4e278793          	addi	a5,a5,1250 # 76f0 <malloc+0x1a74>
  ...
  if(pid == 0){
    ...
    1248:	48478793          	addi	a5,a5,1156 # 86c8 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	47c68693          	addi	a3,a3,1148 # 96c8 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	46078323          	sb	zero,1126(a5) # 96c8 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	ec678793          	addi	a5,a5,-314 # 8130 <malloc+0x24b4>
    ...
    1292:	b1250513          	addi	a0,a0,-1262 # 5da0 <malloc+0x124>
    ...
    12aa:	2fa50513          	addi	a0,a0,762 # 65a0 <malloc+0x924>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	916080e7          	jalr	-1770(ra) # 5bc4 <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	25250513          	addi	a0,a0,594 # 6518 <malloc+0x89c>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	8f6080e7          	jalr	-1802(ra) # 5bc4 <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	25250513          	addi	a0,a0,594 # 6538 <malloc+0x8bc>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	8d6080e7          	jalr	-1834(ra) # 5bc4 <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	25050513          	addi	a0,a0,592 # 6558 <malloc+0x8dc>
    1310:	00005097          	auipc	ra,0x5
    1314:	8b4080e7          	jalr	-1868(ra) # 5bc4 <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	25850513          	addi	a0,a0,600 # 6580 <malloc+0x904>
    1330:	00005097          	auipc	ra,0x5
    1334:	894080e7          	jalr	-1900(ra) # 5bc4 <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	6d650513          	addi	a0,a0,1750 # 6a18 <malloc+0xd9c>
    134a:	00005097          	auipc	ra,0x5
    134e:	87a080e7          	jalr	-1926(ra) # 5bc4 <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	23c50513          	addi	a0,a0,572 # 65c8 <malloc+0x94c>
    1394:	00005097          	auipc	ra,0x5
    1398:	830080e7          	jalr	-2000(ra) # 5bc4 <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a3a50513          	addi	a0,a0,-1478 # 5df8 <malloc+0x17c>
  ...
  if(pid == 0){
    ...
    13ec:	a10a0a13          	addi	s4,s4,-1520 # 5df8 <malloc+0x17c>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	238a8a93          	addi	s5,s5,568 # 6628 <malloc+0x9ac>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	19850513          	addi	a0,a0,408 # 65f8 <malloc+0x97c>
    1468:	00004097          	auipc	ra,0x4
    146c:	75c080e7          	jalr	1884(ra) # 5bc4 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	19450513          	addi	a0,a0,404 # 6610 <malloc+0x994>
    1484:	00004097          	auipc	ra,0x4
    1488:	740080e7          	jalr	1856(ra) # 5bc4 <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	19e50513          	addi	a0,a0,414 # 6638 <malloc+0x9bc>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	722080e7          	jalr	1826(ra) # 5bc4 <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	940a0a13          	addi	s4,s4,-1728 # 5df8 <malloc+0x17c>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	198a8a93          	addi	s5,s5,408 # 6658 <malloc+0x9dc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	8ee50513          	addi	a0,a0,-1810 # 5df8 <malloc+0x17c>
  ...
  exit(xstatus);
    ...
    152c:	0e850513          	addi	a0,a0,232 # 6610 <malloc+0x994>
    1530:	00004097          	auipc	ra,0x4
    1534:	694080e7          	jalr	1684(ra) # 5bc4 <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	11a50513          	addi	a0,a0,282 # 6660 <malloc+0x9e4>
    154e:	00004097          	auipc	ra,0x4
    1552:	676080e7          	jalr	1654(ra) # 5bc4 <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	83278793          	addi	a5,a5,-1998 # 5da0 <malloc+0x124>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	10678793          	addi	a5,a5,262 # 6680 <malloc+0xa04>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	0fe50513          	addi	a0,a0,254 # 6688 <malloc+0xa0c>
  ...
  if(pid == 0) {
    ...
    15bc:	0d050513          	addi	a0,a0,208 # 6688 <malloc+0xa0c>
    ...
    15d8:	0d450513          	addi	a0,a0,212 # 66a8 <malloc+0xa2c>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	5e8080e7          	jalr	1512(ra) # 5bc4 <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	00850513          	addi	a0,a0,8 # 65f8 <malloc+0x97c>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	5cc080e7          	jalr	1484(ra) # 5bc4 <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	08450513          	addi	a0,a0,132 # 6690 <malloc+0xa14>
    1614:	00004097          	auipc	ra,0x4
    1618:	5b0080e7          	jalr	1456(ra) # 5bc4 <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	77650513          	addi	a0,a0,1910 # 5da0 <malloc+0x124>
  ...
  if(xstatus != 0)
    ...
    1662:	05a50513          	addi	a0,a0,90 # 66b8 <malloc+0xa3c>
    1666:	00004097          	auipc	ra,0x4
    166a:	55e080e7          	jalr	1374(ra) # 5bc4 <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	05650513          	addi	a0,a0,86 # 66d0 <malloc+0xa54>
    1682:	00004097          	auipc	ra,0x4
    1686:	542080e7          	jalr	1346(ra) # 5bc4 <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	ffa50513          	addi	a0,a0,-6 # 6688 <malloc+0xa0c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	a8850513          	addi	a0,a0,-1400 # 6140 <malloc+0x4c4>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	504080e7          	jalr	1284(ra) # 5bc4 <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f3c50513          	addi	a0,a0,-196 # 6610 <malloc+0x994>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	4e8080e7          	jalr	1256(ra) # 5bc4 <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	f9a50513          	addi	a0,a0,-102 # 6688 <malloc+0xa0c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	fd050513          	addi	a0,a0,-48 # 66e8 <malloc+0xa6c>
    1720:	00004097          	auipc	ra,0x4
    1724:	4a4080e7          	jalr	1188(ra) # 5bc4 <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	65ca8a93          	addi	s5,s5,1628 # bde0 <buf>
      if(cc > sizeof(buf))
    ...
    17a6:	63e70713          	addi	a4,a4,1598 # bde0 <buf>
    ...
    17dc:	f2850513          	addi	a0,a0,-216 # 6700 <malloc+0xa84>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	3e4080e7          	jalr	996(ra) # 5bc4 <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	5e2b0b13          	addi	s6,s6,1506 # bde0 <buf>
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	eba50513          	addi	a0,a0,-326 # 6718 <malloc+0xa9c>
    1866:	00004097          	auipc	ra,0x4
    186a:	35e080e7          	jalr	862(ra) # 5bc4 <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	eb650513          	addi	a0,a0,-330 # 6730 <malloc+0xab4>
    1882:	00004097          	auipc	ra,0x4
    1886:	342080e7          	jalr	834(ra) # 5bc4 <printf>
}
    ...
    18b0:	e9c50513          	addi	a0,a0,-356 # 6748 <malloc+0xacc>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	310080e7          	jalr	784(ra) # 5bc4 <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	e7c50513          	addi	a0,a0,-388 # 6768 <malloc+0xaec>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	2d0080e7          	jalr	720(ra) # 5bc4 <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	c9a50513          	addi	a0,a0,-870 # 65f8 <malloc+0x97c>
    1966:	00004097          	auipc	ra,0x4
    196a:	25e080e7          	jalr	606(ra) # 5bc4 <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e0650513          	addi	a0,a0,-506 # 6780 <malloc+0xb04>
    1982:	00004097          	auipc	ra,0x4
    1986:	242080e7          	jalr	578(ra) # 5bc4 <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e0250513          	addi	a0,a0,-510 # 6798 <malloc+0xb1c>
    199e:	00004097          	auipc	ra,0x4
    19a2:	226080e7          	jalr	550(ra) # 5bc4 <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	bea50513          	addi	a0,a0,-1046 # 65f8 <malloc+0x97c>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	1ae080e7          	jalr	430(ra) # 5bc4 <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	bc650513          	addi	a0,a0,-1082 # 65f8 <malloc+0x97c>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	18a080e7          	jalr	394(ra) # 5bc4 <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	d0c50513          	addi	a0,a0,-756 # 67b8 <malloc+0xb3c>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	110080e7          	jalr	272(ra) # 5bc4 <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d84080e7          	jalr	-636(ra) # 5842 <exit>
{
    ...
    1b08:	cc450513          	addi	a0,a0,-828 # 67c8 <malloc+0xb4c>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	0b8080e7          	jalr	184(ra) # 5bc4 <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	ec650513          	addi	a0,a0,-314 # 6a18 <malloc+0xd9c>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	06a080e7          	jalr	106(ra) # 5bc4 <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	e2850513          	addi	a0,a0,-472 # 6a18 <malloc+0xd9c>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	fcc080e7          	jalr	-52(ra) # 5bc4 <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	a7450513          	addi	a0,a0,-1420 # 6690 <malloc+0xa14>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	fa0080e7          	jalr	-96(ra) # 5bc4 <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	b5a50513          	addi	a0,a0,-1190 # 67e8 <malloc+0xb6c>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f2e080e7          	jalr	-210(ra) # 5bc4 <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b3e50513          	addi	a0,a0,-1218 # 6800 <malloc+0xb84>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	efa080e7          	jalr	-262(ra) # 5bc4 <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b0050513          	addi	a0,a0,-1280 # 6828 <malloc+0xbac>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	e94080e7          	jalr	-364(ra) # 5bc4 <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	04850513          	addi	a0,a0,72 # 5e10 <malloc+0x194>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e08:	00ca8a93          	addi	s5,s5,12 # 5e10 <malloc+0x194>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a44b8b93          	addi	s7,s7,-1468 # 6850 <malloc+0xbd4>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00004517          	auipc	a0,0x4
    1e1c:	7e050513          	addi	a0,a0,2016 # 65f8 <malloc+0x97c>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	da4080e7          	jalr	-604(ra) # 5bc4 <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	b1250513          	addi	a0,a0,-1262 # 6a18 <malloc+0xd9c>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	cb6080e7          	jalr	-842(ra) # 5bc4 <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	e9eb0b13          	addi	s6,s6,-354 # bde0 <buf>
    ...
    1fba:	8a250513          	addi	a0,a0,-1886 # 6858 <malloc+0xbdc>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	c06080e7          	jalr	-1018(ra) # 5bc4 <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	e9a50513          	addi	a0,a0,-358 # 5e70 <malloc+0x1f4>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	be6080e7          	jalr	-1050(ra) # 5bc4 <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	86450513          	addi	a0,a0,-1948 # 6888 <malloc+0xc0c>
    202c:	00004097          	auipc	ra,0x4
    2030:	b98080e7          	jalr	-1128(ra) # 5bc4 <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	7ea50513          	addi	a0,a0,2026 # 6870 <malloc+0xbf4>
    208e:	00004097          	auipc	ra,0x4
    2092:	b36080e7          	jalr	-1226(ra) # 5bc4 <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	80e50513          	addi	a0,a0,-2034 # 68b0 <malloc+0xc34>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b1a080e7          	jalr	-1254(ra) # 5bc4 <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	80a50513          	addi	a0,a0,-2038 # 68c8 <malloc+0xc4c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	afe080e7          	jalr	-1282(ra) # 5bc4 <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	addi	s3,s3,848 # c350 <buf+0x570>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	slli	s2,s2,0x3
    20fe:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e690>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	4ba50513          	addi	a0,a0,1210 # 65f8 <malloc+0x97c>
    2146:	00004097          	auipc	ra,0x4
    214a:	a7e080e7          	jalr	-1410(ra) # 5bc4 <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	78050513          	addi	a0,a0,1920 # 68e0 <malloc+0xc64>
    2168:	00004097          	auipc	ra,0x4
    216c:	a5c080e7          	jalr	-1444(ra) # 5bc4 <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	41650513          	addi	a0,a0,1046 # 65f8 <malloc+0x97c>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	9da080e7          	jalr	-1574(ra) # 5bc4 <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	6f250513          	addi	a0,a0,1778 # 6900 <malloc+0xc84>
    2216:	00004097          	auipc	ra,0x4
    221a:	9ae080e7          	jalr	-1618(ra) # 5bc4 <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	6da50513          	addi	a0,a0,1754 # 6918 <malloc+0xc9c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	6a850513          	addi	a0,a0,1704 # 6918 <malloc+0xc9c>
  ...
  close(fd);
    ...
    229a:	33278793          	addi	a5,a5,818 # 85c8 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	42268693          	addi	a3,a3,1058 # 86c0 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	68270713          	addi	a4,a4,1666 # 6928 <malloc+0xcac>
    ...
    22fe:	70e50513          	addi	a0,a0,1806 # 6a08 <malloc+0xd8c>
    2302:	00004097          	auipc	ra,0x4
    2306:	8c2080e7          	jalr	-1854(ra) # 5bc4 <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	70a50513          	addi	a0,a0,1802 # 6a28 <malloc+0xdac>
    2326:	00004097          	auipc	ra,0x4
    232a:	89e080e7          	jalr	-1890(ra) # 5bc4 <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0210>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	6cc50513          	addi	a0,a0,1740 # 6a48 <malloc+0xdcc>
    2384:	00004097          	auipc	ra,0x4
    2388:	840080e7          	jalr	-1984(ra) # 5bc4 <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	26050513          	addi	a0,a0,608 # 65f8 <malloc+0x97c>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	824080e7          	jalr	-2012(ra) # 5bc4 <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	2be78793          	addi	a5,a5,702 # 76f0 <malloc+0x1a74>
  ...
  if(ret != -1){
    ...
    2478:	5fc50513          	addi	a0,a0,1532 # 6a70 <malloc+0xdf4>
    247c:	00003097          	auipc	ra,0x3
    2480:	748080e7          	jalr	1864(ra) # 5bc4 <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	08650513          	addi	a0,a0,134 # 6518 <malloc+0x89c>
    249a:	00003097          	auipc	ra,0x3
    249e:	72a080e7          	jalr	1834(ra) # 5bc4 <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	08850513          	addi	a0,a0,136 # 6538 <malloc+0x8bc>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	70c080e7          	jalr	1804(ra) # 5bc4 <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	08850513          	addi	a0,a0,136 # 6558 <malloc+0x8dc>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	6ec080e7          	jalr	1772(ra) # 5bc4 <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	09250513          	addi	a0,a0,146 # 6580 <malloc+0x904>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	6ce080e7          	jalr	1742(ra) # 5bc4 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	57650513          	addi	a0,a0,1398 # 6ab0 <malloc+0xe34>
  ...
  if(n >= 0){
    ...
    256e:	56650513          	addi	a0,a0,1382 # 6ad0 <malloc+0xe54>
    2572:	00003097          	auipc	ra,0x3
    2576:	652080e7          	jalr	1618(ra) # 5bc4 <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	4f450513          	addi	a0,a0,1268 # 6a78 <malloc+0xdfc>
    258c:	00003097          	auipc	ra,0x3
    2590:	638080e7          	jalr	1592(ra) # 5bc4 <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	4f250513          	addi	a0,a0,1266 # 6a90 <malloc+0xe14>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	61e080e7          	jalr	1566(ra) # 5bc4 <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	50050513          	addi	a0,a0,1280 # 6ab8 <malloc+0xe3c>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	604080e7          	jalr	1540(ra) # 5bc4 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	4d450513          	addi	a0,a0,1236 # 6ab0 <malloc+0xe34>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2ae080e7          	jalr	686(ra) # 5892 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	95a50513          	addi	a0,a0,-1702 # 5f48 <malloc+0x2cc>
  ...
  if(n >= 0){
    ...
    261c:	4e850513          	addi	a0,a0,1256 # 6b00 <malloc+0xe84>
    2620:	00003097          	auipc	ra,0x3
    2624:	5a4080e7          	jalr	1444(ra) # 5bc4 <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	48650513          	addi	a0,a0,1158 # 6ab8 <malloc+0xe3c>
    263a:	00003097          	auipc	ra,0x3
    263e:	58a080e7          	jalr	1418(ra) # 5bc4 <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1210>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	47650513          	addi	a0,a0,1142 # 6b28 <malloc+0xeac>
    26ba:	00003097          	auipc	ra,0x3
    26be:	50a080e7          	jalr	1290(ra) # 5bc4 <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	44450513          	addi	a0,a0,1092 # 6b48 <malloc+0xecc>
    270c:	00003097          	auipc	ra,0x3
    2710:	4b8080e7          	jalr	1208(ra) # 5bc4 <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	44050513          	addi	a0,a0,1088 # 6ba8 <malloc+0xf2c>
    2770:	00003097          	auipc	ra,0x3
    2774:	454080e7          	jalr	1108(ra) # 5bc4 <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	3de50513          	addi	a0,a0,990 # 6b68 <malloc+0xeec>
    2792:	00003097          	auipc	ra,0x3
    2796:	432080e7          	jalr	1074(ra) # 5bc4 <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	3e250513          	addi	a0,a0,994 # 6b88 <malloc+0xf0c>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	416080e7          	jalr	1046(ra) # 5bc4 <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f120f>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f120f>
  ...
  if(c != a){
    ...
    28f4:	2d850513          	addi	a0,a0,728 # 6bc8 <malloc+0xf4c>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	2cc080e7          	jalr	716(ra) # 5bc4 <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	30450513          	addi	a0,a0,772 # 6c10 <malloc+0xf94>
    2914:	00003097          	auipc	ra,0x3
    2918:	2b0080e7          	jalr	688(ra) # 5bc4 <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	30450513          	addi	a0,a0,772 # 6c30 <malloc+0xfb4>
    2934:	00003097          	auipc	ra,0x3
    2938:	290080e7          	jalr	656(ra) # 5bc4 <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	32450513          	addi	a0,a0,804 # 6c70 <malloc+0xff4>
    2954:	00003097          	auipc	ra,0x3
    2958:	270080e7          	jalr	624(ra) # 5bc4 <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	33850513          	addi	a0,a0,824 # 6ca0 <malloc+0x1024>
    2970:	00003097          	auipc	ra,0x3
    2974:	254080e7          	jalr	596(ra) # 5bc4 <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	35050513          	addi	a0,a0,848 # 6cd8 <malloc+0x105c>
    2990:	00003097          	auipc	ra,0x3
    2994:	234080e7          	jalr	564(ra) # 5bc4 <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	33e50513          	addi	a0,a0,830 # 6d00 <malloc+0x1084>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	eb8080e7          	jalr	-328(ra) # 5882 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	32c50513          	addi	a0,a0,812 # 6d00 <malloc+0x1084>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	2e050513          	addi	a0,a0,736 # 6d08 <malloc+0x108c>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	194080e7          	jalr	404(ra) # 5bc4 <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	2dc50513          	addi	a0,a0,732 # 6d20 <malloc+0x10a4>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	178080e7          	jalr	376(ra) # 5bc4 <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	ca050513          	addi	a0,a0,-864 # 6700 <malloc+0xa84>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	15c080e7          	jalr	348(ra) # 5bc4 <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	2ae50513          	addi	a0,a0,686 # 6d38 <malloc+0x10bc>
  ...
  close(fd);
    ...
    2ad6:	b3e50513          	addi	a0,a0,-1218 # 6610 <malloc+0x994>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	0ea080e7          	jalr	234(ra) # 5bc4 <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	ef850513          	addi	a0,a0,-264 # 6a18 <malloc+0xd9c>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	09c080e7          	jalr	156(ra) # 5bc4 <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	ea250513          	addi	a0,a0,-350 # 6a18 <malloc+0xd9c>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	046080e7          	jalr	70(ra) # 5bc4 <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bda:	e4250513          	addi	a0,a0,-446 # 6a18 <malloc+0xd9c>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	fe6080e7          	jalr	-26(ra) # 5bc4 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cf6:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff120f>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	cce50513          	addi	a0,a0,-818 # 6a18 <malloc+0xd9c>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	e72080e7          	jalr	-398(ra) # 5bc4 <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	00250513          	addi	a0,a0,2 # 5da0 <malloc+0x124>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	06678793          	addi	a5,a5,102 # 5e10 <malloc+0x194>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	13450513          	addi	a0,a0,308 # 6f10 <malloc+0x1294>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	f7a50513          	addi	a0,a0,-134 # 6d68 <malloc+0x10ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	fbc50513          	addi	a0,a0,-68 # 6dc0 <malloc+0x1144>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	01650513          	addi	a0,a0,22 # 6e38 <malloc+0x11bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	06a50513          	addi	a0,a0,106 # 6ea8 <malloc+0x122c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	0b050513          	addi	a0,a0,176 # 6f00 <malloc+0x1284>
  ...
  unlink("12345678901234");
    ...
    2ed2:	e7250513          	addi	a0,a0,-398 # 6d40 <malloc+0x10c4>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	cee080e7          	jalr	-786(ra) # 5bc4 <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	e9e50513          	addi	a0,a0,-354 # 6d88 <malloc+0x110c>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	cd2080e7          	jalr	-814(ra) # 5bc4 <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	eea50513          	addi	a0,a0,-278 # 6df0 <malloc+0x1174>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	cb6080e7          	jalr	-842(ra) # 5bc4 <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f4650513          	addi	a0,a0,-186 # 6e68 <malloc+0x11ec>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	c9a080e7          	jalr	-870(ra) # 5bc4 <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	f8a50513          	addi	a0,a0,-118 # 6ec8 <malloc+0x124c>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	c7e080e7          	jalr	-898(ra) # 5bc4 <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	fc650513          	addi	a0,a0,-58 # 6f20 <malloc+0x12a4>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c62080e7          	jalr	-926(ra) # 5bc4 <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	fd850513          	addi	a0,a0,-40 # 6f58 <malloc+0x12dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	fc450513          	addi	a0,a0,-60 # 6f58 <malloc+0x12dc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	ff050513          	addi	a0,a0,-16 # 6f98 <malloc+0x131c>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	00c50513          	addi	a0,a0,12 # 6fc8 <malloc+0x134c>
    ...
    2fe0:	f8450513          	addi	a0,a0,-124 # 6f60 <malloc+0x12e4>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	be0080e7          	jalr	-1056(ra) # 5bc4 <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	f8050513          	addi	a0,a0,-128 # 6f78 <malloc+0x12fc>
    3000:	00003097          	auipc	ra,0x3
    3004:	bc4080e7          	jalr	-1084(ra) # 5bc4 <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	f9450513          	addi	a0,a0,-108 # 6fa8 <malloc+0x132c>
    301c:	00003097          	auipc	ra,0x3
    3020:	ba8080e7          	jalr	-1112(ra) # 5bc4 <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	fa050513          	addi	a0,a0,-96 # 6fd0 <malloc+0x1354>
    3038:	00003097          	auipc	ra,0x3
    303c:	b8c080e7          	jalr	-1140(ra) # 5bc4 <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	ef450513          	addi	a0,a0,-268 # 6f58 <malloc+0x12dc>
    ...
    307c:	ee050513          	addi	a0,a0,-288 # 6f58 <malloc+0x12dc>
    ...
    3090:	f0c50513          	addi	a0,a0,-244 # 6f98 <malloc+0x131c>
    ...
    30b0:	54c50513          	addi	a0,a0,1356 # 65f8 <malloc+0x97c>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	b10080e7          	jalr	-1264(ra) # 5bc4 <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	e9850513          	addi	a0,a0,-360 # 6f60 <malloc+0x12e4>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	af4080e7          	jalr	-1292(ra) # 5bc4 <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f0450513          	addi	a0,a0,-252 # 6fe8 <malloc+0x136c>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	ad8080e7          	jalr	-1320(ra) # 5bc4 <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	ea850513          	addi	a0,a0,-344 # 6fa8 <malloc+0x132c>
    3108:	00003097          	auipc	ra,0x3
    310c:	abc080e7          	jalr	-1348(ra) # 5bc4 <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	ec250513          	addi	a0,a0,-318 # 7000 <malloc+0x1384>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	eae50513          	addi	a0,a0,-338 # 7000 <malloc+0x1384>
  ...
  if(chdir("..") < 0){
    ...
    316a:	eba50513          	addi	a0,a0,-326 # 7020 <malloc+0x13a4>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	e8650513          	addi	a0,a0,-378 # 7000 <malloc+0x1384>
    ...
    319e:	dc650513          	addi	a0,a0,-570 # 6f60 <malloc+0x12e4>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a22080e7          	jalr	-1502(ra) # 5bc4 <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e5250513          	addi	a0,a0,-430 # 7008 <malloc+0x138c>
    31be:	00003097          	auipc	ra,0x3
    31c2:	a06080e7          	jalr	-1530(ra) # 5bc4 <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e5650513          	addi	a0,a0,-426 # 7028 <malloc+0x13ac>
    31da:	00003097          	auipc	ra,0x3
    31de:	9ea080e7          	jalr	-1558(ra) # 5bc4 <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e5250513          	addi	a0,a0,-430 # 7040 <malloc+0x13c4>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	9ce080e7          	jalr	-1586(ra) # 5bc4 <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	f7250513          	addi	a0,a0,-142 # 7188 <malloc+0x150c>
    321e:	00002097          	auipc	ra,0x2
    3222:	674080e7          	jalr	1652(ra) # 5892 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e3250513          	addi	a0,a0,-462 # 7058 <malloc+0x13dc>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e3a50513          	addi	a0,a0,-454 # 7078 <malloc+0x13fc>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f3258593          	addi	a1,a1,-206 # 7188 <malloc+0x150c>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	de850513          	addi	a0,a0,-536 # 7058 <malloc+0x13dc>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e4c50513          	addi	a0,a0,-436 # 70d0 <malloc+0x1454>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e5c50513          	addi	a0,a0,-420 # 70f8 <malloc+0x147c>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	e7458593          	addi	a1,a1,-396 # 7128 <malloc+0x14ac>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	e6050513          	addi	a0,a0,-416 # 7130 <malloc+0x14b4>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	af858593          	addi	a1,a1,-1288 # bde0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	ae274703          	lbu	a4,-1310(a4) # bde0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	e6858593          	addi	a1,a1,-408 # 7180 <malloc+0x1504>
    3320:	00004517          	auipc	a0,0x4
    3324:	dd850513          	addi	a0,a0,-552 # 70f8 <malloc+0x147c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	dc450513          	addi	a0,a0,-572 # 70f8 <malloc+0x147c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	dae50513          	addi	a0,a0,-594 # 70f8 <malloc+0x147c>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	cfa50513          	addi	a0,a0,-774 # 7058 <malloc+0x13dc>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	ea650513          	addi	a0,a0,-346 # 7218 <malloc+0x159c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	ec250513          	addi	a0,a0,-318 # 7248 <malloc+0x15cc>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	ede50513          	addi	a0,a0,-290 # 7278 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	dd050513          	addi	a0,a0,-560 # 7180 <malloc+0x1504>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	a1858593          	addi	a1,a1,-1512 # bde0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	d0e50513          	addi	a0,a0,-754 # 70f8 <malloc+0x147c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f0650513          	addi	a0,a0,-250 # 7308 <malloc+0x168c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	f1e50513          	addi	a0,a0,-226 # 7338 <malloc+0x16bc>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c2650513          	addi	a0,a0,-986 # 7058 <malloc+0x13dc>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	c1050513          	addi	a0,a0,-1008 # 7058 <malloc+0x13dc>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	bfa50513          	addi	a0,a0,-1030 # 7058 <malloc+0x13dc>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f5658593          	addi	a1,a1,-170 # 73c8 <malloc+0x174c>
    347a:	00004517          	auipc	a0,0x4
    347e:	e8e50513          	addi	a0,a0,-370 # 7308 <malloc+0x168c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f3a58593          	addi	a1,a1,-198 # 73c8 <malloc+0x174c>
    3496:	00004517          	auipc	a0,0x4
    349a:	ea250513          	addi	a0,a0,-350 # 7338 <malloc+0x16bc>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	cd658593          	addi	a1,a1,-810 # 7180 <malloc+0x1504>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	bc650513          	addi	a0,a0,-1082 # 7078 <malloc+0x13fc>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e4250513          	addi	a0,a0,-446 # 7308 <malloc+0x168c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e5e50513          	addi	a0,a0,-418 # 7338 <malloc+0x16bc>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	c9250513          	addi	a0,a0,-878 # 7180 <malloc+0x1504>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e3650513          	addi	a0,a0,-458 # 7338 <malloc+0x16bc>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	df250513          	addi	a0,a0,-526 # 7308 <malloc+0x168c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b4e50513          	addi	a0,a0,-1202 # 7078 <malloc+0x13fc>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	fda50513          	addi	a0,a0,-38 # 7518 <malloc+0x189c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	c2e50513          	addi	a0,a0,-978 # 7180 <malloc+0x1504>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	b1250513          	addi	a0,a0,-1262 # 7078 <malloc+0x13fc>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	ade50513          	addi	a0,a0,-1314 # 7058 <malloc+0x13dc>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	ffa50513          	addi	a0,a0,-6 # 7588 <malloc+0x190c>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	ab650513          	addi	a0,a0,-1354 # 7058 <malloc+0x13dc>
    ...
    35c8:	a9c50513          	addi	a0,a0,-1380 # 7060 <malloc+0x13e4>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	5f8080e7          	jalr	1528(ra) # 5bc4 <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	aa050513          	addi	a0,a0,-1376 # 7080 <malloc+0x1404>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	5dc080e7          	jalr	1500(ra) # 5bc4 <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	aa450513          	addi	a0,a0,-1372 # 70a0 <malloc+0x1424>
    3604:	00002097          	auipc	ra,0x2
    3608:	5c0080e7          	jalr	1472(ra) # 5bc4 <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	ac050513          	addi	a0,a0,-1344 # 70d8 <malloc+0x145c>
    3620:	00002097          	auipc	ra,0x2
    3624:	5a4080e7          	jalr	1444(ra) # 5bc4 <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	ad450513          	addi	a0,a0,-1324 # 7108 <malloc+0x148c>
    363c:	00002097          	auipc	ra,0x2
    3640:	588080e7          	jalr	1416(ra) # 5bc4 <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	af050513          	addi	a0,a0,-1296 # 7140 <malloc+0x14c4>
    3658:	00002097          	auipc	ra,0x2
    365c:	56c080e7          	jalr	1388(ra) # 5bc4 <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	af450513          	addi	a0,a0,-1292 # 7160 <malloc+0x14e4>
    3674:	00002097          	auipc	ra,0x2
    3678:	550080e7          	jalr	1360(ra) # 5bc4 <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	b0850513          	addi	a0,a0,-1272 # 7190 <malloc+0x1514>
    3690:	00002097          	auipc	ra,0x2
    3694:	534080e7          	jalr	1332(ra) # 5bc4 <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	b1450513          	addi	a0,a0,-1260 # 71b8 <malloc+0x153c>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	518080e7          	jalr	1304(ra) # 5bc4 <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	b1850513          	addi	a0,a0,-1256 # 71d8 <malloc+0x155c>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	4fc080e7          	jalr	1276(ra) # 5bc4 <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b2450513          	addi	a0,a0,-1244 # 7200 <malloc+0x1584>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	4e0080e7          	jalr	1248(ra) # 5bc4 <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b3050513          	addi	a0,a0,-1232 # 7228 <malloc+0x15ac>
    3700:	00002097          	auipc	ra,0x2
    3704:	4c4080e7          	jalr	1220(ra) # 5bc4 <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b4450513          	addi	a0,a0,-1212 # 7258 <malloc+0x15dc>
    371c:	00002097          	auipc	ra,0x2
    3720:	4a8080e7          	jalr	1192(ra) # 5bc4 <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b5050513          	addi	a0,a0,-1200 # 7280 <malloc+0x1604>
    3738:	00002097          	auipc	ra,0x2
    373c:	48c080e7          	jalr	1164(ra) # 5bc4 <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b4c50513          	addi	a0,a0,-1204 # 7298 <malloc+0x161c>
    3754:	00002097          	auipc	ra,0x2
    3758:	470080e7          	jalr	1136(ra) # 5bc4 <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b5050513          	addi	a0,a0,-1200 # 72b8 <malloc+0x163c>
    3770:	00002097          	auipc	ra,0x2
    3774:	454080e7          	jalr	1108(ra) # 5bc4 <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b5450513          	addi	a0,a0,-1196 # 72d8 <malloc+0x165c>
    378c:	00002097          	auipc	ra,0x2
    3790:	438080e7          	jalr	1080(ra) # 5bc4 <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	b7850513          	addi	a0,a0,-1160 # 7318 <malloc+0x169c>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	41c080e7          	jalr	1052(ra) # 5bc4 <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	b8c50513          	addi	a0,a0,-1140 # 7348 <malloc+0x16cc>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	400080e7          	jalr	1024(ra) # 5bc4 <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	b9050513          	addi	a0,a0,-1136 # 7368 <malloc+0x16ec>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	3e4080e7          	jalr	996(ra) # 5bc4 <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	b9450513          	addi	a0,a0,-1132 # 7388 <malloc+0x170c>
    37fc:	00002097          	auipc	ra,0x2
    3800:	3c8080e7          	jalr	968(ra) # 5bc4 <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	b9850513          	addi	a0,a0,-1128 # 73a8 <malloc+0x172c>
    3818:	00002097          	auipc	ra,0x2
    381c:	3ac080e7          	jalr	940(ra) # 5bc4 <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	bac50513          	addi	a0,a0,-1108 # 73d8 <malloc+0x175c>
    3834:	00002097          	auipc	ra,0x2
    3838:	390080e7          	jalr	912(ra) # 5bc4 <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	bb850513          	addi	a0,a0,-1096 # 7400 <malloc+0x1784>
    3850:	00002097          	auipc	ra,0x2
    3854:	374080e7          	jalr	884(ra) # 5bc4 <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	bc450513          	addi	a0,a0,-1084 # 7428 <malloc+0x17ac>
    386c:	00002097          	auipc	ra,0x2
    3870:	358080e7          	jalr	856(ra) # 5bc4 <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	bd050513          	addi	a0,a0,-1072 # 7450 <malloc+0x17d4>
    3888:	00002097          	auipc	ra,0x2
    388c:	33c080e7          	jalr	828(ra) # 5bc4 <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	bd450513          	addi	a0,a0,-1068 # 7470 <malloc+0x17f4>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	320080e7          	jalr	800(ra) # 5bc4 <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	bd850513          	addi	a0,a0,-1064 # 7490 <malloc+0x1814>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	304080e7          	jalr	772(ra) # 5bc4 <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	be450513          	addi	a0,a0,-1052 # 74b8 <malloc+0x183c>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	2e8080e7          	jalr	744(ra) # 5bc4 <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	be850513          	addi	a0,a0,-1048 # 74d8 <malloc+0x185c>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	2cc080e7          	jalr	716(ra) # 5bc4 <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	bec50513          	addi	a0,a0,-1044 # 74f8 <malloc+0x187c>
    3914:	00002097          	auipc	ra,0x2
    3918:	2b0080e7          	jalr	688(ra) # 5bc4 <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	bf850513          	addi	a0,a0,-1032 # 7520 <malloc+0x18a4>
    3930:	00002097          	auipc	ra,0x2
    3934:	294080e7          	jalr	660(ra) # 5bc4 <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	87450513          	addi	a0,a0,-1932 # 71b8 <malloc+0x153c>
    394c:	00002097          	auipc	ra,0x2
    3950:	278080e7          	jalr	632(ra) # 5bc4 <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	be050513          	addi	a0,a0,-1056 # 7540 <malloc+0x18c4>
    3968:	00002097          	auipc	ra,0x2
    396c:	25c080e7          	jalr	604(ra) # 5bc4 <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	be450513          	addi	a0,a0,-1052 # 7560 <malloc+0x18e4>
    3984:	00002097          	auipc	ra,0x2
    3988:	240080e7          	jalr	576(ra) # 5bc4 <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	bf850513          	addi	a0,a0,-1032 # 7590 <malloc+0x1914>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	224080e7          	jalr	548(ra) # 5bc4 <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	bfc50513          	addi	a0,a0,-1028 # 75b0 <malloc+0x1934>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	208080e7          	jalr	520(ra) # 5bc4 <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	bee50513          	addi	a0,a0,-1042 # 75c8 <malloc+0x194c>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	bdc50513          	addi	a0,a0,-1060 # 75c8 <malloc+0x194c>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a5a50513          	addi	a0,a0,-1446 # 6458 <malloc+0x7dc>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	61050513          	addi	a0,a0,1552 # 7020 <malloc+0x13a4>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	5a650513          	addi	a0,a0,1446 # 6fc8 <malloc+0x134c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	bfc50513          	addi	a0,a0,-1028 # 7630 <malloc+0x19b4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	c1250513          	addi	a0,a0,-1006 # 7658 <malloc+0x19dc>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	b7050513          	addi	a0,a0,-1168 # 75c8 <malloc+0x194c>
    ...
    3a7a:	b5a50513          	addi	a0,a0,-1190 # 75d0 <malloc+0x1954>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	146080e7          	jalr	326(ra) # 5bc4 <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b5650513          	addi	a0,a0,-1194 # 75e8 <malloc+0x196c>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	12a080e7          	jalr	298(ra) # 5bc4 <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b5250513          	addi	a0,a0,-1198 # 7600 <malloc+0x1984>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	10e080e7          	jalr	270(ra) # 5bc4 <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b4e50513          	addi	a0,a0,-1202 # 7618 <malloc+0x199c>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	0f2080e7          	jalr	242(ra) # 5bc4 <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	4ea50513          	addi	a0,a0,1258 # 6fd0 <malloc+0x1354>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	0d6080e7          	jalr	214(ra) # 5bc4 <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b3650513          	addi	a0,a0,-1226 # 7638 <malloc+0x19bc>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0ba080e7          	jalr	186(ra) # 5bc4 <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b4250513          	addi	a0,a0,-1214 # 7660 <malloc+0x19e4>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	09e080e7          	jalr	158(ra) # 5bc4 <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b4650513          	addi	a0,a0,-1210 # 7680 <malloc+0x1a04>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	082080e7          	jalr	130(ra) # 5bc4 <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b3a50513          	addi	a0,a0,-1222 # 76a0 <malloc+0x1a24>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	b1e50513          	addi	a0,a0,-1250 # 76a0 <malloc+0x1a24>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b5250513          	addi	a0,a0,-1198 # 76e8 <malloc+0x1a6c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b3a50513          	addi	a0,a0,-1222 # 76e8 <malloc+0x1a6c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b2650513          	addi	a0,a0,-1242 # 76e8 <malloc+0x1a6c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	b1250513          	addi	a0,a0,-1262 # 76e8 <malloc+0x1a6c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	afe58593          	addi	a1,a1,-1282 # 76e8 <malloc+0x1a6c>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	35650513          	addi	a0,a0,854 # 5f48 <malloc+0x2cc>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	a9a50513          	addi	a0,a0,-1382 # 76a0 <malloc+0x1a24>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	83c50513          	addi	a0,a0,-1988 # 6458 <malloc+0x7dc>
  ...
  fd = open(".", 0);
    ...
    3c36:	82650513          	addi	a0,a0,-2010 # 6458 <malloc+0x7dc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	1ca58593          	addi	a1,a1,458 # 5e10 <malloc+0x194>
  ...
  close(fd);
    ...
    3c76:	a3650513          	addi	a0,a0,-1482 # 76a8 <malloc+0x1a2c>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f4a080e7          	jalr	-182(ra) # 5bc4 <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a3a50513          	addi	a0,a0,-1478 # 76c8 <malloc+0x1a4c>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f2e080e7          	jalr	-210(ra) # 5bc4 <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a4e50513          	addi	a0,a0,-1458 # 76f8 <malloc+0x1a7c>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	f12080e7          	jalr	-238(ra) # 5bc4 <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a3250513          	addi	a0,a0,-1486 # 76f8 <malloc+0x1a7c>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	ef6080e7          	jalr	-266(ra) # 5bc4 <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a3e50513          	addi	a0,a0,-1474 # 7720 <malloc+0x1aa4>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	eda080e7          	jalr	-294(ra) # 5bc4 <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a4a50513          	addi	a0,a0,-1462 # 7748 <malloc+0x1acc>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	ebe080e7          	jalr	-322(ra) # 5bc4 <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a5650513          	addi	a0,a0,-1450 # 7770 <malloc+0x1af4>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	ea2080e7          	jalr	-350(ra) # 5bc4 <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	a6250513          	addi	a0,a0,-1438 # 7798 <malloc+0x1b1c>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	e86080e7          	jalr	-378(ra) # 5bc4 <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	a6650513          	addi	a0,a0,-1434 # 77b8 <malloc+0x1b3c>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	e6a080e7          	jalr	-406(ra) # 5bc4 <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	a7250513          	addi	a0,a0,-1422 # 77e0 <malloc+0x1b64>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e4e080e7          	jalr	-434(ra) # 5bc4 <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a56a0a13          	addi	s4,s4,-1450 # 77f8 <malloc+0x1b7c>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	55648493          	addi	s1,s1,1366 # 7300 <malloc+0x1684>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	196a8a93          	addi	s5,s5,406 # 5f48 <malloc+0x2cc>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	93698993          	addi	s3,s3,-1738 # 76f0 <malloc+0x1a74>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a3a50513          	addi	a0,a0,-1478 # 7800 <malloc+0x1b84>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	df6080e7          	jalr	-522(ra) # 5bc4 <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a3650513          	addi	a0,a0,-1482 # 7818 <malloc+0x1b9c>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	dda080e7          	jalr	-550(ra) # 5bc4 <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	1aa98993          	addi	s3,s3,426 # 7020 <malloc+0x13a4>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	97a90913          	addi	s2,s2,-1670 # 77f8 <malloc+0x1b7c>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	12a50513          	addi	a0,a0,298 # 6fc8 <malloc+0x134c>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	96250513          	addi	a0,a0,-1694 # 7830 <malloc+0x1bb4>
  ...
  if(pid == 0){
    ...
    3ef6:	93e50513          	addi	a0,a0,-1730 # 7830 <malloc+0x1bb4>
    ...
    3f0c:	94850513          	addi	a0,a0,-1720 # 7850 <malloc+0x1bd4>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	cb4080e7          	jalr	-844(ra) # 5bc4 <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	91450513          	addi	a0,a0,-1772 # 7838 <malloc+0x1bbc>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	c98080e7          	jalr	-872(ra) # 5bc4 <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	6b850513          	addi	a0,a0,1720 # 65f8 <malloc+0x97c>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	c7c080e7          	jalr	-900(ra) # 5bc4 <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	8c250513          	addi	a0,a0,-1854 # 7830 <malloc+0x1bb4>
    ...
    3f86:	86650513          	addi	a0,a0,-1946 # 67e8 <malloc+0xb6c>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c3a080e7          	jalr	-966(ra) # 5bc4 <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	8b850513          	addi	a0,a0,-1864 # 7878 <malloc+0x1bfc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	88c50513          	addi	a0,a0,-1908 # 7878 <malloc+0x1bfc>
  ...
  sleep(10); // one second
    ...
    4028:	79450513          	addi	a0,a0,1940 # 67b8 <malloc+0xb3c>
    402c:	00002097          	auipc	ra,0x2
    4030:	b98080e7          	jalr	-1128(ra) # 5bc4 <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	83a48493          	addi	s1,s1,-1990 # 7878 <malloc+0x1bfc>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	51250513          	addi	a0,a0,1298 # 65f8 <malloc+0x97c>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	ad6080e7          	jalr	-1322(ra) # 5bc4 <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	77c50513          	addi	a0,a0,1916 # 7888 <malloc+0x1c0c>
    4114:	00002097          	auipc	ra,0x2
    4118:	ab0080e7          	jalr	-1360(ra) # 5bc4 <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	66c50513          	addi	a0,a0,1644 # 67b8 <malloc+0xb3c>
    4154:	00002097          	auipc	ra,0x2
    4158:	a70080e7          	jalr	-1424(ra) # 5bc4 <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	47e50513          	addi	a0,a0,1150 # 65f8 <malloc+0x97c>
    4182:	00002097          	auipc	ra,0x2
    4186:	a42080e7          	jalr	-1470(ra) # 5bc4 <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	c5258593          	addi	a1,a1,-942 # 5e10 <malloc+0x194>
    ...
    41ec:	41050513          	addi	a0,a0,1040 # 65f8 <malloc+0x97c>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	9d4080e7          	jalr	-1580(ra) # 5bc4 <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	6a450513          	addi	a0,a0,1700 # 78a8 <malloc+0x1c2c>
    420c:	00002097          	auipc	ra,0x2
    4210:	9b8080e7          	jalr	-1608(ra) # 5bc4 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4228:	bbc58593          	addi	a1,a1,-1092 # bde0 <buf>
    ...
    4244:	68050513          	addi	a0,a0,1664 # 78c0 <malloc+0x1c44>
    4248:	00002097          	auipc	ra,0x2
    424c:	97c080e7          	jalr	-1668(ra) # 5bc4 <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	66c50513          	addi	a0,a0,1644 # 78d8 <malloc+0x1c5c>
    4274:	00002097          	auipc	ra,0x2
    4278:	950080e7          	jalr	-1712(ra) # 5bc4 <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	64e50513          	addi	a0,a0,1614 # 78e8 <malloc+0x1c6c>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	922080e7          	jalr	-1758(ra) # 5bc4 <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	2de50513          	addi	a0,a0,734 # 65f8 <malloc+0x97c>
    4322:	00002097          	auipc	ra,0x2
    4326:	8a2080e7          	jalr	-1886(ra) # 5bc4 <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	44a50513          	addi	a0,a0,1098 # 6780 <malloc+0xb04>
    433e:	00002097          	auipc	ra,0x2
    4342:	886080e7          	jalr	-1914(ra) # 5bc4 <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	35450513          	addi	a0,a0,852 # 6700 <malloc+0xa84>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	810080e7          	jalr	-2032(ra) # 5bc4 <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	a3058593          	addi	a1,a1,-1488 # 5e10 <malloc+0x194>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	45450513          	addi	a0,a0,1108 # 78f8 <malloc+0x1c7c>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	718080e7          	jalr	1816(ra) # 5bc4 <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	13850513          	addi	a0,a0,312 # 65f8 <malloc+0x97c>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	6fc080e7          	jalr	1788(ra) # 5bc4 <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    44fa:	6705                	lui	a4,0x1
      n += *(a+i);
    44fc:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1210>
    ...
    4510:	40c50513          	addi	a0,a0,1036 # 7918 <malloc+0x1c9c>
    4514:	00001097          	auipc	ra,0x1
    4518:	6b0080e7          	jalr	1712(ra) # 5bc4 <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	706080e7          	jalr	1798(ra) # 5c7c <malloc>
    ...
    45b4:	39850513          	addi	a0,a0,920 # 7948 <malloc+0x1ccc>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	60c080e7          	jalr	1548(ra) # 5bc4 <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	31250513          	addi	a0,a0,786 # 7978 <malloc+0x1cfc>
    466e:	00001097          	auipc	ra,0x1
    4672:	556080e7          	jalr	1366(ra) # 5bc4 <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	31e50513          	addi	a0,a0,798 # 79a0 <malloc+0x1d24>
    468a:	00001097          	auipc	ra,0x1
    468e:	53a080e7          	jalr	1338(ra) # 5bc4 <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	2a250513          	addi	a0,a0,674 # 7968 <malloc+0x1cec>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	2ba50513          	addi	a0,a0,698 # 79c0 <malloc+0x1d44>
    470e:	00001097          	auipc	ra,0x1
    4712:	4b6080e7          	jalr	1206(ra) # 5bc4 <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	22650513          	addi	a0,a0,550 # 7968 <malloc+0x1cec>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	28050513          	addi	a0,a0,640 # 79e8 <malloc+0x1d6c>
    4770:	00001097          	auipc	ra,0x1
    4774:	454080e7          	jalr	1108(ra) # 5bc4 <printf>
    exit(1);
    4778:	4505                	li	a0,1
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	25278793          	addi	a5,a5,594 # 7a00 <malloc+0x1d84>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	24e78793          	addi	a5,a5,590 # 7a08 <malloc+0x1d8c>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	24a78793          	addi	a5,a5,586 # 7a10 <malloc+0x1d94>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	24678793          	addi	a5,a5,582 # 7a18 <malloc+0x1d9c>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    482e:	5b6a0a13          	addi	s4,s4,1462 # bde0 <buf>
    4832:	00007a97          	auipc	s5,0x7
    4836:	5afa8a93          	addi	s5,s5,1455 # bde1 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	1ce50513          	addi	a0,a0,462 # 6a18 <malloc+0xd9c>
    4852:	00001097          	auipc	ra,0x1
    4856:	372080e7          	jalr	882(ra) # 5bc4 <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	15a50513          	addi	a0,a0,346 # 7a20 <malloc+0x1da4>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	2f6080e7          	jalr	758(ra) # 5bc4 <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	15050513          	addi	a0,a0,336 # 7a30 <malloc+0x1db4>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	2dc080e7          	jalr	732(ra) # 5bc4 <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	14050513          	addi	a0,a0,320 # 7a48 <malloc+0x1dcc>
    4910:	00001097          	auipc	ra,0x1
    4914:	2b4080e7          	jalr	692(ra) # 5bc4 <printf>
          exit(1);
    4918:	4505                	li	a0,1
    ...
    493c:	4a878793          	addi	a5,a5,1192 # bde0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	0c250513          	addi	a0,a0,194 # 7a58 <malloc+0x1ddc>
    499e:	00001097          	auipc	ra,0x1
    49a2:	226080e7          	jalr	550(ra) # 5bc4 <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	078b8b93          	addi	s7,s7,120 # 7a70 <malloc+0x1df4>
  for(i = 0; i < N; i++){
    ...
    4a3e:	03e50513          	addi	a0,a0,62 # 7a78 <malloc+0x1dfc>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	182080e7          	jalr	386(ra) # 5bc4 <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	01850513          	addi	a0,a0,24 # 7a70 <malloc+0x1df4>
  ...
  fd = open(".", 0);
    ...
    4a94:	9c850513          	addi	a0,a0,-1592 # 6458 <malloc+0x7dc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	f9050513          	addi	a0,a0,-112 # 7a98 <malloc+0x1e1c>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	0b4080e7          	jalr	180(ra) # 5bc4 <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	f9050513          	addi	a0,a0,-112 # 7ab8 <malloc+0x1e3c>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	094080e7          	jalr	148(ra) # 5bc4 <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	f8050513          	addi	a0,a0,-128 # 7ae0 <malloc+0x1e64>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	05c080e7          	jalr	92(ra) # 5bc4 <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	a7c50513          	addi	a0,a0,-1412 # 65f8 <malloc+0x97c>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	040080e7          	jalr	64(ra) # 5bc4 <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6a:	07a90913          	addi	s2,s2,122 # bde0 <buf>
  for(i = 0; i < N; i++){
    4d6e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	d6a50513          	addi	a0,a0,-662 # 7b18 <malloc+0x1e9c>
  ...
  for(i = 0; ; i++){
    ...
    4dc8:	01c90913          	addi	s2,s2,28 # bde0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e16:	d1650513          	addi	a0,a0,-746 # 7b28 <malloc+0x1eac>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	daa080e7          	jalr	-598(ra) # 5bc4 <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	d1a50513          	addi	a0,a0,-742 # 7b48 <malloc+0x1ecc>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	d8e080e7          	jalr	-626(ra) # 5bc4 <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	d1e50513          	addi	a0,a0,-738 # 7b68 <malloc+0x1eec>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	d72080e7          	jalr	-654(ra) # 5bc4 <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	d2250513          	addi	a0,a0,-734 # 7b88 <malloc+0x1f0c>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	d56080e7          	jalr	-682(ra) # 5bc4 <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	d2650513          	addi	a0,a0,-730 # 7ba8 <malloc+0x1f2c>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	d3a080e7          	jalr	-710(ra) # 5bc4 <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	d2250513          	addi	a0,a0,-734 # 7bc0 <malloc+0x1f44>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	d1e080e7          	jalr	-738(ra) # 5bc4 <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	c4c50513          	addi	a0,a0,-948 # 7b18 <malloc+0x1e9c>
    ...
    4ef4:	cf050513          	addi	a0,a0,-784 # 7be0 <malloc+0x1f64>
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	ccc080e7          	jalr	-820(ra) # 5bc4 <printf>
    exit(1);
    4f00:	4505                	li	a0,1
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	cd850513          	addi	a0,a0,-808 # 7c00 <malloc+0x1f84>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	c94080e7          	jalr	-876(ra) # 5bc4 <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	cc8c8c93          	addi	s9,s9,-824 # 7c10 <malloc+0x1f94>
    int total = 0;
    4f50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f52:	00007a17          	auipc	s4,0x7
    4f56:	e8ea0a13          	addi	s4,s4,-370 # bde0 <buf>
    name[0] = 'f';
    ...
    4fa4:	c24080e7          	jalr	-988(ra) # 5bc4 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	c5e50513          	addi	a0,a0,-930 # 7c20 <malloc+0x1fa4>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	bfa080e7          	jalr	-1030(ra) # 5bc4 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	c0850513          	addi	a0,a0,-1016 # 7c40 <malloc+0x1fc4>
    5040:	00001097          	auipc	ra,0x1
    5044:	b84080e7          	jalr	-1148(ra) # 5bc4 <printf>
}
    ...
    508c:	ba850513          	addi	a0,a0,-1112 # 7c30 <malloc+0x1fb4>
    5090:	00001097          	auipc	ra,0x1
    5094:	b34080e7          	jalr	-1228(ra) # 5bc4 <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	b3e50513          	addi	a0,a0,-1218 # 7c58 <malloc+0x1fdc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	cde58593          	addi	a1,a1,-802 # 5e10 <malloc+0x194>
    ...
    514c:	b3050513          	addi	a0,a0,-1232 # 7c78 <malloc+0x1ffc>
    5150:	00001097          	auipc	ra,0x1
    5154:	a74080e7          	jalr	-1420(ra) # 5bc4 <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	afe50513          	addi	a0,a0,-1282 # 7c60 <malloc+0x1fe4>
    516a:	00001097          	auipc	ra,0x1
    516e:	a5a080e7          	jalr	-1446(ra) # 5bc4 <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	ae450513          	addi	a0,a0,-1308 # 7c60 <malloc+0x1fe4>
    5184:	00001097          	auipc	ra,0x1
    5188:	a40080e7          	jalr	-1472(ra) # 5bc4 <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	ab850513          	addi	a0,a0,-1352 # 7c58 <malloc+0x1fdc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	c1a98993          	addi	s3,s3,-998 # 5e10 <malloc+0x194>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	aa050513          	addi	a0,a0,-1376 # 7cc8 <malloc+0x204c>
    5230:	00001097          	auipc	ra,0x1
    5234:	994080e7          	jalr	-1644(ra) # 5bc4 <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	a4650513          	addi	a0,a0,-1466 # 7c88 <malloc+0x200c>
    524a:	00001097          	auipc	ra,0x1
    524e:	97a080e7          	jalr	-1670(ra) # 5bc4 <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	a4c50513          	addi	a0,a0,-1460 # 7ca8 <malloc+0x202c>
    5264:	00001097          	auipc	ra,0x1
    5268:	960080e7          	jalr	-1696(ra) # 5bc4 <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	a3e50513          	addi	a0,a0,-1474 # 7ce8 <malloc+0x206c>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	912080e7          	jalr	-1774(ra) # 5bc4 <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	a0e50513          	addi	a0,a0,-1522 # 7d08 <malloc+0x208c>
    5302:	00001097          	auipc	ra,0x1
    5306:	8c2080e7          	jalr	-1854(ra) # 5bc4 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a0650513          	addi	a0,a0,-1530 # 7d30 <malloc+0x20b4>
    5332:	00001097          	auipc	ra,0x1
    5336:	892080e7          	jalr	-1902(ra) # 5bc4 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	9ca50513          	addi	a0,a0,-1590 # 7d18 <malloc+0x209c>
    5356:	00001097          	auipc	ra,0x1
    535a:	86e080e7          	jalr	-1938(ra) # 5bc4 <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	9c250513          	addi	a0,a0,-1598 # 7d38 <malloc+0x20bc>
    537e:	00001097          	auipc	ra,0x1
    5382:	846080e7          	jalr	-1978(ra) # 5bc4 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	d9078793          	addi	a5,a5,-624 # 8150 <malloc+0x24d4>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	17430313          	addi	t1,t1,372 # 8540 <malloc+0x28c4>
  ...
  printf("usertests starting\n");
    ...
    5404:	9f050513          	addi	a0,a0,-1552 # 7df0 <malloc+0x2174>
    5408:	00000097          	auipc	ra,0x0
    540c:	7bc080e7          	jalr	1980(ra) # 5bc4 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	97050513          	addi	a0,a0,-1680 # 7da8 <malloc+0x212c>
    5440:	00000097          	auipc	ra,0x0
    5444:	784080e7          	jalr	1924(ra) # 5bc4 <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	8ec58593          	addi	a1,a1,-1812 # 7d40 <malloc+0x20c4>
    ...
    546e:	9be58593          	addi	a1,a1,-1602 # 7e28 <malloc+0x21ac>
    ...
    5492:	8ba50513          	addi	a0,a0,-1862 # 7d48 <malloc+0x20cc>
    5496:	00000097          	auipc	ra,0x0
    549a:	72e080e7          	jalr	1838(ra) # 5bc4 <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	70c080e7          	jalr	1804(ra) # 5bc4 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	89650513          	addi	a0,a0,-1898 # 7d90 <malloc+0x2114>
    5502:	00000097          	auipc	ra,0x0
    5506:	6c2080e7          	jalr	1730(ra) # 5bc4 <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	8c450513          	addi	a0,a0,-1852 # 7dd8 <malloc+0x215c>
    551c:	00000097          	auipc	ra,0x0
    5520:	6a8080e7          	jalr	1704(ra) # 5bc4 <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	694080e7          	jalr	1684(ra) # 5bc4 <printf>
        if(continuous != 2)
    ...
    5576:	bde78793          	addi	a5,a5,-1058 # 8150 <malloc+0x24d4>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	fc230313          	addi	t1,t1,-62 # 8540 <malloc+0x28c4>
    ...
    55b6:	85650513          	addi	a0,a0,-1962 # 7e08 <malloc+0x218c>
    55ba:	00000097          	auipc	ra,0x0
    55be:	60a080e7          	jalr	1546(ra) # 5bc4 <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00002a97          	auipc	s5,0x2
    55c6:	7cea8a93          	addi	s5,s5,1998 # 7d90 <malloc+0x2114>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00002b17          	auipc	s6,0x2
    55d0:	7a4b0b13          	addi	s6,s6,1956 # 7d70 <malloc+0x20f4>
...
putc(int fd, char c)
{
    58ea:	1101                	addi	sp,sp,-32
    58ec:	ec06                	sd	ra,24(sp)
    58ee:	e822                	sd	s0,16(sp)
    58f0:	1000                	addi	s0,sp,32
    58f2:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    58f6:	4605                	li	a2,1
    58f8:	fef40593          	addi	a1,s0,-17
    58fc:	00000097          	auipc	ra,0x0
    5900:	f66080e7          	jalr	-154(ra) # 5862 <write>
}
    5904:	60e2                	ld	ra,24(sp)
    5906:	6442                	ld	s0,16(sp)
    5908:	6105                	addi	sp,sp,32
    590a:	8082                	ret

000000000000590c <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    590c:	7139                	addi	sp,sp,-64
    590e:	fc06                	sd	ra,56(sp)
    5910:	f822                	sd	s0,48(sp)
    5912:	f426                	sd	s1,40(sp)
    5914:	f04a                	sd	s2,32(sp)
    5916:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    591c:	c299                	beqz	a3,5922 <printint+0x16>
    591e:	0805c963          	bltz	a1,59b0 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5922:	2581                	sext.w	a1,a1
  neg = 0;
    5924:	4881                	li	a7,0
    5926:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    592c:	2601                	sext.w	a2,a2
    592e:	00003517          	auipc	a0,0x3
    5932:	c7250513          	addi	a0,a0,-910 # 85a0 <digits>
    5936:	883a                	mv	a6,a4
    5938:	2705                	addiw	a4,a4,1
    593a:	02c5f7bb          	remuw	a5,a1,a2
    593e:	1782                	slli	a5,a5,0x20
    5940:	9381                	srli	a5,a5,0x20
    5942:	97aa                	add	a5,a5,a0
    5944:	0007c783          	lbu	a5,0(a5)
    5948:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    594c:	0005879b          	sext.w	a5,a1
    5950:	02c5d5bb          	divuw	a1,a1,a2
    5954:	0685                	addi	a3,a3,1
    5956:	fec7f0e3          	bgeu	a5,a2,5936 <printint+0x2a>
  if(neg)
    595a:	00088c63          	beqz	a7,5972 <printint+0x66>
    buf[i++] = '-';
    595e:	fd070793          	addi	a5,a4,-48
    5962:	00878733          	add	a4,a5,s0
    5966:	02d00793          	li	a5,45
    596a:	fef70823          	sb	a5,-16(a4)
    596e:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5972:	02e05863          	blez	a4,59a2 <printint+0x96>
    5976:	fc040793          	addi	a5,s0,-64
    597a:	00e78933          	add	s2,a5,a4
    597e:	fff78993          	addi	s3,a5,-1
    5982:	99ba                	add	s3,s3,a4
    5984:	377d                	addiw	a4,a4,-1
    5986:	1702                	slli	a4,a4,0x20
    5988:	9301                	srli	a4,a4,0x20
    598a:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    598e:	fff94583          	lbu	a1,-1(s2)
    5992:	8526                	mv	a0,s1
    5994:	00000097          	auipc	ra,0x0
    5998:	f56080e7          	jalr	-170(ra) # 58ea <putc>
  while(--i >= 0)
    599c:	197d                	addi	s2,s2,-1
    599e:	ff3918e3          	bne	s2,s3,598e <printint+0x82>
}
    59a2:	70e2                	ld	ra,56(sp)
    59a4:	7442                	ld	s0,48(sp)
    59a6:	74a2                	ld	s1,40(sp)
    59a8:	7902                	ld	s2,32(sp)
    59aa:	69e2                	ld	s3,24(sp)
    59ac:	6121                	addi	sp,sp,64
    59ae:	8082                	ret
    x = -xx;
    59b0:	40b005bb          	negw	a1,a1
    neg = 1;
    59b4:	4885                	li	a7,1
    x = -xx;
    59b6:	bf85                	j	5926 <printint+0x1a>

00000000000059b8 <vprintf>:
}
...
{
    59b8:	7119                	addi	sp,sp,-128
    59ba:	fc86                	sd	ra,120(sp)
    59bc:	f8a2                	sd	s0,112(sp)
    59be:	f4a6                	sd	s1,104(sp)
    59c0:	f0ca                	sd	s2,96(sp)
    59c2:	ecce                	sd	s3,88(sp)
    59c4:	e8d2                	sd	s4,80(sp)
    59c6:	e4d6                	sd	s5,72(sp)
    59c8:	e0da                	sd	s6,64(sp)
    59ca:	fc5e                	sd	s7,56(sp)
    59cc:	f862                	sd	s8,48(sp)
    59ce:	f466                	sd	s9,40(sp)
    59d0:	f06a                	sd	s10,32(sp)
    59d2:	ec6e                	sd	s11,24(sp)
    59d4:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    59d6:	0005c903          	lbu	s2,0(a1)
    59da:	18090f63          	beqz	s2,5b78 <vprintf+0x1c0>
    59de:	8aaa                	mv	s5,a0
    59e0:	8b32                	mv	s6,a2
    59e2:	00158493          	addi	s1,a1,1
  state = 0;
    59e6:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    59e8:	02500a13          	li	s4,37
    59ec:	4c55                	li	s8,21
    59ee:	00003c97          	auipc	s9,0x3
    59f2:	b5ac8c93          	addi	s9,s9,-1190 # 8548 <malloc+0x28cc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    59f6:	02800d93          	li	s11,40
  putc(fd, 'x');
    59fa:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    59fc:	00003b97          	auipc	s7,0x3
    5a00:	ba4b8b93          	addi	s7,s7,-1116 # 85a0 <digits>
    5a04:	a839                	j	5a22 <vprintf+0x6a>
        putc(fd, c);
    5a06:	85ca                	mv	a1,s2
    5a08:	8556                	mv	a0,s5
    5a0a:	00000097          	auipc	ra,0x0
    5a0e:	ee0080e7          	jalr	-288(ra) # 58ea <putc>
    5a12:	a019                	j	5a18 <vprintf+0x60>
    } else if(state == '%'){
    5a14:	01498d63          	beq	s3,s4,5a2e <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5a18:	0485                	addi	s1,s1,1
    5a1a:	fff4c903          	lbu	s2,-1(s1)
    5a1e:	14090d63          	beqz	s2,5b78 <vprintf+0x1c0>
    if(state == 0){
    5a22:	fe0999e3          	bnez	s3,5a14 <vprintf+0x5c>
      if(c == '%'){
    5a26:	ff4910e3          	bne	s2,s4,5a06 <vprintf+0x4e>
        state = '%';
    5a2a:	89d2                	mv	s3,s4
    5a2c:	b7f5                	j	5a18 <vprintf+0x60>
      if(c == 'd'){
    5a2e:	11490c63          	beq	s2,s4,5b46 <vprintf+0x18e>
    5a32:	f9d9079b          	addiw	a5,s2,-99
    5a36:	0ff7f793          	zext.b	a5,a5
    5a3a:	10fc6e63          	bltu	s8,a5,5b56 <vprintf+0x19e>
    5a3e:	f9d9079b          	addiw	a5,s2,-99
    5a42:	0ff7f713          	zext.b	a4,a5
    5a46:	10ec6863          	bltu	s8,a4,5b56 <vprintf+0x19e>
    5a4a:	00271793          	slli	a5,a4,0x2
    5a4e:	97e6                	add	a5,a5,s9
    5a50:	439c                	lw	a5,0(a5)
    5a52:	97e6                	add	a5,a5,s9
    5a54:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5a56:	008b0913          	addi	s2,s6,8
    5a5a:	4685                	li	a3,1
    5a5c:	4629                	li	a2,10
    5a5e:	000b2583          	lw	a1,0(s6)
    5a62:	8556                	mv	a0,s5
    5a64:	00000097          	auipc	ra,0x0
    5a68:	ea8080e7          	jalr	-344(ra) # 590c <printint>
    5a6c:	8b4a                	mv	s6,s2
      } else {
      ...
      state = 0;
    5a6e:	4981                	li	s3,0
    5a70:	b765                	j	5a18 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5a72:	008b0913          	addi	s2,s6,8
    5a76:	4681                	li	a3,0
    5a78:	4629                	li	a2,10
    5a7a:	000b2583          	lw	a1,0(s6)
    5a7e:	8556                	mv	a0,s5
    5a80:	00000097          	auipc	ra,0x0
    5a84:	e8c080e7          	jalr	-372(ra) # 590c <printint>
    5a88:	8b4a                	mv	s6,s2
      state = 0;
    5a8a:	4981                	li	s3,0
    5a8c:	b771                	j	5a18 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5a8e:	008b0913          	addi	s2,s6,8
    5a92:	4681                	li	a3,0
    5a94:	866a                	mv	a2,s10
    5a96:	000b2583          	lw	a1,0(s6)
    5a9a:	8556                	mv	a0,s5
    5a9c:	00000097          	auipc	ra,0x0
    5aa0:	e70080e7          	jalr	-400(ra) # 590c <printint>
    5aa4:	8b4a                	mv	s6,s2
      state = 0;
    5aa6:	4981                	li	s3,0
    5aa8:	bf85                	j	5a18 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5aaa:	008b0793          	addi	a5,s6,8
    5aae:	f8f43423          	sd	a5,-120(s0)
    5ab2:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5ab6:	03000593          	li	a1,48
    5aba:	8556                	mv	a0,s5
    5abc:	00000097          	auipc	ra,0x0
    5ac0:	e2e080e7          	jalr	-466(ra) # 58ea <putc>
  putc(fd, 'x');
    5ac4:	07800593          	li	a1,120
    5ac8:	8556                	mv	a0,s5
    5aca:	00000097          	auipc	ra,0x0
    5ace:	e20080e7          	jalr	-480(ra) # 58ea <putc>
    5ad2:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5ae4:	e0a080e7          	jalr	-502(ra) # 58ea <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5ae8:	0992                	slli	s3,s3,0x4
    5aea:	397d                	addiw	s2,s2,-1
    5aec:	fe0914e3          	bnez	s2,5ad4 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5af0:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5af4:	4981                	li	s3,0
    5af6:	b70d                	j	5a18 <vprintf+0x60>
        s = va_arg(ap, char*);
    5af8:	008b0913          	addi	s2,s6,8
    5afc:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5b00:	02098163          	beqz	s3,5b22 <vprintf+0x16a>
        while(*s != 0){
    5b04:	0009c583          	lbu	a1,0(s3)
    5b08:	c5ad                	beqz	a1,5b72 <vprintf+0x1ba>
          putc(fd, *s);
    5b0a:	8556                	mv	a0,s5
    5b0c:	00000097          	auipc	ra,0x0
    5b10:	dde080e7          	jalr	-546(ra) # 58ea <putc>
          s++;
    5b14:	0985                	addi	s3,s3,1
        while(*s != 0){
    5b16:	0009c583          	lbu	a1,0(s3)
    5b1a:	f9e5                	bnez	a1,5b0a <vprintf+0x152>
        s = va_arg(ap, char*);
    5b1c:	8b4a                	mv	s6,s2
      state = 0;
    5b1e:	4981                	li	s3,0
    5b20:	bde5                	j	5a18 <vprintf+0x60>
          s = "(null)";
    5b22:	00003997          	auipc	s3,0x3
    5b26:	a1e98993          	addi	s3,s3,-1506 # 8540 <malloc+0x28c4>
        while(*s != 0){
    5b2a:	85ee                	mv	a1,s11
    5b2c:	bff9                	j	5b0a <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5b2e:	008b0913          	addi	s2,s6,8
    5b32:	000b4583          	lbu	a1,0(s6)
    5b36:	8556                	mv	a0,s5
    5b38:	00000097          	auipc	ra,0x0
    5b3c:	db2080e7          	jalr	-590(ra) # 58ea <putc>
    5b40:	8b4a                	mv	s6,s2
      state = 0;
    5b42:	4981                	li	s3,0
    5b44:	bdd1                	j	5a18 <vprintf+0x60>
        putc(fd, c);
    5b46:	85d2                	mv	a1,s4
    5b48:	8556                	mv	a0,s5
    5b4a:	00000097          	auipc	ra,0x0
    5b4e:	da0080e7          	jalr	-608(ra) # 58ea <putc>
      state = 0;
    5b52:	4981                	li	s3,0
    5b54:	b5d1                	j	5a18 <vprintf+0x60>
        putc(fd, '%');
    5b56:	85d2                	mv	a1,s4
    5b58:	8556                	mv	a0,s5
    5b5a:	00000097          	auipc	ra,0x0
    5b5e:	d90080e7          	jalr	-624(ra) # 58ea <putc>
        putc(fd, c);
    5b62:	85ca                	mv	a1,s2
    5b64:	8556                	mv	a0,s5
    5b66:	00000097          	auipc	ra,0x0
    5b6a:	d84080e7          	jalr	-636(ra) # 58ea <putc>
      state = 0;
    5b6e:	4981                	li	s3,0
    5b70:	b565                	j	5a18 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b72:	8b4a                	mv	s6,s2
      state = 0;
    5b74:	4981                	li	s3,0
    5b76:	b54d                	j	5a18 <vprintf+0x60>
    }
  }
}
    5b78:	70e6                	ld	ra,120(sp)
    5b7a:	7446                	ld	s0,112(sp)
    5b7c:	74a6                	ld	s1,104(sp)
    5b7e:	7906                	ld	s2,96(sp)
    5b80:	69e6                	ld	s3,88(sp)
    5b82:	6a46                	ld	s4,80(sp)
    5b84:	6aa6                	ld	s5,72(sp)
    5b86:	6b06                	ld	s6,64(sp)
    5b88:	7be2                	ld	s7,56(sp)
    5b8a:	7c42                	ld	s8,48(sp)
    5b8c:	7ca2                	ld	s9,40(sp)
    5b8e:	7d02                	ld	s10,32(sp)
    5b90:	6de2                	ld	s11,24(sp)
    5b92:	6109                	addi	sp,sp,128
    5b94:	8082                	ret

0000000000005b96 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5b96:	715d                	addi	sp,sp,-80
    5b98:	ec06                	sd	ra,24(sp)
    5b9a:	e822                	sd	s0,16(sp)
    5b9c:	1000                	addi	s0,sp,32
    5b9e:	e010                	sd	a2,0(s0)
    5ba0:	e414                	sd	a3,8(s0)
    5ba2:	e818                	sd	a4,16(s0)
    5ba4:	ec1c                	sd	a5,24(s0)
    5ba6:	03043023          	sd	a6,32(s0)
    5baa:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bae:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bb2:	8622                	mv	a2,s0
    5bb4:	00000097          	auipc	ra,0x0
    5bb8:	e04080e7          	jalr	-508(ra) # 59b8 <vprintf>
}
    5bbc:	60e2                	ld	ra,24(sp)
    5bbe:	6442                	ld	s0,16(sp)
    5bc0:	6161                	addi	sp,sp,80
    5bc2:	8082                	ret

0000000000005bc4 <printf>:

void
printf(const char *fmt, ...)
{
    5bc4:	711d                	addi	sp,sp,-96
    5bc6:	ec06                	sd	ra,24(sp)
    5bc8:	e822                	sd	s0,16(sp)
    5bca:	1000                	addi	s0,sp,32
    5bcc:	e40c                	sd	a1,8(s0)
    5bce:	e810                	sd	a2,16(s0)
    5bd0:	ec14                	sd	a3,24(s0)
    5bd2:	f018                	sd	a4,32(s0)
    5bd4:	f41c                	sd	a5,40(s0)
    5bd6:	03043823          	sd	a6,48(s0)
    5bda:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5bde:	00840613          	addi	a2,s0,8
    5be2:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5be6:	85aa                	mv	a1,a0
    5be8:	4505                	li	a0,1
    5bea:	00000097          	auipc	ra,0x0
    5bee:	dce080e7          	jalr	-562(ra) # 59b8 <vprintf>
}
    5bf2:	60e2                	ld	ra,24(sp)
    5bf4:	6442                	ld	s0,16(sp)
    5bf6:	6125                	addi	sp,sp,96
    5bf8:	8082                	ret

0000000000005bfa <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    5c00:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c04:	00003797          	auipc	a5,0x3
    5c08:	9bc7b783          	ld	a5,-1604(a5) # 85c0 <freep>
    5c0c:	a02d                	j	5c36 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c0e:	4618                	lw	a4,8(a2)
    5c10:	9f2d                	addw	a4,a4,a1
    5c12:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c16:	6398                	ld	a4,0(a5)
    5c18:	6310                	ld	a2,0(a4)
    5c1a:	a83d                	j	5c58 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c1c:	ff852703          	lw	a4,-8(a0)
    5c20:	9f31                	addw	a4,a4,a2
    5c22:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c24:	ff053683          	ld	a3,-16(a0)
    5c28:	a091                	j	5c6c <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c2a:	6398                	ld	a4,0(a5)
    5c2c:	00e7e463          	bltu	a5,a4,5c34 <free+0x3a>
    5c30:	00e6ea63          	bltu	a3,a4,5c44 <free+0x4a>
{
    5c34:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c36:	fed7fae3          	bgeu	a5,a3,5c2a <free+0x30>
    5c3a:	6398                	ld	a4,0(a5)
    5c3c:	00e6e463          	bltu	a3,a4,5c44 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c40:	fee7eae3          	bltu	a5,a4,5c34 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c44:	ff852583          	lw	a1,-8(a0)
    5c48:	6390                	ld	a2,0(a5)
    5c4a:	02059813          	slli	a6,a1,0x20
    5c4e:	01c85713          	srli	a4,a6,0x1c
    5c52:	9736                	add	a4,a4,a3
    5c54:	fae60de3          	beq	a2,a4,5c0e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c58:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c5c:	4790                	lw	a2,8(a5)
    5c5e:	02061593          	slli	a1,a2,0x20
    5c62:	01c5d713          	srli	a4,a1,0x1c
    5c66:	973e                	add	a4,a4,a5
    5c68:	fae68ae3          	beq	a3,a4,5c1c <free+0x22>
    p->s.ptr = bp->s.ptr;
    5c6c:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5c6e:	00003717          	auipc	a4,0x3
    5c72:	94f73923          	sd	a5,-1710(a4) # 85c0 <freep>
}
    5c76:	6422                	ld	s0,8(sp)
    5c78:	0141                	addi	sp,sp,16
    5c7a:	8082                	ret

0000000000005c7c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5c7c:	7139                	addi	sp,sp,-64
    5c7e:	fc06                	sd	ra,56(sp)
    5c80:	f822                	sd	s0,48(sp)
    5c82:	f426                	sd	s1,40(sp)
    5c84:	f04a                	sd	s2,32(sp)
    5c86:	ec4e                	sd	s3,24(sp)
    5c88:	e852                	sd	s4,16(sp)
    5c8a:	e456                	sd	s5,8(sp)
    5c8c:	e05a                	sd	s6,0(sp)
    5c8e:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5c90:	02051493          	slli	s1,a0,0x20
    5c94:	9081                	srli	s1,s1,0x20
    5c96:	04bd                	addi	s1,s1,15
    5c98:	8091                	srli	s1,s1,0x4
    5c9a:	0014899b          	addiw	s3,s1,1
    5c9e:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5ca0:	00003517          	auipc	a0,0x3
    5ca4:	92053503          	ld	a0,-1760(a0) # 85c0 <freep>
    5ca8:	c515                	beqz	a0,5cd4 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5caa:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cac:	4798                	lw	a4,8(a5)
    5cae:	02977f63          	bgeu	a4,s1,5cec <malloc+0x70>
    5cb2:	8a4e                	mv	s4,s3
    5cb4:	0009871b          	sext.w	a4,s3
    5cb8:	6685                	lui	a3,0x1
    5cba:	00d77363          	bgeu	a4,a3,5cc0 <malloc+0x44>
    5cbe:	6a05                	lui	s4,0x1
    5cc0:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cc4:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cc8:	00003917          	auipc	s2,0x3
    5ccc:	8f890913          	addi	s2,s2,-1800 # 85c0 <freep>
  if(p == (char*)-1)
    5cd0:	5afd                	li	s5,-1
    5cd2:	a895                	j	5d46 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5cd4:	00009797          	auipc	a5,0x9
    5cd8:	10c78793          	addi	a5,a5,268 # ede0 <base>
    5cdc:	00003717          	auipc	a4,0x3
    5ce0:	8ef73223          	sd	a5,-1820(a4) # 85c0 <freep>
    5ce4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5ce6:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5cea:	b7e1                	j	5cb2 <malloc+0x36>
      if(p->s.size == nunits)
    5cec:	02e48c63          	beq	s1,a4,5d24 <malloc+0xa8>
        p->s.size -= nunits;
    5cf0:	4137073b          	subw	a4,a4,s3
    5cf4:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5cf6:	02071693          	slli	a3,a4,0x20
    5cfa:	01c6d713          	srli	a4,a3,0x1c
    5cfe:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d00:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d04:	00003717          	auipc	a4,0x3
    5d08:	8aa73e23          	sd	a0,-1860(a4) # 85c0 <freep>
      return (void*)(p + 1);
    ...
    5d28:	bff1                	j	5d04 <malloc+0x88>
  hp->s.size = nu;
    5d2a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d2e:	0541                	addi	a0,a0,16
    5d30:	00000097          	auipc	ra,0x0
    5d34:	eca080e7          	jalr	-310(ra) # 5bfa <free>
  return freep;
    5d38:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d3c:	d971                	beqz	a0,5d10 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d3e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d40:	4798                	lw	a4,8(a5)
    5d42:	fa9775e3          	bgeu	a4,s1,5cec <malloc+0x70>
    if(p == freep)
    5d46:	00093703          	ld	a4,0(s2)
    5d4a:	853e                	mv	a0,a5
    5d4c:	fef719e3          	bne	a4,a5,5d3e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d50:	8552                	mv	a0,s4
    5d52:	00000097          	auipc	ra,0x0
    5d56:	b78080e7          	jalr	-1160(ra) # 58ca <sbrk>
  if(p == (char*)-1)
    5d5a:	fd5518e3          	bne	a0,s5,5d2a <malloc+0xae>
        return 0;
    5d5e:	4501                	li	a0,0
    5d60:	bf45                	j	5d10 <malloc+0x94>
