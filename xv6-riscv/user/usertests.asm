...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	09a50513          	addi	a0,a0,154 # 60d8 <malloc+0x448>
      46:	00006097          	auipc	ra,0x6
      4a:	b8c080e7          	jalr	-1140(ra) # 5bd2 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	07850513          	addi	a0,a0,120 # 60f8 <malloc+0x468>
      88:	00006097          	auipc	ra,0x6
      8c:	b4a080e7          	jalr	-1206(ra) # 5bd2 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	06850513          	addi	a0,a0,104 # 6110 <malloc+0x480>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	06a50513          	addi	a0,a0,106 # 6130 <malloc+0x4a0>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	03250513          	addi	a0,a0,50 # 6118 <malloc+0x488>
      ee:	00006097          	auipc	ra,0x6
      f2:	ae4080e7          	jalr	-1308(ra) # 5bd2 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	03e50513          	addi	a0,a0,62 # 6140 <malloc+0x4b0>
     10a:	00006097          	auipc	ra,0x6
     10e:	ac8080e7          	jalr	-1336(ra) # 5bd2 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	03c50513          	addi	a0,a0,60 # 6168 <malloc+0x4d8>
     134:	00005097          	auipc	ra,0x5
     138:	76e080e7          	jalr	1902(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	02850513          	addi	a0,a0,40 # 6168 <malloc+0x4d8>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	02458593          	addi	a1,a1,36 # 6178 <malloc+0x4e8>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	00458593          	addi	a1,a1,4 # 6180 <malloc+0x4f0>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fd450513          	addi	a0,a0,-44 # 6168 <malloc+0x4d8>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	fbe50513          	addi	a0,a0,-66 # 6188 <malloc+0x4f8>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a00080e7          	jalr	-1536(ra) # 5bd2 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	cdc50513          	addi	a0,a0,-804 # 5f58 <malloc+0x2c8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	cc8a8a93          	addi	s5,s5,-824 # 5f58 <malloc+0x2c8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	e9e50513          	addi	a0,a0,-354 # 61b0 <malloc+0x520>
     31a:	00006097          	auipc	ra,0x6
     31e:	8b8080e7          	jalr	-1864(ra) # 5bd2 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	e9a50513          	addi	a0,a0,-358 # 61d0 <malloc+0x540>
     33e:	00006097          	auipc	ra,0x6
     342:	894080e7          	jalr	-1900(ra) # 5bd2 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	e76a0a13          	addi	s4,s4,-394 # 61e8 <malloc+0x558>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	dd250513          	addi	a0,a0,-558 # 61f0 <malloc+0x560>
     426:	00005097          	auipc	ra,0x5
     42a:	7ac080e7          	jalr	1964(ra) # 5bd2 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	dcc50513          	addi	a0,a0,-564 # 6208 <malloc+0x578>
     444:	00005097          	auipc	ra,0x5
     448:	78e080e7          	jalr	1934(ra) # 5bd2 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	dde50513          	addi	a0,a0,-546 # 6238 <malloc+0x5a8>
     462:	00005097          	auipc	ra,0x5
     466:	770080e7          	jalr	1904(ra) # 5bd2 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	df450513          	addi	a0,a0,-524 # 6268 <malloc+0x5d8>
     47c:	00005097          	auipc	ra,0x5
     480:	756080e7          	jalr	1878(ra) # 5bd2 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	de650513          	addi	a0,a0,-538 # 6278 <malloc+0x5e8>
     49a:	00005097          	auipc	ra,0x5
     49e:	738080e7          	jalr	1848(ra) # 5bd2 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	dd8a0a13          	addi	s4,s4,-552 # 62a8 <malloc+0x618>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	ca8a8a93          	addi	s5,s5,-856 # 6180 <malloc+0x4f0>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d3250513          	addi	a0,a0,-718 # 62b0 <malloc+0x620>
     586:	00005097          	auipc	ra,0x5
     58a:	64c080e7          	jalr	1612(ra) # 5bd2 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d2c50513          	addi	a0,a0,-724 # 62c8 <malloc+0x638>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	62e080e7          	jalr	1582(ra) # 5bd2 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	cb250513          	addi	a0,a0,-846 # 6268 <malloc+0x5d8>
     5be:	00005097          	auipc	ra,0x5
     5c2:	614080e7          	jalr	1556(ra) # 5bd2 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d2850513          	addi	a0,a0,-728 # 62f8 <malloc+0x668>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	5fa080e7          	jalr	1530(ra) # 5bd2 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d2250513          	addi	a0,a0,-734 # 6310 <malloc+0x680>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	5dc080e7          	jalr	1500(ra) # 5bd2 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b3458593          	addi	a1,a1,-1228 # 6178 <malloc+0x4e8>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b0850513          	addi	a0,a0,-1272 # 6168 <malloc+0x4d8>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	adc50513          	addi	a0,a0,-1316 # 6168 <malloc+0x4d8>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	ac850513          	addi	a0,a0,-1336 # 6168 <malloc+0x4d8>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	cc258593          	addi	a1,a1,-830 # 63a0 <malloc+0x710>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	a4850513          	addi	a0,a0,-1464 # 6168 <malloc+0x4d8>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	bdc50513          	addi	a0,a0,-1060 # 6340 <malloc+0x6b0>
     76c:	00005097          	auipc	ra,0x5
     770:	466080e7          	jalr	1126(ra) # 5bd2 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	be050513          	addi	a0,a0,-1056 # 6360 <malloc+0x6d0>
     788:	00005097          	auipc	ra,0x5
     78c:	44a080e7          	jalr	1098(ra) # 5bd2 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	bdc50513          	addi	a0,a0,-1060 # 6370 <malloc+0x6e0>
     79c:	00005097          	auipc	ra,0x5
     7a0:	436080e7          	jalr	1078(ra) # 5bd2 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	be050513          	addi	a0,a0,-1056 # 6390 <malloc+0x700>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	41a080e7          	jalr	1050(ra) # 5bd2 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	bac50513          	addi	a0,a0,-1108 # 6370 <malloc+0x6e0>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	406080e7          	jalr	1030(ra) # 5bd2 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	bc650513          	addi	a0,a0,-1082 # 63a8 <malloc+0x718>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	3e8080e7          	jalr	1000(ra) # 5bd2 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	bc850513          	addi	a0,a0,-1080 # 63c8 <malloc+0x738>
     808:	00005097          	auipc	ra,0x5
     80c:	3ca080e7          	jalr	970(ra) # 5bd2 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	bb450513          	addi	a0,a0,-1100 # 63e8 <malloc+0x758>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	bc498993          	addi	s3,s3,-1084 # 6410 <malloc+0x780>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	bf4a8a93          	addi	s5,s5,-1036 # 6448 <malloc+0x7b8>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	b4e50513          	addi	a0,a0,-1202 # 63e8 <malloc+0x758>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b1250513          	addi	a0,a0,-1262 # 63e8 <malloc+0x758>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	af050513          	addi	a0,a0,-1296 # 63f0 <malloc+0x760>
     908:	00005097          	auipc	ra,0x5
     90c:	2ca080e7          	jalr	714(ra) # 5bd2 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	b0250513          	addi	a0,a0,-1278 # 6420 <malloc+0x790>
     926:	00005097          	auipc	ra,0x5
     92a:	2ac080e7          	jalr	684(ra) # 5bd2 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b1c50513          	addi	a0,a0,-1252 # 6458 <malloc+0x7c8>
     944:	00005097          	auipc	ra,0x5
     948:	28e080e7          	jalr	654(ra) # 5bd2 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b2850513          	addi	a0,a0,-1240 # 6480 <malloc+0x7f0>
     960:	00005097          	auipc	ra,0x5
     964:	272080e7          	jalr	626(ra) # 5bd2 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b2c50513          	addi	a0,a0,-1236 # 64a0 <malloc+0x810>
     97c:	00005097          	auipc	ra,0x5
     980:	256080e7          	jalr	598(ra) # 5bd2 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b2850513          	addi	a0,a0,-1240 # 64b8 <malloc+0x828>
     998:	00005097          	auipc	ra,0x5
     99c:	23a080e7          	jalr	570(ra) # 5bd2 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b1650513          	addi	a0,a0,-1258 # 64d8 <malloc+0x848>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	3c290913          	addi	s2,s2,962 # bd98 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	ac450513          	addi	a0,a0,-1340 # 64d8 <malloc+0x848>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	37090913          	addi	s2,s2,880 # bd98 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a8450513          	addi	a0,a0,-1404 # 64e0 <malloc+0x850>
     a64:	00005097          	auipc	ra,0x5
     a68:	16e080e7          	jalr	366(ra) # 5bd2 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	a8650513          	addi	a0,a0,-1402 # 6500 <malloc+0x870>
     a82:	00005097          	auipc	ra,0x5
     a86:	150080e7          	jalr	336(ra) # 5bd2 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	a9250513          	addi	a0,a0,-1390 # 6528 <malloc+0x898>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	134080e7          	jalr	308(ra) # 5bd2 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a1650513          	addi	a0,a0,-1514 # 64d8 <malloc+0x848>
     ...
     af2:	a5a50513          	addi	a0,a0,-1446 # 6548 <malloc+0x8b8>
     af6:	00005097          	auipc	ra,0x5
     afa:	0dc080e7          	jalr	220(ra) # 5bd2 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	a6450513          	addi	a0,a0,-1436 # 6570 <malloc+0x8e0>
     b14:	00005097          	auipc	ra,0x5
     b18:	0be080e7          	jalr	190(ra) # 5bd2 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	a5e50513          	addi	a0,a0,-1442 # 6588 <malloc+0x8f8>
     b32:	00005097          	auipc	ra,0x5
     b36:	0a0080e7          	jalr	160(ra) # 5bd2 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	a6a50513          	addi	a0,a0,-1430 # 65b0 <malloc+0x920>
     b4e:	00005097          	auipc	ra,0x5
     b52:	084080e7          	jalr	132(ra) # 5bd2 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	37450513          	addi	a0,a0,884 # 5ee8 <malloc+0x258>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	a5c58593          	addi	a1,a1,-1444 # 65e8 <malloc+0x958>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	34050513          	addi	a0,a0,832 # 5ee8 <malloc+0x258>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	32a50513          	addi	a0,a0,810 # 5ee8 <malloc+0x258>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	31450513          	addi	a0,a0,788 # 5ee8 <malloc+0x258>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	a4858593          	addi	a1,a1,-1464 # 6630 <malloc+0x9a0>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	19458593          	addi	a1,a1,404 # bd98 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	29850513          	addi	a0,a0,664 # 5ee8 <malloc+0x258>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	95850513          	addi	a0,a0,-1704 # 65c8 <malloc+0x938>
     c78:	00005097          	auipc	ra,0x5
     c7c:	f5a080e7          	jalr	-166(ra) # 5bd2 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	96450513          	addi	a0,a0,-1692 # 65f0 <malloc+0x960>
     c94:	00005097          	auipc	ra,0x5
     c98:	f3e080e7          	jalr	-194(ra) # 5bd2 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	96850513          	addi	a0,a0,-1688 # 6610 <malloc+0x980>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f22080e7          	jalr	-222(ra) # 5bd2 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	97450513          	addi	a0,a0,-1676 # 6638 <malloc+0x9a8>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	f06080e7          	jalr	-250(ra) # 5bd2 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	97850513          	addi	a0,a0,-1672 # 6658 <malloc+0x9c8>
     ce8:	00005097          	auipc	ra,0x5
     cec:	eea080e7          	jalr	-278(ra) # 5bd2 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	97c50513          	addi	a0,a0,-1668 # 6678 <malloc+0x9e8>
     d04:	00005097          	auipc	ra,0x5
     d08:	ece080e7          	jalr	-306(ra) # 5bd2 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	88858593          	addi	a1,a1,-1912 # 65e8 <malloc+0x958>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	92058593          	addi	a1,a1,-1760 # 66a0 <malloc+0xa10>
     d88:	00006517          	auipc	a0,0x6
     d8c:	91050513          	addi	a0,a0,-1776 # 6698 <malloc+0xa08>
  ...
  unlink("lf1");
     ...
     da0:	8fc50513          	addi	a0,a0,-1796 # 6698 <malloc+0xa08>
     da4:	00005097          	auipc	ra,0x5
     da8:	afe080e7          	jalr	-1282(ra) # 58a2 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	8ea50513          	addi	a0,a0,-1814 # 6698 <malloc+0xa08>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	8dc50513          	addi	a0,a0,-1828 # 66a0 <malloc+0xa10>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	fbc58593          	addi	a1,a1,-68 # bd98 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	8a458593          	addi	a1,a1,-1884 # 66a0 <malloc+0xa10>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	88e50513          	addi	a0,a0,-1906 # 66a0 <malloc+0xa10>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a88080e7          	jalr	-1400(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	87658593          	addi	a1,a1,-1930 # 6698 <malloc+0xa08>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	87650513          	addi	a0,a0,-1930 # 66a0 <malloc+0xa10>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	85a58593          	addi	a1,a1,-1958 # 6698 <malloc+0xa08>
     e46:	00006517          	auipc	a0,0x6
     e4a:	96250513          	addi	a0,a0,-1694 # 67a8 <malloc+0xb18>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	84050513          	addi	a0,a0,-1984 # 66a8 <malloc+0xa18>
     e70:	00005097          	auipc	ra,0x5
     e74:	d62080e7          	jalr	-670(ra) # 5bd2 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	83c50513          	addi	a0,a0,-1988 # 66c0 <malloc+0xa30>
     e8c:	00005097          	auipc	ra,0x5
     e90:	d46080e7          	jalr	-698(ra) # 5bd2 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	83850513          	addi	a0,a0,-1992 # 66d8 <malloc+0xa48>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d2a080e7          	jalr	-726(ra) # 5bd2 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	83c50513          	addi	a0,a0,-1988 # 66f8 <malloc+0xa68>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d0e080e7          	jalr	-754(ra) # 5bd2 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	85050513          	addi	a0,a0,-1968 # 6728 <malloc+0xa98>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	cf2080e7          	jalr	-782(ra) # 5bd2 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	84c50513          	addi	a0,a0,-1972 # 6740 <malloc+0xab0>
     efc:	00005097          	auipc	ra,0x5
     f00:	cd6080e7          	jalr	-810(ra) # 5bd2 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	84850513          	addi	a0,a0,-1976 # 6758 <malloc+0xac8>
     f18:	00005097          	auipc	ra,0x5
     f1c:	cba080e7          	jalr	-838(ra) # 5bd2 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	85450513          	addi	a0,a0,-1964 # 6780 <malloc+0xaf0>
     f34:	00005097          	auipc	ra,0x5
     f38:	c9e080e7          	jalr	-866(ra) # 5bd2 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	86850513          	addi	a0,a0,-1944 # 67b0 <malloc+0xb20>
     f50:	00005097          	auipc	ra,0x5
     f54:	c82080e7          	jalr	-894(ra) # 5bd2 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	822a0a13          	addi	s4,s4,-2014 # 67d0 <malloc+0xb40>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	7d050513          	addi	a0,a0,2000 # 67d0 <malloc+0xb40>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	76850513          	addi	a0,a0,1896 # 67d8 <malloc+0xb48>
    1078:	00005097          	auipc	ra,0x5
    107c:	b5a080e7          	jalr	-1190(ra) # 5bd2 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	76850513          	addi	a0,a0,1896 # 67f8 <malloc+0xb68>
    1098:	00005097          	auipc	ra,0x5
    109c:	b3a080e7          	jalr	-1222(ra) # 5bd2 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	76c50513          	addi	a0,a0,1900 # 6818 <malloc+0xb88>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b1e080e7          	jalr	-1250(ra) # 5bd2 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	75a98993          	addi	s3,s3,1882 # 6838 <malloc+0xba8>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	72e50513          	addi	a0,a0,1838 # 6848 <malloc+0xbb8>
    1122:	00005097          	auipc	ra,0x5
    1126:	ab0080e7          	jalr	-1360(ra) # 5bd2 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x5b8>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	f8a98993          	addi	s3,s3,-118 # 6110 <malloc+0x480>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	82078793          	addi	a5,a5,-2016 # 7a30 <malloc+0x1da0>
  ...
  if(pid == 0){
    ...
    124a:	43a78793          	addi	a5,a5,1082 # 8680 <big.1272>
    124e:	00008697          	auipc	a3,0x8
    1252:	43268693          	addi	a3,a3,1074 # 9680 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1268:	40078e23          	sb	zero,1052(a5) # 9680 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	ed478793          	addi	a5,a5,-300 # 8140 <malloc+0x24b0>
    ...
    1294:	e8050513          	addi	a0,a0,-384 # 6110 <malloc+0x480>
    ...
    12ac:	64850513          	addi	a0,a0,1608 # 68f0 <malloc+0xc60>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	922080e7          	jalr	-1758(ra) # 5bd2 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	5a050513          	addi	a0,a0,1440 # 6868 <malloc+0xbd8>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	902080e7          	jalr	-1790(ra) # 5bd2 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	5a050513          	addi	a0,a0,1440 # 6888 <malloc+0xbf8>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	8e2080e7          	jalr	-1822(ra) # 5bd2 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	59e50513          	addi	a0,a0,1438 # 68a8 <malloc+0xc18>
    1312:	00005097          	auipc	ra,0x5
    1316:	8c0080e7          	jalr	-1856(ra) # 5bd2 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	5a650513          	addi	a0,a0,1446 # 68d0 <malloc+0xc40>
    1332:	00005097          	auipc	ra,0x5
    1336:	8a0080e7          	jalr	-1888(ra) # 5bd2 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a2450513          	addi	a0,a0,-1500 # 6d68 <malloc+0x10d8>
    134c:	00005097          	auipc	ra,0x5
    1350:	886080e7          	jalr	-1914(ra) # 5bd2 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	58a50513          	addi	a0,a0,1418 # 6918 <malloc+0xc88>
    1396:	00005097          	auipc	ra,0x5
    139a:	83c080e7          	jalr	-1988(ra) # 5bd2 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	da850513          	addi	a0,a0,-600 # 6168 <malloc+0x4d8>
  ...
  if(pid == 0){
    ...
    13ee:	d7ea0a13          	addi	s4,s4,-642 # 6168 <malloc+0x4d8>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	586a8a93          	addi	s5,s5,1414 # 6978 <malloc+0xce8>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	4e650513          	addi	a0,a0,1254 # 6948 <malloc+0xcb8>
    146a:	00004097          	auipc	ra,0x4
    146e:	768080e7          	jalr	1896(ra) # 5bd2 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	4e250513          	addi	a0,a0,1250 # 6960 <malloc+0xcd0>
    1486:	00004097          	auipc	ra,0x4
    148a:	74c080e7          	jalr	1868(ra) # 5bd2 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	4ec50513          	addi	a0,a0,1260 # 6988 <malloc+0xcf8>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	72e080e7          	jalr	1838(ra) # 5bd2 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	caea0a13          	addi	s4,s4,-850 # 6168 <malloc+0x4d8>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	4e6a8a93          	addi	s5,s5,1254 # 69a8 <malloc+0xd18>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	c5c50513          	addi	a0,a0,-932 # 6168 <malloc+0x4d8>
  ...
  exit(xstatus);
    ...
    152e:	43650513          	addi	a0,a0,1078 # 6960 <malloc+0xcd0>
    1532:	00004097          	auipc	ra,0x4
    1536:	6a0080e7          	jalr	1696(ra) # 5bd2 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	46850513          	addi	a0,a0,1128 # 69b0 <malloc+0xd20>
    1550:	00004097          	auipc	ra,0x4
    1554:	682080e7          	jalr	1666(ra) # 5bd2 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	ba078793          	addi	a5,a5,-1120 # 6110 <malloc+0x480>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	45478793          	addi	a5,a5,1108 # 69d0 <malloc+0xd40>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	44c50513          	addi	a0,a0,1100 # 69d8 <malloc+0xd48>
  ...
  if(pid == 0) {
    ...
    15be:	41e50513          	addi	a0,a0,1054 # 69d8 <malloc+0xd48>
    ...
    15da:	42250513          	addi	a0,a0,1058 # 69f8 <malloc+0xd68>
    15de:	00004097          	auipc	ra,0x4
    15e2:	5f4080e7          	jalr	1524(ra) # 5bd2 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	35650513          	addi	a0,a0,854 # 6948 <malloc+0xcb8>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	5d8080e7          	jalr	1496(ra) # 5bd2 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	3d250513          	addi	a0,a0,978 # 69e0 <malloc+0xd50>
    1616:	00004097          	auipc	ra,0x4
    161a:	5bc080e7          	jalr	1468(ra) # 5bd2 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	ae450513          	addi	a0,a0,-1308 # 6110 <malloc+0x480>
  ...
  if(xstatus != 0)
    ...
    1664:	3a850513          	addi	a0,a0,936 # 6a08 <malloc+0xd78>
    1668:	00004097          	auipc	ra,0x4
    166c:	56a080e7          	jalr	1386(ra) # 5bd2 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	3a450513          	addi	a0,a0,932 # 6a20 <malloc+0xd90>
    1684:	00004097          	auipc	ra,0x4
    1688:	54e080e7          	jalr	1358(ra) # 5bd2 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	34850513          	addi	a0,a0,840 # 69d8 <malloc+0xd48>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	de650513          	addi	a0,a0,-538 # 64a0 <malloc+0x810>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	510080e7          	jalr	1296(ra) # 5bd2 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	28a50513          	addi	a0,a0,650 # 6960 <malloc+0xcd0>
    16de:	00004097          	auipc	ra,0x4
    16e2:	4f4080e7          	jalr	1268(ra) # 5bd2 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	2e850513          	addi	a0,a0,744 # 69d8 <malloc+0xd48>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	31e50513          	addi	a0,a0,798 # 6a38 <malloc+0xda8>
    1722:	00004097          	auipc	ra,0x4
    1726:	4b0080e7          	jalr	1200(ra) # 5bd2 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	612a8a93          	addi	s5,s5,1554 # bd98 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	5f470713          	addi	a4,a4,1524 # bd98 <buf>
    ...
    17e0:	27450513          	addi	a0,a0,628 # 6a50 <malloc+0xdc0>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	3ee080e7          	jalr	1006(ra) # 5bd2 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	596b0b13          	addi	s6,s6,1430 # bd98 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	20650513          	addi	a0,a0,518 # 6a68 <malloc+0xdd8>
    186a:	00004097          	auipc	ra,0x4
    186e:	368080e7          	jalr	872(ra) # 5bd2 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	20250513          	addi	a0,a0,514 # 6a80 <malloc+0xdf0>
    1886:	00004097          	auipc	ra,0x4
    188a:	34c080e7          	jalr	844(ra) # 5bd2 <printf>
}
    ...
    18b4:	1e850513          	addi	a0,a0,488 # 6a98 <malloc+0xe08>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	31a080e7          	jalr	794(ra) # 5bd2 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	1c850513          	addi	a0,a0,456 # 6ab8 <malloc+0xe28>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	2da080e7          	jalr	730(ra) # 5bd2 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	fe650513          	addi	a0,a0,-26 # 6948 <malloc+0xcb8>
    196a:	00004097          	auipc	ra,0x4
    196e:	268080e7          	jalr	616(ra) # 5bd2 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	15250513          	addi	a0,a0,338 # 6ad0 <malloc+0xe40>
    1986:	00004097          	auipc	ra,0x4
    198a:	24c080e7          	jalr	588(ra) # 5bd2 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	14e50513          	addi	a0,a0,334 # 6ae8 <malloc+0xe58>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	230080e7          	jalr	560(ra) # 5bd2 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f3650513          	addi	a0,a0,-202 # 6948 <malloc+0xcb8>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	1b8080e7          	jalr	440(ra) # 5bd2 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f1250513          	addi	a0,a0,-238 # 6948 <malloc+0xcb8>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	194080e7          	jalr	404(ra) # 5bd2 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	05850513          	addi	a0,a0,88 # 6b08 <malloc+0xe78>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	11a080e7          	jalr	282(ra) # 5bd2 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	d90080e7          	jalr	-624(ra) # 5852 <exit>
{
    ...
    1b0c:	01050513          	addi	a0,a0,16 # 6b18 <malloc+0xe88>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	0c2080e7          	jalr	194(ra) # 5bd2 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	21250513          	addi	a0,a0,530 # 6d68 <malloc+0x10d8>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	074080e7          	jalr	116(ra) # 5bd2 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	17450513          	addi	a0,a0,372 # 6d68 <malloc+0x10d8>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	fd6080e7          	jalr	-42(ra) # 5bd2 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	dc050513          	addi	a0,a0,-576 # 69e0 <malloc+0xd50>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	faa080e7          	jalr	-86(ra) # 5bd2 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	ea650513          	addi	a0,a0,-346 # 6b38 <malloc+0xea8>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f38080e7          	jalr	-200(ra) # 5bd2 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	e8a50513          	addi	a0,a0,-374 # 6b50 <malloc+0xec0>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f04080e7          	jalr	-252(ra) # 5bd2 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	e4c50513          	addi	a0,a0,-436 # 6b78 <malloc+0xee8>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	e9e080e7          	jalr	-354(ra) # 5bd2 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	3b450513          	addi	a0,a0,948 # 6180 <malloc+0x4f0>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	378a8a93          	addi	s5,s5,888 # 6180 <malloc+0x4f0>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	d90b8b93          	addi	s7,s7,-624 # 6ba0 <malloc+0xf10>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b2c50513          	addi	a0,a0,-1236 # 6948 <malloc+0xcb8>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	dae080e7          	jalr	-594(ra) # 5bd2 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	e5e50513          	addi	a0,a0,-418 # 6d68 <malloc+0x10d8>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	cc0080e7          	jalr	-832(ra) # 5bd2 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	e52b8b93          	addi	s7,s7,-430 # bd98 <buf>
    ...
    1fbe:	bee50513          	addi	a0,a0,-1042 # 6ba8 <malloc+0xf18>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c10080e7          	jalr	-1008(ra) # 5bd2 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	1f650513          	addi	a0,a0,502 # 61d0 <malloc+0x540>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	bf0080e7          	jalr	-1040(ra) # 5bd2 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	bb050513          	addi	a0,a0,-1104 # 6bd8 <malloc+0xf48>
    2030:	00004097          	auipc	ra,0x4
    2034:	ba2080e7          	jalr	-1118(ra) # 5bd2 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b3650513          	addi	a0,a0,-1226 # 6bc0 <malloc+0xf30>
    2092:	00004097          	auipc	ra,0x4
    2096:	b40080e7          	jalr	-1216(ra) # 5bd2 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	b5a50513          	addi	a0,a0,-1190 # 6c00 <malloc+0xf70>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b24080e7          	jalr	-1244(ra) # 5bd2 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	b5650513          	addi	a0,a0,-1194 # 6c18 <malloc+0xf88>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	b08080e7          	jalr	-1272(ra) # 5bd2 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x5b8>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e6d8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	80650513          	addi	a0,a0,-2042 # 6948 <malloc+0xcb8>
    214a:	00004097          	auipc	ra,0x4
    214e:	a88080e7          	jalr	-1400(ra) # 5bd2 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	acc50513          	addi	a0,a0,-1332 # 6c30 <malloc+0xfa0>
    216c:	00004097          	auipc	ra,0x4
    2170:	a66080e7          	jalr	-1434(ra) # 5bd2 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	76250513          	addi	a0,a0,1890 # 6948 <malloc+0xcb8>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	9e4080e7          	jalr	-1564(ra) # 5bd2 <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a3e50513          	addi	a0,a0,-1474 # 6c50 <malloc+0xfc0>
    221a:	00004097          	auipc	ra,0x4
    221e:	9b8080e7          	jalr	-1608(ra) # 5bd2 <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a2650513          	addi	a0,a0,-1498 # 6c68 <malloc+0xfd8>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	9f450513          	addi	a0,a0,-1548 # 6c68 <malloc+0xfd8>
  ...
  close(fd);
    ...
    229e:	2e678793          	addi	a5,a5,742 # 8580 <args.1861>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3d668693          	addi	a3,a3,982 # 8678 <args.1861+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	9ce70713          	addi	a4,a4,-1586 # 6c78 <malloc+0xfe8>
    ...
    2302:	a5a50513          	addi	a0,a0,-1446 # 6d58 <malloc+0x10c8>
    2306:	00004097          	auipc	ra,0x4
    230a:	8cc080e7          	jalr	-1844(ra) # 5bd2 <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	a5650513          	addi	a0,a0,-1450 # 6d78 <malloc+0x10e8>
    232a:	00004097          	auipc	ra,0x4
    232e:	8a8080e7          	jalr	-1880(ra) # 5bd2 <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0258>
    237e:	85a6                	mv	a1,s1
    2380:	00005517          	auipc	a0,0x5
    2384:	a1850513          	addi	a0,a0,-1512 # 6d98 <malloc+0x1108>
    2388:	00004097          	auipc	ra,0x4
    238c:	84a080e7          	jalr	-1974(ra) # 5bd2 <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	5ac50513          	addi	a0,a0,1452 # 6948 <malloc+0xcb8>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	82e080e7          	jalr	-2002(ra) # 5bd2 <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	5fa78793          	addi	a5,a5,1530 # 7a30 <malloc+0x1da0>
  ...
  if(ret != -1){
    ...
    247c:	94850513          	addi	a0,a0,-1720 # 6dc0 <malloc+0x1130>
    2480:	00003097          	auipc	ra,0x3
    2484:	752080e7          	jalr	1874(ra) # 5bd2 <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	3d250513          	addi	a0,a0,978 # 6868 <malloc+0xbd8>
    249e:	00003097          	auipc	ra,0x3
    24a2:	734080e7          	jalr	1844(ra) # 5bd2 <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	3d450513          	addi	a0,a0,980 # 6888 <malloc+0xbf8>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	716080e7          	jalr	1814(ra) # 5bd2 <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	3d450513          	addi	a0,a0,980 # 68a8 <malloc+0xc18>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	6f6080e7          	jalr	1782(ra) # 5bd2 <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	3de50513          	addi	a0,a0,990 # 68d0 <malloc+0xc40>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	6d8080e7          	jalr	1752(ra) # 5bd2 <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	8c250513          	addi	a0,a0,-1854 # 5e00 <malloc+0x170>
  ...
  if(n >= 0){
    ...
    2574:	8a850513          	addi	a0,a0,-1880 # 6e18 <malloc+0x1188>
    2578:	00003097          	auipc	ra,0x3
    257c:	65a080e7          	jalr	1626(ra) # 5bd2 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	83e50513          	addi	a0,a0,-1986 # 6dc8 <malloc+0x1138>
    2592:	00003097          	auipc	ra,0x3
    2596:	640080e7          	jalr	1600(ra) # 5bd2 <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	83c50513          	addi	a0,a0,-1988 # 6de0 <malloc+0x1150>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	626080e7          	jalr	1574(ra) # 5bd2 <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	84250513          	addi	a0,a0,-1982 # 6e00 <malloc+0x1170>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	60c080e7          	jalr	1548(ra) # 5bd2 <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	81e50513          	addi	a0,a0,-2018 # 5e00 <malloc+0x170>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2b8080e7          	jalr	696(ra) # 58a2 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	cb450513          	addi	a0,a0,-844 # 62a8 <malloc+0x618>
  ...
  if(n >= 0){
    ...
    2622:	82a50513          	addi	a0,a0,-2006 # 6e48 <malloc+0x11b8>
    2626:	00003097          	auipc	ra,0x3
    262a:	5ac080e7          	jalr	1452(ra) # 5bd2 <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	7c850513          	addi	a0,a0,1992 # 6e00 <malloc+0x1170>
    2640:	00003097          	auipc	ra,0x3
    2644:	592080e7          	jalr	1426(ra) # 5bd2 <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1258>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26be:	7b650513          	addi	a0,a0,1974 # 6e70 <malloc+0x11e0>
    26c2:	00003097          	auipc	ra,0x3
    26c6:	510080e7          	jalr	1296(ra) # 5bd2 <printf>
    exit(1);
    26ca:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	78250513          	addi	a0,a0,1922 # 6e90 <malloc+0x1200>
    2716:	00003097          	auipc	ra,0x3
    271a:	4bc080e7          	jalr	1212(ra) # 5bd2 <printf>
    exit(1);
    271e:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2774:	78050513          	addi	a0,a0,1920 # 6ef0 <malloc+0x1260>
    2778:	00003097          	auipc	ra,0x3
    277c:	45a080e7          	jalr	1114(ra) # 5bd2 <printf>
    exit(1);
    2780:	4505                	li	a0,1
    ...
    2796:	71e50513          	addi	a0,a0,1822 # 6eb0 <malloc+0x1220>
    279a:	00003097          	auipc	ra,0x3
    279e:	438080e7          	jalr	1080(ra) # 5bd2 <printf>
      exit(1);
    27a2:	4505                	li	a0,1
    ...
    27b2:	72250513          	addi	a0,a0,1826 # 6ed0 <malloc+0x1240>
    27b6:	00003097          	auipc	ra,0x3
    27ba:	41c080e7          	jalr	1052(ra) # 5bd2 <printf>
    exit(1);
    27be:	4505                	li	a0,1
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1257>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1257>
  ...
  if(c != a){
    ...
    28fc:	61850513          	addi	a0,a0,1560 # 6f10 <malloc+0x1280>
    2900:	00003097          	auipc	ra,0x3
    2904:	2d2080e7          	jalr	722(ra) # 5bd2 <printf>
    exit(1);
    2908:	4505                	li	a0,1
    ...
    2918:	64450513          	addi	a0,a0,1604 # 6f58 <malloc+0x12c8>
    291c:	00003097          	auipc	ra,0x3
    2920:	2b6080e7          	jalr	694(ra) # 5bd2 <printf>
    exit(1);
    2924:	4505                	li	a0,1
    ...
    2938:	64450513          	addi	a0,a0,1604 # 6f78 <malloc+0x12e8>
    293c:	00003097          	auipc	ra,0x3
    2940:	296080e7          	jalr	662(ra) # 5bd2 <printf>
    exit(1);
    2944:	4505                	li	a0,1
    ...
    2958:	66450513          	addi	a0,a0,1636 # 6fb8 <malloc+0x1328>
    295c:	00003097          	auipc	ra,0x3
    2960:	276080e7          	jalr	630(ra) # 5bd2 <printf>
    exit(1);
    2964:	4505                	li	a0,1
    ...
    2974:	67850513          	addi	a0,a0,1656 # 6fe8 <malloc+0x1358>
    2978:	00003097          	auipc	ra,0x3
    297c:	25a080e7          	jalr	602(ra) # 5bd2 <printf>
    exit(1);
    2980:	4505                	li	a0,1
    ...
    2994:	69050513          	addi	a0,a0,1680 # 7020 <malloc+0x1390>
    2998:	00003097          	auipc	ra,0x3
    299c:	23a080e7          	jalr	570(ra) # 5bd2 <printf>
    exit(1);
    29a0:	4505                	li	a0,1
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	67e50513          	addi	a0,a0,1662 # 7048 <malloc+0x13b8>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ec0080e7          	jalr	-320(ra) # 5892 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	66c50513          	addi	a0,a0,1644 # 7048 <malloc+0x13b8>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	62050513          	addi	a0,a0,1568 # 7050 <malloc+0x13c0>
    2a38:	00003097          	auipc	ra,0x3
    2a3c:	19a080e7          	jalr	410(ra) # 5bd2 <printf>
    exit(1);
    2a40:	4505                	li	a0,1
    ...
    2a50:	61c50513          	addi	a0,a0,1564 # 7068 <malloc+0x13d8>
    2a54:	00003097          	auipc	ra,0x3
    2a58:	17e080e7          	jalr	382(ra) # 5bd2 <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a6c:	fe850513          	addi	a0,a0,-24 # 6a50 <malloc+0xdc0>
    2a70:	00003097          	auipc	ra,0x3
    2a74:	162080e7          	jalr	354(ra) # 5bd2 <printf>
    exit(1);
    2a78:	4505                	li	a0,1
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	5ee50513          	addi	a0,a0,1518 # 7080 <malloc+0x13f0>
  ...
  close(fd);
    ...
    2ade:	e8650513          	addi	a0,a0,-378 # 6960 <malloc+0xcd0>
    2ae2:	00003097          	auipc	ra,0x3
    2ae6:	0f0080e7          	jalr	240(ra) # 5bd2 <printf>
    exit(1);
    2aea:	4505                	li	a0,1
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	24050513          	addi	a0,a0,576 # 6d68 <malloc+0x10d8>
    2b30:	00003097          	auipc	ra,0x3
    2b34:	0a2080e7          	jalr	162(ra) # 5bd2 <printf>
    exit(1);
    2b38:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b82:	1ea50513          	addi	a0,a0,490 # 6d68 <malloc+0x10d8>
    2b86:	00003097          	auipc	ra,0x3
    2b8a:	04c080e7          	jalr	76(ra) # 5bd2 <printf>
    exit(1);
    2b8e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be2:	18a50513          	addi	a0,a0,394 # 6d68 <malloc+0x10d8>
    2be6:	00003097          	auipc	ra,0x3
    2bea:	fec080e7          	jalr	-20(ra) # 5bd2 <printf>
    exit(1);
    2bee:	4505                	li	a0,1
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff1257>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	01650513          	addi	a0,a0,22 # 6d68 <malloc+0x10d8>
    2d5a:	00003097          	auipc	ra,0x3
    2d5e:	e78080e7          	jalr	-392(ra) # 5bd2 <printf>
      exit(1);
    2d62:	4505                	li	a0,1
    ...
    2daa:	36a50513          	addi	a0,a0,874 # 6110 <malloc+0x480>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	3ce78793          	addi	a5,a5,974 # 6180 <malloc+0x4f0>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	47450513          	addi	a0,a0,1140 # 7258 <malloc+0x15c8>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	2ba50513          	addi	a0,a0,698 # 70b0 <malloc+0x1420>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	2fc50513          	addi	a0,a0,764 # 7108 <malloc+0x1478>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	35650513          	addi	a0,a0,854 # 7180 <malloc+0x14f0>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	3aa50513          	addi	a0,a0,938 # 71f0 <malloc+0x1560>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	3f050513          	addi	a0,a0,1008 # 7248 <malloc+0x15b8>
  ...
  unlink("12345678901234");
    ...
    2eda:	1b250513          	addi	a0,a0,434 # 7088 <malloc+0x13f8>
    2ede:	00003097          	auipc	ra,0x3
    2ee2:	cf4080e7          	jalr	-780(ra) # 5bd2 <printf>
    exit(1);
    2ee6:	4505                	li	a0,1
    ...
    2ef6:	1de50513          	addi	a0,a0,478 # 70d0 <malloc+0x1440>
    2efa:	00003097          	auipc	ra,0x3
    2efe:	cd8080e7          	jalr	-808(ra) # 5bd2 <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f12:	22a50513          	addi	a0,a0,554 # 7138 <malloc+0x14a8>
    2f16:	00003097          	auipc	ra,0x3
    2f1a:	cbc080e7          	jalr	-836(ra) # 5bd2 <printf>
    exit(1);
    2f1e:	4505                	li	a0,1
    ...
    2f2e:	28650513          	addi	a0,a0,646 # 71b0 <malloc+0x1520>
    2f32:	00003097          	auipc	ra,0x3
    2f36:	ca0080e7          	jalr	-864(ra) # 5bd2 <printf>
    exit(1);
    2f3a:	4505                	li	a0,1
    ...
    2f4a:	2ca50513          	addi	a0,a0,714 # 7210 <malloc+0x1580>
    2f4e:	00003097          	auipc	ra,0x3
    2f52:	c84080e7          	jalr	-892(ra) # 5bd2 <printf>
    exit(1);
    2f56:	4505                	li	a0,1
    ...
    2f66:	30650513          	addi	a0,a0,774 # 7268 <malloc+0x15d8>
    2f6a:	00003097          	auipc	ra,0x3
    2f6e:	c68080e7          	jalr	-920(ra) # 5bd2 <printf>
    exit(1);
    2f72:	4505                	li	a0,1
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	31850513          	addi	a0,a0,792 # 72a0 <malloc+0x1610>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	30450513          	addi	a0,a0,772 # 72a0 <malloc+0x1610>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	33050513          	addi	a0,a0,816 # 72e0 <malloc+0x1650>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	34c50513          	addi	a0,a0,844 # 7310 <malloc+0x1680>
    ...
    2fe8:	2c450513          	addi	a0,a0,708 # 72a8 <malloc+0x1618>
    2fec:	00003097          	auipc	ra,0x3
    2ff0:	be6080e7          	jalr	-1050(ra) # 5bd2 <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    ...
    3004:	2c050513          	addi	a0,a0,704 # 72c0 <malloc+0x1630>
    3008:	00003097          	auipc	ra,0x3
    300c:	bca080e7          	jalr	-1078(ra) # 5bd2 <printf>
    exit(1);
    3010:	4505                	li	a0,1
    ...
    3020:	2d450513          	addi	a0,a0,724 # 72f0 <malloc+0x1660>
    3024:	00003097          	auipc	ra,0x3
    3028:	bae080e7          	jalr	-1106(ra) # 5bd2 <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    303c:	2e050513          	addi	a0,a0,736 # 7318 <malloc+0x1688>
    3040:	00003097          	auipc	ra,0x3
    3044:	b92080e7          	jalr	-1134(ra) # 5bd2 <printf>
    exit(1);
    3048:	4505                	li	a0,1
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	23450513          	addi	a0,a0,564 # 72a0 <malloc+0x1610>
    ...
    3084:	22050513          	addi	a0,a0,544 # 72a0 <malloc+0x1610>
    ...
    3098:	24c50513          	addi	a0,a0,588 # 72e0 <malloc+0x1650>
    ...
    30b8:	89450513          	addi	a0,a0,-1900 # 6948 <malloc+0xcb8>
    30bc:	00003097          	auipc	ra,0x3
    30c0:	b16080e7          	jalr	-1258(ra) # 5bd2 <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d4:	1d850513          	addi	a0,a0,472 # 72a8 <malloc+0x1618>
    30d8:	00003097          	auipc	ra,0x3
    30dc:	afa080e7          	jalr	-1286(ra) # 5bd2 <printf>
      exit(1);
    30e0:	4505                	li	a0,1
    ...
    30f0:	24450513          	addi	a0,a0,580 # 7330 <malloc+0x16a0>
    30f4:	00003097          	auipc	ra,0x3
    30f8:	ade080e7          	jalr	-1314(ra) # 5bd2 <printf>
      exit(1);
    30fc:	4505                	li	a0,1
    ...
    310c:	1e850513          	addi	a0,a0,488 # 72f0 <malloc+0x1660>
    3110:	00003097          	auipc	ra,0x3
    3114:	ac2080e7          	jalr	-1342(ra) # 5bd2 <printf>
      exit(1);
    3118:	4505                	li	a0,1
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	20250513          	addi	a0,a0,514 # 7348 <malloc+0x16b8>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	1ee50513          	addi	a0,a0,494 # 7348 <malloc+0x16b8>
  ...
  if(chdir("..") < 0){
    ...
    3172:	1fa50513          	addi	a0,a0,506 # 7368 <malloc+0x16d8>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	1c650513          	addi	a0,a0,454 # 7348 <malloc+0x16b8>
    ...
    31a6:	10650513          	addi	a0,a0,262 # 72a8 <malloc+0x1618>
    31aa:	00003097          	auipc	ra,0x3
    31ae:	a28080e7          	jalr	-1496(ra) # 5bd2 <printf>
    exit(1);
    31b2:	4505                	li	a0,1
    ...
    31c2:	19250513          	addi	a0,a0,402 # 7350 <malloc+0x16c0>
    31c6:	00003097          	auipc	ra,0x3
    31ca:	a0c080e7          	jalr	-1524(ra) # 5bd2 <printf>
    exit(1);
    31ce:	4505                	li	a0,1
    ...
    31de:	19650513          	addi	a0,a0,406 # 7370 <malloc+0x16e0>
    31e2:	00003097          	auipc	ra,0x3
    31e6:	9f0080e7          	jalr	-1552(ra) # 5bd2 <printf>
    exit(1);
    31ea:	4505                	li	a0,1
    ...
    31fa:	19250513          	addi	a0,a0,402 # 7388 <malloc+0x16f8>
    31fe:	00003097          	auipc	ra,0x3
    3202:	9d4080e7          	jalr	-1580(ra) # 5bd2 <printf>
    exit(1);
    3206:	4505                	li	a0,1
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	2b250513          	addi	a0,a0,690 # 74d0 <malloc+0x1840>
    3226:	00002097          	auipc	ra,0x2
    322a:	67c080e7          	jalr	1660(ra) # 58a2 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	17250513          	addi	a0,a0,370 # 73a0 <malloc+0x1710>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	17a50513          	addi	a0,a0,378 # 73c0 <malloc+0x1730>
  ...
  write(fd, "ff", 2);
    ...
    3262:	27258593          	addi	a1,a1,626 # 74d0 <malloc+0x1840>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	12850513          	addi	a0,a0,296 # 73a0 <malloc+0x1710>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	18c50513          	addi	a0,a0,396 # 7418 <malloc+0x1788>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	19c50513          	addi	a0,a0,412 # 7440 <malloc+0x17b0>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	1b458593          	addi	a1,a1,436 # 7470 <malloc+0x17e0>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	1a050513          	addi	a0,a0,416 # 7478 <malloc+0x17e8>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	aa858593          	addi	a1,a1,-1368 # bd98 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	a9274703          	lbu	a4,-1390(a4) # bd98 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	1a858593          	addi	a1,a1,424 # 74c8 <malloc+0x1838>
    3328:	00004517          	auipc	a0,0x4
    332c:	11850513          	addi	a0,a0,280 # 7440 <malloc+0x17b0>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	10450513          	addi	a0,a0,260 # 7440 <malloc+0x17b0>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	0ee50513          	addi	a0,a0,238 # 7440 <malloc+0x17b0>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	03a50513          	addi	a0,a0,58 # 73a0 <malloc+0x1710>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	1e650513          	addi	a0,a0,486 # 7560 <malloc+0x18d0>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	20250513          	addi	a0,a0,514 # 7590 <malloc+0x1900>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	21e50513          	addi	a0,a0,542 # 75c0 <malloc+0x1930>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	11050513          	addi	a0,a0,272 # 74c8 <malloc+0x1838>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	9c858593          	addi	a1,a1,-1592 # bd98 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	04e50513          	addi	a0,a0,78 # 7440 <malloc+0x17b0>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	24650513          	addi	a0,a0,582 # 7650 <malloc+0x19c0>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	25e50513          	addi	a0,a0,606 # 7680 <malloc+0x19f0>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	f6650513          	addi	a0,a0,-154 # 73a0 <malloc+0x1710>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	f5050513          	addi	a0,a0,-176 # 73a0 <malloc+0x1710>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	f3a50513          	addi	a0,a0,-198 # 73a0 <malloc+0x1710>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	29658593          	addi	a1,a1,662 # 7710 <malloc+0x1a80>
    3482:	00004517          	auipc	a0,0x4
    3486:	1ce50513          	addi	a0,a0,462 # 7650 <malloc+0x19c0>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	27a58593          	addi	a1,a1,634 # 7710 <malloc+0x1a80>
    349e:	00004517          	auipc	a0,0x4
    34a2:	1e250513          	addi	a0,a0,482 # 7680 <malloc+0x19f0>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	01658593          	addi	a1,a1,22 # 74c8 <malloc+0x1838>
    34ba:	00004517          	auipc	a0,0x4
    34be:	f0650513          	addi	a0,a0,-250 # 73c0 <malloc+0x1730>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	18250513          	addi	a0,a0,386 # 7650 <malloc+0x19c0>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	19e50513          	addi	a0,a0,414 # 7680 <malloc+0x19f0>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	fd250513          	addi	a0,a0,-46 # 74c8 <malloc+0x1838>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	17650513          	addi	a0,a0,374 # 7680 <malloc+0x19f0>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	13250513          	addi	a0,a0,306 # 7650 <malloc+0x19c0>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	e8e50513          	addi	a0,a0,-370 # 73c0 <malloc+0x1730>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	31a50513          	addi	a0,a0,794 # 7860 <malloc+0x1bd0>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	f6e50513          	addi	a0,a0,-146 # 74c8 <malloc+0x1838>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	e5250513          	addi	a0,a0,-430 # 73c0 <malloc+0x1730>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	e1e50513          	addi	a0,a0,-482 # 73a0 <malloc+0x1710>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	33a50513          	addi	a0,a0,826 # 78d0 <malloc+0x1c40>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	df650513          	addi	a0,a0,-522 # 73a0 <malloc+0x1710>
    ...
    35d0:	ddc50513          	addi	a0,a0,-548 # 73a8 <malloc+0x1718>
    35d4:	00002097          	auipc	ra,0x2
    35d8:	5fe080e7          	jalr	1534(ra) # 5bd2 <printf>
    exit(1);
    35dc:	4505                	li	a0,1
    ...
    35ec:	de050513          	addi	a0,a0,-544 # 73c8 <malloc+0x1738>
    35f0:	00002097          	auipc	ra,0x2
    35f4:	5e2080e7          	jalr	1506(ra) # 5bd2 <printf>
    exit(1);
    35f8:	4505                	li	a0,1
    ...
    3608:	de450513          	addi	a0,a0,-540 # 73e8 <malloc+0x1758>
    360c:	00002097          	auipc	ra,0x2
    3610:	5c6080e7          	jalr	1478(ra) # 5bd2 <printf>
    exit(1);
    3614:	4505                	li	a0,1
    ...
    3624:	e0050513          	addi	a0,a0,-512 # 7420 <malloc+0x1790>
    3628:	00002097          	auipc	ra,0x2
    362c:	5aa080e7          	jalr	1450(ra) # 5bd2 <printf>
    exit(1);
    3630:	4505                	li	a0,1
    ...
    3640:	e1450513          	addi	a0,a0,-492 # 7450 <malloc+0x17c0>
    3644:	00002097          	auipc	ra,0x2
    3648:	58e080e7          	jalr	1422(ra) # 5bd2 <printf>
    exit(1);
    364c:	4505                	li	a0,1
    ...
    365c:	e3050513          	addi	a0,a0,-464 # 7488 <malloc+0x17f8>
    3660:	00002097          	auipc	ra,0x2
    3664:	572080e7          	jalr	1394(ra) # 5bd2 <printf>
    exit(1);
    3668:	4505                	li	a0,1
    ...
    3678:	e3450513          	addi	a0,a0,-460 # 74a8 <malloc+0x1818>
    367c:	00002097          	auipc	ra,0x2
    3680:	556080e7          	jalr	1366(ra) # 5bd2 <printf>
    exit(1);
    3684:	4505                	li	a0,1
    ...
    3694:	e4850513          	addi	a0,a0,-440 # 74d8 <malloc+0x1848>
    3698:	00002097          	auipc	ra,0x2
    369c:	53a080e7          	jalr	1338(ra) # 5bd2 <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	e5450513          	addi	a0,a0,-428 # 7500 <malloc+0x1870>
    36b4:	00002097          	auipc	ra,0x2
    36b8:	51e080e7          	jalr	1310(ra) # 5bd2 <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	e5850513          	addi	a0,a0,-424 # 7520 <malloc+0x1890>
    36d0:	00002097          	auipc	ra,0x2
    36d4:	502080e7          	jalr	1282(ra) # 5bd2 <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	e6450513          	addi	a0,a0,-412 # 7548 <malloc+0x18b8>
    36ec:	00002097          	auipc	ra,0x2
    36f0:	4e6080e7          	jalr	1254(ra) # 5bd2 <printf>
    exit(1);
    36f4:	4505                	li	a0,1
    ...
    3704:	e7050513          	addi	a0,a0,-400 # 7570 <malloc+0x18e0>
    3708:	00002097          	auipc	ra,0x2
    370c:	4ca080e7          	jalr	1226(ra) # 5bd2 <printf>
    exit(1);
    3710:	4505                	li	a0,1
    ...
    3720:	e8450513          	addi	a0,a0,-380 # 75a0 <malloc+0x1910>
    3724:	00002097          	auipc	ra,0x2
    3728:	4ae080e7          	jalr	1198(ra) # 5bd2 <printf>
    exit(1);
    372c:	4505                	li	a0,1
    ...
    373c:	e9050513          	addi	a0,a0,-368 # 75c8 <malloc+0x1938>
    3740:	00002097          	auipc	ra,0x2
    3744:	492080e7          	jalr	1170(ra) # 5bd2 <printf>
    exit(1);
    3748:	4505                	li	a0,1
    ...
    3758:	e8c50513          	addi	a0,a0,-372 # 75e0 <malloc+0x1950>
    375c:	00002097          	auipc	ra,0x2
    3760:	476080e7          	jalr	1142(ra) # 5bd2 <printf>
    exit(1);
    3764:	4505                	li	a0,1
    ...
    3774:	e9050513          	addi	a0,a0,-368 # 7600 <malloc+0x1970>
    3778:	00002097          	auipc	ra,0x2
    377c:	45a080e7          	jalr	1114(ra) # 5bd2 <printf>
    exit(1);
    3780:	4505                	li	a0,1
    ...
    3790:	e9450513          	addi	a0,a0,-364 # 7620 <malloc+0x1990>
    3794:	00002097          	auipc	ra,0x2
    3798:	43e080e7          	jalr	1086(ra) # 5bd2 <printf>
    exit(1);
    379c:	4505                	li	a0,1
    ...
    37ac:	eb850513          	addi	a0,a0,-328 # 7660 <malloc+0x19d0>
    37b0:	00002097          	auipc	ra,0x2
    37b4:	422080e7          	jalr	1058(ra) # 5bd2 <printf>
    exit(1);
    37b8:	4505                	li	a0,1
    ...
    37c8:	ecc50513          	addi	a0,a0,-308 # 7690 <malloc+0x1a00>
    37cc:	00002097          	auipc	ra,0x2
    37d0:	406080e7          	jalr	1030(ra) # 5bd2 <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e4:	ed050513          	addi	a0,a0,-304 # 76b0 <malloc+0x1a20>
    37e8:	00002097          	auipc	ra,0x2
    37ec:	3ea080e7          	jalr	1002(ra) # 5bd2 <printf>
    exit(1);
    37f0:	4505                	li	a0,1
    ...
    3800:	ed450513          	addi	a0,a0,-300 # 76d0 <malloc+0x1a40>
    3804:	00002097          	auipc	ra,0x2
    3808:	3ce080e7          	jalr	974(ra) # 5bd2 <printf>
    exit(1);
    380c:	4505                	li	a0,1
    ...
    381c:	ed850513          	addi	a0,a0,-296 # 76f0 <malloc+0x1a60>
    3820:	00002097          	auipc	ra,0x2
    3824:	3b2080e7          	jalr	946(ra) # 5bd2 <printf>
    exit(1);
    3828:	4505                	li	a0,1
    ...
    3838:	eec50513          	addi	a0,a0,-276 # 7720 <malloc+0x1a90>
    383c:	00002097          	auipc	ra,0x2
    3840:	396080e7          	jalr	918(ra) # 5bd2 <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    3854:	ef850513          	addi	a0,a0,-264 # 7748 <malloc+0x1ab8>
    3858:	00002097          	auipc	ra,0x2
    385c:	37a080e7          	jalr	890(ra) # 5bd2 <printf>
    exit(1);
    3860:	4505                	li	a0,1
    ...
    3870:	f0450513          	addi	a0,a0,-252 # 7770 <malloc+0x1ae0>
    3874:	00002097          	auipc	ra,0x2
    3878:	35e080e7          	jalr	862(ra) # 5bd2 <printf>
    exit(1);
    387c:	4505                	li	a0,1
    ...
    388c:	f1050513          	addi	a0,a0,-240 # 7798 <malloc+0x1b08>
    3890:	00002097          	auipc	ra,0x2
    3894:	342080e7          	jalr	834(ra) # 5bd2 <printf>
    exit(1);
    3898:	4505                	li	a0,1
    ...
    38a8:	f1450513          	addi	a0,a0,-236 # 77b8 <malloc+0x1b28>
    38ac:	00002097          	auipc	ra,0x2
    38b0:	326080e7          	jalr	806(ra) # 5bd2 <printf>
    exit(1);
    38b4:	4505                	li	a0,1
    ...
    38c4:	f1850513          	addi	a0,a0,-232 # 77d8 <malloc+0x1b48>
    38c8:	00002097          	auipc	ra,0x2
    38cc:	30a080e7          	jalr	778(ra) # 5bd2 <printf>
    exit(1);
    38d0:	4505                	li	a0,1
    ...
    38e0:	f2450513          	addi	a0,a0,-220 # 7800 <malloc+0x1b70>
    38e4:	00002097          	auipc	ra,0x2
    38e8:	2ee080e7          	jalr	750(ra) # 5bd2 <printf>
    exit(1);
    38ec:	4505                	li	a0,1
    ...
    38fc:	f2850513          	addi	a0,a0,-216 # 7820 <malloc+0x1b90>
    3900:	00002097          	auipc	ra,0x2
    3904:	2d2080e7          	jalr	722(ra) # 5bd2 <printf>
    exit(1);
    3908:	4505                	li	a0,1
    ...
    3918:	f2c50513          	addi	a0,a0,-212 # 7840 <malloc+0x1bb0>
    391c:	00002097          	auipc	ra,0x2
    3920:	2b6080e7          	jalr	694(ra) # 5bd2 <printf>
    exit(1);
    3924:	4505                	li	a0,1
    ...
    3934:	f3850513          	addi	a0,a0,-200 # 7868 <malloc+0x1bd8>
    3938:	00002097          	auipc	ra,0x2
    393c:	29a080e7          	jalr	666(ra) # 5bd2 <printf>
    exit(1);
    3940:	4505                	li	a0,1
    ...
    3950:	bb450513          	addi	a0,a0,-1100 # 7500 <malloc+0x1870>
    3954:	00002097          	auipc	ra,0x2
    3958:	27e080e7          	jalr	638(ra) # 5bd2 <printf>
    exit(1);
    395c:	4505                	li	a0,1
    ...
    396c:	f2050513          	addi	a0,a0,-224 # 7888 <malloc+0x1bf8>
    3970:	00002097          	auipc	ra,0x2
    3974:	262080e7          	jalr	610(ra) # 5bd2 <printf>
    exit(1);
    3978:	4505                	li	a0,1
    ...
    3988:	f2450513          	addi	a0,a0,-220 # 78a8 <malloc+0x1c18>
    398c:	00002097          	auipc	ra,0x2
    3990:	246080e7          	jalr	582(ra) # 5bd2 <printf>
    exit(1);
    3994:	4505                	li	a0,1
    ...
    39a4:	f3850513          	addi	a0,a0,-200 # 78d8 <malloc+0x1c48>
    39a8:	00002097          	auipc	ra,0x2
    39ac:	22a080e7          	jalr	554(ra) # 5bd2 <printf>
    exit(1);
    39b0:	4505                	li	a0,1
    ...
    39c0:	f3c50513          	addi	a0,a0,-196 # 78f8 <malloc+0x1c68>
    39c4:	00002097          	auipc	ra,0x2
    39c8:	20e080e7          	jalr	526(ra) # 5bd2 <printf>
    exit(1);
    39cc:	4505                	li	a0,1
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	f2e50513          	addi	a0,a0,-210 # 7910 <malloc+0x1c80>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	f1c50513          	addi	a0,a0,-228 # 7910 <malloc+0x1c80>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	da250513          	addi	a0,a0,-606 # 67a8 <malloc+0xb18>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	95050513          	addi	a0,a0,-1712 # 7368 <malloc+0x16d8>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	8e650513          	addi	a0,a0,-1818 # 7310 <malloc+0x1680>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	f3c50513          	addi	a0,a0,-196 # 7978 <malloc+0x1ce8>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	f5250513          	addi	a0,a0,-174 # 79a0 <malloc+0x1d10>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	eb050513          	addi	a0,a0,-336 # 7910 <malloc+0x1c80>
    ...
    3a82:	e9a50513          	addi	a0,a0,-358 # 7918 <malloc+0x1c88>
    3a86:	00002097          	auipc	ra,0x2
    3a8a:	14c080e7          	jalr	332(ra) # 5bd2 <printf>
    exit(1);
    3a8e:	4505                	li	a0,1
    ...
    3a9e:	e9650513          	addi	a0,a0,-362 # 7930 <malloc+0x1ca0>
    3aa2:	00002097          	auipc	ra,0x2
    3aa6:	130080e7          	jalr	304(ra) # 5bd2 <printf>
    exit(1);
    3aaa:	4505                	li	a0,1
    ...
    3aba:	e9250513          	addi	a0,a0,-366 # 7948 <malloc+0x1cb8>
    3abe:	00002097          	auipc	ra,0x2
    3ac2:	114080e7          	jalr	276(ra) # 5bd2 <printf>
    exit(1);
    3ac6:	4505                	li	a0,1
    ...
    3ad6:	e8e50513          	addi	a0,a0,-370 # 7960 <malloc+0x1cd0>
    3ada:	00002097          	auipc	ra,0x2
    3ade:	0f8080e7          	jalr	248(ra) # 5bd2 <printf>
    exit(1);
    3ae2:	4505                	li	a0,1
    ...
    3af2:	82a50513          	addi	a0,a0,-2006 # 7318 <malloc+0x1688>
    3af6:	00002097          	auipc	ra,0x2
    3afa:	0dc080e7          	jalr	220(ra) # 5bd2 <printf>
    exit(1);
    3afe:	4505                	li	a0,1
    ...
    3b0e:	e7650513          	addi	a0,a0,-394 # 7980 <malloc+0x1cf0>
    3b12:	00002097          	auipc	ra,0x2
    3b16:	0c0080e7          	jalr	192(ra) # 5bd2 <printf>
    exit(1);
    3b1a:	4505                	li	a0,1
    ...
    3b2a:	e8250513          	addi	a0,a0,-382 # 79a8 <malloc+0x1d18>
    3b2e:	00002097          	auipc	ra,0x2
    3b32:	0a4080e7          	jalr	164(ra) # 5bd2 <printf>
    exit(1);
    3b36:	4505                	li	a0,1
    ...
    3b46:	e8650513          	addi	a0,a0,-378 # 79c8 <malloc+0x1d38>
    3b4a:	00002097          	auipc	ra,0x2
    3b4e:	088080e7          	jalr	136(ra) # 5bd2 <printf>
    exit(1);
    3b52:	4505                	li	a0,1
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	54250513          	addi	a0,a0,1346 # 60b0 <malloc+0x420>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	52650513          	addi	a0,a0,1318 # 60b0 <malloc+0x420>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	e8a50513          	addi	a0,a0,-374 # 7a28 <malloc+0x1d98>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	e7250513          	addi	a0,a0,-398 # 7a28 <malloc+0x1d98>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	e5e50513          	addi	a0,a0,-418 # 7a28 <malloc+0x1d98>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	e4a50513          	addi	a0,a0,-438 # 7a28 <malloc+0x1d98>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	e3658593          	addi	a1,a1,-458 # 7a28 <malloc+0x1d98>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	6ae50513          	addi	a0,a0,1710 # 62a8 <malloc+0x618>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	4a250513          	addi	a0,a0,1186 # 60b0 <malloc+0x420>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	b8450513          	addi	a0,a0,-1148 # 67a8 <malloc+0xb18>
  ...
  fd = open(".", 0);
    ...
    3c3e:	b6e50513          	addi	a0,a0,-1170 # 67a8 <malloc+0xb18>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	53258593          	addi	a1,a1,1330 # 6180 <malloc+0x4f0>
  ...
  close(fd);
    ...
    3c7e:	d6e50513          	addi	a0,a0,-658 # 79e8 <malloc+0x1d58>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	f50080e7          	jalr	-176(ra) # 5bd2 <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	d7250513          	addi	a0,a0,-654 # 7a08 <malloc+0x1d78>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	f34080e7          	jalr	-204(ra) # 5bd2 <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	d8650513          	addi	a0,a0,-634 # 7a38 <malloc+0x1da8>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	f18080e7          	jalr	-232(ra) # 5bd2 <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	d6a50513          	addi	a0,a0,-662 # 7a38 <malloc+0x1da8>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	efc080e7          	jalr	-260(ra) # 5bd2 <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	d7650513          	addi	a0,a0,-650 # 7a60 <malloc+0x1dd0>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	ee0080e7          	jalr	-288(ra) # 5bd2 <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	d8250513          	addi	a0,a0,-638 # 7a88 <malloc+0x1df8>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	ec4080e7          	jalr	-316(ra) # 5bd2 <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	d8e50513          	addi	a0,a0,-626 # 7ab0 <malloc+0x1e20>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	ea8080e7          	jalr	-344(ra) # 5bd2 <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	d9a50513          	addi	a0,a0,-614 # 7ad8 <malloc+0x1e48>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	e8c080e7          	jalr	-372(ra) # 5bd2 <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	d9e50513          	addi	a0,a0,-610 # 7af8 <malloc+0x1e68>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	e70080e7          	jalr	-400(ra) # 5bd2 <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	daa50513          	addi	a0,a0,-598 # 7b20 <malloc+0x1e90>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	e54080e7          	jalr	-428(ra) # 5bd2 <printf>
    exit(1);
    3d86:	4505                	li	a0,1
...
0000000000003d90 <iref>:
{
    ...
    3dae:	d8ea0a13          	addi	s4,s4,-626 # 7b38 <malloc+0x1ea8>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	89648493          	addi	s1,s1,-1898 # 7648 <malloc+0x19b8>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	4eea8a93          	addi	s5,s5,1262 # 62a8 <malloc+0x618>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	c6e98993          	addi	s3,s3,-914 # 7a30 <malloc+0x1da0>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	d7250513          	addi	a0,a0,-654 # 7b40 <malloc+0x1eb0>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	dfc080e7          	jalr	-516(ra) # 5bd2 <printf>
      exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	d6e50513          	addi	a0,a0,-658 # 7b58 <malloc+0x1ec8>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	de0080e7          	jalr	-544(ra) # 5bd2 <printf>
      exit(1);
    3dfa:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	4ea98993          	addi	s3,s3,1258 # 7368 <malloc+0x16d8>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	cb290913          	addi	s2,s2,-846 # 7b38 <malloc+0x1ea8>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	46a50513          	addi	a0,a0,1130 # 7310 <malloc+0x1680>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	c9a50513          	addi	a0,a0,-870 # 7b70 <malloc+0x1ee0>
  ...
  if(pid == 0){
    ...
    3efe:	c7650513          	addi	a0,a0,-906 # 7b70 <malloc+0x1ee0>
    ...
    3f14:	c8050513          	addi	a0,a0,-896 # 7b90 <malloc+0x1f00>
    3f18:	00002097          	auipc	ra,0x2
    3f1c:	cba080e7          	jalr	-838(ra) # 5bd2 <printf>
      exit(1);
    3f20:	4505                	li	a0,1
    ...
    3f30:	c4c50513          	addi	a0,a0,-948 # 7b78 <malloc+0x1ee8>
    3f34:	00002097          	auipc	ra,0x2
    3f38:	c9e080e7          	jalr	-866(ra) # 5bd2 <printf>
    exit(1);
    3f3c:	4505                	li	a0,1
    ...
    3f4c:	a0050513          	addi	a0,a0,-1536 # 6948 <malloc+0xcb8>
    3f50:	00002097          	auipc	ra,0x2
    3f54:	c82080e7          	jalr	-894(ra) # 5bd2 <printf>
    exit(1);
    3f58:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	bfa50513          	addi	a0,a0,-1030 # 7b70 <malloc+0x1ee0>
    ...
    3f8e:	bae50513          	addi	a0,a0,-1106 # 6b38 <malloc+0xea8>
    3f92:	00002097          	auipc	ra,0x2
    3f96:	c40080e7          	jalr	-960(ra) # 5bd2 <printf>
    exit(1);
    3f9a:	4505                	li	a0,1
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	bf050513          	addi	a0,a0,-1040 # 7bb8 <malloc+0x1f28>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	bc450513          	addi	a0,a0,-1084 # 7bb8 <malloc+0x1f28>
  ...
  sleep(10); // one second
    ...
    4030:	adc50513          	addi	a0,a0,-1316 # 6b08 <malloc+0xe78>
    4034:	00002097          	auipc	ra,0x2
    4038:	b9e080e7          	jalr	-1122(ra) # 5bd2 <printf>
    exit(1);
    403c:	4505                	li	a0,1
    ...
    404a:	b7248493          	addi	s1,s1,-1166 # 7bb8 <malloc+0x1f28>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	85a50513          	addi	a0,a0,-1958 # 6948 <malloc+0xcb8>
    40f6:	00002097          	auipc	ra,0x2
    40fa:	adc080e7          	jalr	-1316(ra) # 5bd2 <printf>
      exit(1);
    40fe:	4505                	li	a0,1
    ...
    4118:	ab450513          	addi	a0,a0,-1356 # 7bc8 <malloc+0x1f38>
    411c:	00002097          	auipc	ra,0x2
    4120:	ab6080e7          	jalr	-1354(ra) # 5bd2 <printf>
       exit(1);
    4124:	4505                	li	a0,1
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	9b450513          	addi	a0,a0,-1612 # 6b08 <malloc+0xe78>
    415c:	00002097          	auipc	ra,0x2
    4160:	a76080e7          	jalr	-1418(ra) # 5bd2 <printf>
    exit(1);
    4164:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4186:	7c650513          	addi	a0,a0,1990 # 6948 <malloc+0xcb8>
    418a:	00002097          	auipc	ra,0x2
    418e:	a48080e7          	jalr	-1464(ra) # 5bd2 <printf>
    exit(1);
    4192:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41ca:	fba58593          	addi	a1,a1,-70 # 6180 <malloc+0x4f0>
    ...
    41f4:	75850513          	addi	a0,a0,1880 # 6948 <malloc+0xcb8>
    41f8:	00002097          	auipc	ra,0x2
    41fc:	9da080e7          	jalr	-1574(ra) # 5bd2 <printf>
     exit(1);
    4200:	4505                	li	a0,1
    ...
    4210:	9dc50513          	addi	a0,a0,-1572 # 7be8 <malloc+0x1f58>
    4214:	00002097          	auipc	ra,0x2
    4218:	9be080e7          	jalr	-1602(ra) # 5bd2 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	b6c58593          	addi	a1,a1,-1172 # bd98 <buf>
    ...
    424c:	9b850513          	addi	a0,a0,-1608 # 7c00 <malloc+0x1f70>
    4250:	00002097          	auipc	ra,0x2
    4254:	982080e7          	jalr	-1662(ra) # 5bd2 <printf>
}
  ...
  printf("kill... ");
    ...
    4278:	9a450513          	addi	a0,a0,-1628 # 7c18 <malloc+0x1f88>
    427c:	00002097          	auipc	ra,0x2
    4280:	956080e7          	jalr	-1706(ra) # 5bd2 <printf>
  kill(pid1);
    4284:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    42a6:	98650513          	addi	a0,a0,-1658 # 7c28 <malloc+0x1f98>
    42aa:	00002097          	auipc	ra,0x2
    42ae:	928080e7          	jalr	-1752(ra) # 5bd2 <printf>
  wait(0);
    42b2:	4501                	li	a0,0
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	62650513          	addi	a0,a0,1574 # 6948 <malloc+0xcb8>
    432a:	00002097          	auipc	ra,0x2
    432e:	8a8080e7          	jalr	-1880(ra) # 5bd2 <printf>
      exit(1);
    4332:	4505                	li	a0,1
    ...
    4342:	79250513          	addi	a0,a0,1938 # 6ad0 <malloc+0xe40>
    4346:	00002097          	auipc	ra,0x2
    434a:	88c080e7          	jalr	-1908(ra) # 5bd2 <printf>
        exit(1);
    434e:	4505                	li	a0,1
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	69c50513          	addi	a0,a0,1692 # 6a50 <malloc+0xdc0>
    43bc:	00002097          	auipc	ra,0x2
    43c0:	816080e7          	jalr	-2026(ra) # 5bd2 <printf>
    exit(1);
    43c4:	4505                	li	a0,1
    ...
    43ee:	d9658593          	addi	a1,a1,-618 # 6180 <malloc+0x4f0>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	78a50513          	addi	a0,a0,1930 # 7c38 <malloc+0x1fa8>
    44b6:	00001097          	auipc	ra,0x1
    44ba:	71c080e7          	jalr	1820(ra) # 5bd2 <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	47e50513          	addi	a0,a0,1150 # 6948 <malloc+0xcb8>
    44d2:	00001097          	auipc	ra,0x1
    44d6:	700080e7          	jalr	1792(ra) # 5bd2 <printf>
    exit(1);
    44da:	4505                	li	a0,1
    ...
    451a:	74250513          	addi	a0,a0,1858 # 7c58 <malloc+0x1fc8>
    451e:	00001097          	auipc	ra,0x1
    4522:	6b4080e7          	jalr	1716(ra) # 5bd2 <printf>
    exit(1);
    4526:	4505                	li	a0,1
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4562:	732080e7          	jalr	1842(ra) # 5c90 <malloc>
    ...
    45a2:	6ea50513          	addi	a0,a0,1770 # 7c88 <malloc+0x1ff8>
    45a6:	00001097          	auipc	ra,0x1
    45aa:	62c080e7          	jalr	1580(ra) # 5bd2 <printf>
      exit(1);
    45ae:	4505                	li	a0,1
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	63650513          	addi	a0,a0,1590 # 7ca8 <malloc+0x2018>
    467a:	00001097          	auipc	ra,0x1
    467e:	558080e7          	jalr	1368(ra) # 5bd2 <printf>
    exit(1);
    4682:	4505                	li	a0,1
    ...
    4692:	64250513          	addi	a0,a0,1602 # 7cd0 <malloc+0x2040>
    4696:	00001097          	auipc	ra,0x1
    469a:	53c080e7          	jalr	1340(ra) # 5bd2 <printf>
      exit(1);
    469e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	84e50513          	addi	a0,a0,-1970 # 5f20 <malloc+0x290>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	5de50513          	addi	a0,a0,1502 # 7cf0 <malloc+0x2060>
    471a:	00001097          	auipc	ra,0x1
    471e:	4b8080e7          	jalr	1208(ra) # 5bd2 <printf>
    exit(1);
    4722:	4505                	li	a0,1
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1258>
  ...
  unlink("sharedfd");
    ...
    4752:	7d250513          	addi	a0,a0,2002 # 5f20 <malloc+0x290>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	5a450513          	addi	a0,a0,1444 # 7d18 <malloc+0x2088>
    477c:	00001097          	auipc	ra,0x1
    4780:	456080e7          	jalr	1110(ra) # 5bd2 <printf>
    exit(1);
    4784:	4505                	li	a0,1
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	5c078793          	addi	a5,a5,1472 # 5d78 <malloc+0xe8>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	5bc78793          	addi	a5,a5,1468 # 5d80 <malloc+0xf0>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	5b878793          	addi	a5,a5,1464 # 5d88 <malloc+0xf8>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	5b478793          	addi	a5,a5,1460 # 5d90 <malloc+0x100>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	562a0a13          	addi	s4,s4,1378 # bd98 <buf>
    483e:	00007a97          	auipc	s5,0x7
    4842:	55ba8a93          	addi	s5,s5,1371 # bd99 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	51450513          	addi	a0,a0,1300 # 6d68 <malloc+0x10d8>
    485c:	00001097          	auipc	ra,0x1
    4860:	376080e7          	jalr	886(ra) # 5bd2 <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    48d2:	46250513          	addi	a0,a0,1122 # 7d30 <malloc+0x20a0>
    48d6:	00001097          	auipc	ra,0x1
    48da:	2fc080e7          	jalr	764(ra) # 5bd2 <printf>
        exit(1);
    48de:	4505                	li	a0,1
    ...
    48ec:	45850513          	addi	a0,a0,1112 # 7d40 <malloc+0x20b0>
    48f0:	00001097          	auipc	ra,0x1
    48f4:	2e2080e7          	jalr	738(ra) # 5bd2 <printf>
          exit(1);
    48f8:	4505                	li	a0,1
    ...
    4910:	44c50513          	addi	a0,a0,1100 # 7d58 <malloc+0x20c8>
    4914:	00001097          	auipc	ra,0x1
    4918:	2be080e7          	jalr	702(ra) # 5bd2 <printf>
          exit(1);
    491c:	4505                	li	a0,1
    ...
    4940:	45c78793          	addi	a5,a5,1116 # bd98 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	3cc50513          	addi	a0,a0,972 # 7d68 <malloc+0x20d8>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	22e080e7          	jalr	558(ra) # 5bd2 <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	382b8b93          	addi	s7,s7,898 # 7d80 <malloc+0x20f0>
  for(i = 0; i < N; i++){
    ...
    4a44:	34850513          	addi	a0,a0,840 # 7d88 <malloc+0x20f8>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	18a080e7          	jalr	394(ra) # 5bd2 <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	32250513          	addi	a0,a0,802 # 7d80 <malloc+0x20f0>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d1250513          	addi	a0,a0,-750 # 67a8 <malloc+0xb18>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	2ec50513          	addi	a0,a0,748 # 7da8 <malloc+0x2118>
    4ac4:	00001097          	auipc	ra,0x1
    4ac8:	10e080e7          	jalr	270(ra) # 5bd2 <printf>
        exit(1);
    4acc:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	29c50513          	addi	a0,a0,668 # 7dc8 <malloc+0x2138>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	09e080e7          	jalr	158(ra) # 5bd2 <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	28c50513          	addi	a0,a0,652 # 7df0 <malloc+0x2160>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	066080e7          	jalr	102(ra) # 5bd2 <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	dc850513          	addi	a0,a0,-568 # 6948 <malloc+0xcb8>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	04a080e7          	jalr	74(ra) # 5bd2 <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	02e90913          	addi	s2,s2,46 # bd98 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	07650513          	addi	a0,a0,118 # 7e28 <malloc+0x2198>
  ...
  for(i = 0; ; i++){
    ...
    4dcc:	fd090913          	addi	s2,s2,-48 # bd98 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	02250513          	addi	a0,a0,34 # 7e38 <malloc+0x21a8>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	db4080e7          	jalr	-588(ra) # 5bd2 <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	02650513          	addi	a0,a0,38 # 7e58 <malloc+0x21c8>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	d98080e7          	jalr	-616(ra) # 5bd2 <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	02a50513          	addi	a0,a0,42 # 7e78 <malloc+0x21e8>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	d7c080e7          	jalr	-644(ra) # 5bd2 <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	02e50513          	addi	a0,a0,46 # 7e98 <malloc+0x2208>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	d60080e7          	jalr	-672(ra) # 5bd2 <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	03250513          	addi	a0,a0,50 # 7eb8 <malloc+0x2228>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	d44080e7          	jalr	-700(ra) # 5bd2 <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	02e50513          	addi	a0,a0,46 # 7ed0 <malloc+0x2240>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d28080e7          	jalr	-728(ra) # 5bd2 <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	f5850513          	addi	a0,a0,-168 # 7e28 <malloc+0x2198>
    ...
    4ef8:	ffc50513          	addi	a0,a0,-4 # 7ef0 <malloc+0x2260>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	cd6080e7          	jalr	-810(ra) # 5bd2 <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	fe450513          	addi	a0,a0,-28 # 7f10 <malloc+0x2280>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	c9e080e7          	jalr	-866(ra) # 5bd2 <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	fd4c8c93          	addi	s9,s9,-44 # 7f20 <malloc+0x2290>
    int total = 0;
    4f54:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f56:	00007a17          	auipc	s4,0x7
    4f5a:	e42a0a13          	addi	s4,s4,-446 # bd98 <buf>
    name[0] = 'f';
    ...
    4fa8:	c2e080e7          	jalr	-978(ra) # 5bd2 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	f6a50513          	addi	a0,a0,-150 # 7f30 <malloc+0x22a0>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	c04080e7          	jalr	-1020(ra) # 5bd2 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f1450513          	addi	a0,a0,-236 # 7f50 <malloc+0x22c0>
    5044:	00001097          	auipc	ra,0x1
    5048:	b8e080e7          	jalr	-1138(ra) # 5bd2 <printf>
}
    ...
    5090:	eb450513          	addi	a0,a0,-332 # 7f40 <malloc+0x22b0>
    5094:	00001097          	auipc	ra,0x1
    5098:	b3e080e7          	jalr	-1218(ra) # 5bd2 <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	e4a50513          	addi	a0,a0,-438 # 7f68 <malloc+0x22d8>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	04a58593          	addi	a1,a1,74 # 6180 <malloc+0x4f0>
    ...
    5150:	e3c50513          	addi	a0,a0,-452 # 7f88 <malloc+0x22f8>
    5154:	00001097          	auipc	ra,0x1
    5158:	a7e080e7          	jalr	-1410(ra) # 5bd2 <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e0a50513          	addi	a0,a0,-502 # 7f70 <malloc+0x22e0>
    516e:	00001097          	auipc	ra,0x1
    5172:	a64080e7          	jalr	-1436(ra) # 5bd2 <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	df050513          	addi	a0,a0,-528 # 7f70 <malloc+0x22e0>
    5188:	00001097          	auipc	ra,0x1
    518c:	a4a080e7          	jalr	-1462(ra) # 5bd2 <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	dc450513          	addi	a0,a0,-572 # 7f68 <malloc+0x22d8>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	f8690913          	addi	s2,s2,-122 # 6180 <malloc+0x4f0>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	daa50513          	addi	a0,a0,-598 # 7fd8 <malloc+0x2348>
    5236:	00001097          	auipc	ra,0x1
    523a:	99c080e7          	jalr	-1636(ra) # 5bd2 <printf>
        exit(1);
    523e:	4505                	li	a0,1
    ...
    524c:	d5050513          	addi	a0,a0,-688 # 7f98 <malloc+0x2308>
    5250:	00001097          	auipc	ra,0x1
    5254:	982080e7          	jalr	-1662(ra) # 5bd2 <printf>
    exit(1);
    5258:	4505                	li	a0,1
    ...
    5266:	d5650513          	addi	a0,a0,-682 # 7fb8 <malloc+0x2328>
    526a:	00001097          	auipc	ra,0x1
    526e:	968080e7          	jalr	-1688(ra) # 5bd2 <printf>
    exit(1);
    5272:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b4:	d4850513          	addi	a0,a0,-696 # 7ff8 <malloc+0x2368>
    52b8:	00001097          	auipc	ra,0x1
    52bc:	91a080e7          	jalr	-1766(ra) # 5bd2 <printf>
      exit(1);
    52c0:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	d1850513          	addi	a0,a0,-744 # 8018 <malloc+0x2388>
    5308:	00001097          	auipc	ra,0x1
    530c:	8ca080e7          	jalr	-1846(ra) # 5bd2 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5334:	d1050513          	addi	a0,a0,-752 # 8040 <malloc+0x23b0>
    5338:	00001097          	auipc	ra,0x1
    533c:	89a080e7          	jalr	-1894(ra) # 5bd2 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5358:	cd450513          	addi	a0,a0,-812 # 8028 <malloc+0x2398>
    535c:	00001097          	auipc	ra,0x1
    5360:	876080e7          	jalr	-1930(ra) # 5bd2 <printf>
    exit(1);
    5364:	4505                	li	a0,1
    ...
    5380:	ccc50513          	addi	a0,a0,-820 # 8048 <malloc+0x23b8>
    5384:	00001097          	auipc	ra,0x1
    5388:	84e080e7          	jalr	-1970(ra) # 5bd2 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	d9a78793          	addi	a5,a5,-614 # 8160 <malloc+0x24d0>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	17e30313          	addi	t1,t1,382 # 8550 <malloc+0x28c0>
  ...
  printf("usertests starting\n");
    ...
    540a:	cfa50513          	addi	a0,a0,-774 # 8100 <malloc+0x2470>
    540e:	00000097          	auipc	ra,0x0
    5412:	7c4080e7          	jalr	1988(ra) # 5bd2 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5442:	c7a50513          	addi	a0,a0,-902 # 80b8 <malloc+0x2428>
    5446:	00000097          	auipc	ra,0x0
    544a:	78c080e7          	jalr	1932(ra) # 5bd2 <printf>
    exit(1);
    544e:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	bf658593          	addi	a1,a1,-1034 # 8050 <malloc+0x23c0>
    ...
    5474:	cc858593          	addi	a1,a1,-824 # 8138 <malloc+0x24a8>
    ...
    5498:	bc450513          	addi	a0,a0,-1084 # 8058 <malloc+0x23c8>
    549c:	00000097          	auipc	ra,0x0
    54a0:	736080e7          	jalr	1846(ra) # 5bd2 <printf>
    exit(1);
    54a4:	4505                	li	a0,1
    ...
    54c2:	714080e7          	jalr	1812(ra) # 5bd2 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5504:	ba050513          	addi	a0,a0,-1120 # 80a0 <malloc+0x2410>
    5508:	00000097          	auipc	ra,0x0
    550c:	6ca080e7          	jalr	1738(ra) # 5bd2 <printf>
    exit(1);
    5510:	4505                	li	a0,1
    ...
    551e:	bce50513          	addi	a0,a0,-1074 # 80e8 <malloc+0x2458>
    5522:	00000097          	auipc	ra,0x0
    5526:	6b0080e7          	jalr	1712(ra) # 5bd2 <printf>
    exit(0);
    552a:	4501                	li	a0,0
    ...
    553a:	69c080e7          	jalr	1692(ra) # 5bd2 <printf>
        if(continuous != 2)
    ...
    557c:	be878793          	addi	a5,a5,-1048 # 8160 <malloc+0x24d0>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	fcc30313          	addi	t1,t1,-52 # 8550 <malloc+0x28c0>
    ...
    55bc:	b6050513          	addi	a0,a0,-1184 # 8118 <malloc+0x2488>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	612080e7          	jalr	1554(ra) # 5bd2 <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	ad8a8a93          	addi	s5,s5,-1320 # 80a0 <malloc+0x2410>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	aaeb0b13          	addi	s6,s6,-1362 # 8080 <malloc+0x23f0>
...
putc(int fd, char c)
{
    58fa:	1101                	addi	sp,sp,-32
    58fc:	ec06                	sd	ra,24(sp)
    58fe:	e822                	sd	s0,16(sp)
    5900:	1000                	addi	s0,sp,32
    5902:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5906:	4605                	li	a2,1
    5908:	fef40593          	addi	a1,s0,-17
    590c:	00000097          	auipc	ra,0x0
    5910:	f66080e7          	jalr	-154(ra) # 5872 <write>
}
    5914:	60e2                	ld	ra,24(sp)
    5916:	6442                	ld	s0,16(sp)
    5918:	6105                	addi	sp,sp,32
    591a:	8082                	ret

000000000000591c <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    591c:	7139                	addi	sp,sp,-64
    591e:	fc06                	sd	ra,56(sp)
    5920:	f822                	sd	s0,48(sp)
    5922:	f426                	sd	s1,40(sp)
    5924:	f04a                	sd	s2,32(sp)
    5926:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    592c:	c299                	beqz	a3,5932 <printint+0x16>
    592e:	0805c863          	bltz	a1,59be <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5932:	2581                	sext.w	a1,a1
  neg = 0;
    5934:	4881                	li	a7,0
    5936:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    593c:	2601                	sext.w	a2,a2
    593e:	00003517          	auipc	a0,0x3
    5942:	c1a50513          	addi	a0,a0,-998 # 8558 <digits>
    5946:	883a                	mv	a6,a4
    5948:	2705                	addiw	a4,a4,1
    594a:	02c5f7bb          	remuw	a5,a1,a2
    594e:	1782                	slli	a5,a5,0x20
    5950:	9381                	srli	a5,a5,0x20
    5952:	97aa                	add	a5,a5,a0
    5954:	0007c783          	lbu	a5,0(a5)
    5958:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    595c:	0005879b          	sext.w	a5,a1
    5960:	02c5d5bb          	divuw	a1,a1,a2
    5964:	0685                	addi	a3,a3,1
    5966:	fec7f0e3          	bgeu	a5,a2,5946 <printint+0x2a>
  if(neg)
    596a:	00088b63          	beqz	a7,5980 <printint+0x64>
    buf[i++] = '-';
    596e:	fd040793          	addi	a5,s0,-48
    5972:	973e                	add	a4,a4,a5
    5974:	02d00793          	li	a5,45
    5978:	fef70823          	sb	a5,-16(a4)
    597c:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5980:	02e05863          	blez	a4,59b0 <printint+0x94>
    5984:	fc040793          	addi	a5,s0,-64
    5988:	00e78933          	add	s2,a5,a4
    598c:	fff78993          	addi	s3,a5,-1
    5990:	99ba                	add	s3,s3,a4
    5992:	377d                	addiw	a4,a4,-1
    5994:	1702                	slli	a4,a4,0x20
    5996:	9301                	srli	a4,a4,0x20
    5998:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    599c:	fff94583          	lbu	a1,-1(s2)
    59a0:	8526                	mv	a0,s1
    59a2:	00000097          	auipc	ra,0x0
    59a6:	f58080e7          	jalr	-168(ra) # 58fa <putc>
  while(--i >= 0)
    59aa:	197d                	addi	s2,s2,-1
    59ac:	ff3918e3          	bne	s2,s3,599c <printint+0x80>
}
    ...
    59ba:	6121                	addi	sp,sp,64
    59bc:	8082                	ret
    x = -xx;
    59be:	40b005bb          	negw	a1,a1
    neg = 1;
    59c2:	4885                	li	a7,1
    x = -xx;
    59c4:	bf8d                	j	5936 <printint+0x1a>

00000000000059c6 <vprintf>:
}
...
{
    59c6:	7119                	addi	sp,sp,-128
    59c8:	fc86                	sd	ra,120(sp)
    59ca:	f8a2                	sd	s0,112(sp)
    59cc:	f4a6                	sd	s1,104(sp)
    59ce:	f0ca                	sd	s2,96(sp)
    59d0:	ecce                	sd	s3,88(sp)
    59d2:	e8d2                	sd	s4,80(sp)
    59d4:	e4d6                	sd	s5,72(sp)
    59d6:	e0da                	sd	s6,64(sp)
    59d8:	fc5e                	sd	s7,56(sp)
    59da:	f862                	sd	s8,48(sp)
    59dc:	f466                	sd	s9,40(sp)
    59de:	f06a                	sd	s10,32(sp)
    59e0:	ec6e                	sd	s11,24(sp)
    59e2:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    59e4:	0005c903          	lbu	s2,0(a1)
    59e8:	18090f63          	beqz	s2,5b86 <vprintf+0x1c0>
    59ec:	8aaa                	mv	s5,a0
    59ee:	8b32                	mv	s6,a2
    59f0:	00158493          	addi	s1,a1,1
  state = 0;
    59f4:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    59f6:	02500a13          	li	s4,37
      if(c == 'd'){
    59fa:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    59fe:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5a02:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a06:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a0a:	00003b97          	auipc	s7,0x3
    5a0e:	b4eb8b93          	addi	s7,s7,-1202 # 8558 <digits>
    5a12:	a839                	j	5a30 <vprintf+0x6a>
        putc(fd, c);
    5a14:	85ca                	mv	a1,s2
    5a16:	8556                	mv	a0,s5
    5a18:	00000097          	auipc	ra,0x0
    5a1c:	ee2080e7          	jalr	-286(ra) # 58fa <putc>
    5a20:	a019                	j	5a26 <vprintf+0x60>
    } else if(state == '%'){
    5a22:	01498f63          	beq	s3,s4,5a40 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a26:	0485                	addi	s1,s1,1
    5a28:	fff4c903          	lbu	s2,-1(s1)
    5a2c:	14090d63          	beqz	s2,5b86 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a30:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a34:	fe0997e3          	bnez	s3,5a22 <vprintf+0x5c>
      if(c == '%'){
    5a38:	fd479ee3          	bne	a5,s4,5a14 <vprintf+0x4e>
        state = '%';
    5a3c:	89be                	mv	s3,a5
    5a3e:	b7e5                	j	5a26 <vprintf+0x60>
      if(c == 'd'){
    5a40:	05878063          	beq	a5,s8,5a80 <vprintf+0xba>
      } else if(c == 'l') {
    5a44:	05978c63          	beq	a5,s9,5a9c <vprintf+0xd6>
      } else if(c == 'x') {
    5a48:	07a78863          	beq	a5,s10,5ab8 <vprintf+0xf2>
      } else if(c == 'p') {
    5a4c:	09b78463          	beq	a5,s11,5ad4 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5a50:	07300713          	li	a4,115
    5a54:	0ce78663          	beq	a5,a4,5b20 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5a58:	06300713          	li	a4,99
    5a5c:	0ee78e63          	beq	a5,a4,5b58 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5a60:	11478863          	beq	a5,s4,5b70 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5a64:	85d2                	mv	a1,s4
    5a66:	8556                	mv	a0,s5
    5a68:	00000097          	auipc	ra,0x0
    5a6c:	e92080e7          	jalr	-366(ra) # 58fa <putc>
        putc(fd, c);
    5a70:	85ca                	mv	a1,s2
    5a72:	8556                	mv	a0,s5
    5a74:	00000097          	auipc	ra,0x0
    5a78:	e86080e7          	jalr	-378(ra) # 58fa <putc>
      }
      state = 0;
    5a7c:	4981                	li	s3,0
    5a7e:	b765                	j	5a26 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    5a80:	008b0913          	addi	s2,s6,8
    5a84:	4685                	li	a3,1
    5a86:	4629                	li	a2,10
    5a88:	000b2583          	lw	a1,0(s6)
    5a8c:	8556                	mv	a0,s5
    5a8e:	00000097          	auipc	ra,0x0
    5a92:	e8e080e7          	jalr	-370(ra) # 591c <printint>
    5a96:	8b4a                	mv	s6,s2
      state = 0;
    5a98:	4981                	li	s3,0
    5a9a:	b771                	j	5a26 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5a9c:	008b0913          	addi	s2,s6,8
    5aa0:	4681                	li	a3,0
    5aa2:	4629                	li	a2,10
    5aa4:	000b2583          	lw	a1,0(s6)
    5aa8:	8556                	mv	a0,s5
    5aaa:	00000097          	auipc	ra,0x0
    5aae:	e72080e7          	jalr	-398(ra) # 591c <printint>
    5ab2:	8b4a                	mv	s6,s2
      state = 0;
    5ab4:	4981                	li	s3,0
    5ab6:	bf85                	j	5a26 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5ab8:	008b0913          	addi	s2,s6,8
    5abc:	4681                	li	a3,0
    5abe:	4641                	li	a2,16
    5ac0:	000b2583          	lw	a1,0(s6)
    5ac4:	8556                	mv	a0,s5
    5ac6:	00000097          	auipc	ra,0x0
    5aca:	e56080e7          	jalr	-426(ra) # 591c <printint>
    5ace:	8b4a                	mv	s6,s2
      state = 0;
    5ad0:	4981                	li	s3,0
    5ad2:	bf91                	j	5a26 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5ad4:	008b0793          	addi	a5,s6,8
    5ad8:	f8f43423          	sd	a5,-120(s0)
    5adc:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5ae0:	03000593          	li	a1,48
    5ae4:	8556                	mv	a0,s5
    5ae6:	00000097          	auipc	ra,0x0
    5aea:	e14080e7          	jalr	-492(ra) # 58fa <putc>
  putc(fd, 'x');
    5aee:	85ea                	mv	a1,s10
    5af0:	8556                	mv	a0,s5
    5af2:	00000097          	auipc	ra,0x0
    5af6:	e08080e7          	jalr	-504(ra) # 58fa <putc>
    5afa:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5b0c:	df2080e7          	jalr	-526(ra) # 58fa <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b10:	0992                	slli	s3,s3,0x4
    5b12:	397d                	addiw	s2,s2,-1
    5b14:	fe0914e3          	bnez	s2,5afc <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b18:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b1c:	4981                	li	s3,0
    5b1e:	b721                	j	5a26 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b20:	008b0993          	addi	s3,s6,8
    5b24:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b28:	02090163          	beqz	s2,5b4a <vprintf+0x184>
        while(*s != 0){
    5b2c:	00094583          	lbu	a1,0(s2)
    5b30:	c9a1                	beqz	a1,5b80 <vprintf+0x1ba>
          putc(fd, *s);
    5b32:	8556                	mv	a0,s5
    5b34:	00000097          	auipc	ra,0x0
    5b38:	dc6080e7          	jalr	-570(ra) # 58fa <putc>
          s++;
    5b3c:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b3e:	00094583          	lbu	a1,0(s2)
    5b42:	f9e5                	bnez	a1,5b32 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5b44:	8b4e                	mv	s6,s3
      state = 0;
    5b46:	4981                	li	s3,0
    5b48:	bdf9                	j	5a26 <vprintf+0x60>
          s = "(null)";
    5b4a:	00003917          	auipc	s2,0x3
    5b4e:	a0690913          	addi	s2,s2,-1530 # 8550 <malloc+0x28c0>
        while(*s != 0){
    5b52:	02800593          	li	a1,40
    5b56:	bff1                	j	5b32 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5b58:	008b0913          	addi	s2,s6,8
    5b5c:	000b4583          	lbu	a1,0(s6)
    5b60:	8556                	mv	a0,s5
    5b62:	00000097          	auipc	ra,0x0
    5b66:	d98080e7          	jalr	-616(ra) # 58fa <putc>
    5b6a:	8b4a                	mv	s6,s2
      state = 0;
    5b6c:	4981                	li	s3,0
    5b6e:	bd65                	j	5a26 <vprintf+0x60>
        putc(fd, c);
    5b70:	85d2                	mv	a1,s4
    5b72:	8556                	mv	a0,s5
    5b74:	00000097          	auipc	ra,0x0
    5b78:	d86080e7          	jalr	-634(ra) # 58fa <putc>
      state = 0;
    5b7c:	4981                	li	s3,0
    5b7e:	b565                	j	5a26 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b80:	8b4e                	mv	s6,s3
      state = 0;
    5b82:	4981                	li	s3,0
    5b84:	b54d                	j	5a26 <vprintf+0x60>
    }
  }
}
    5b86:	70e6                	ld	ra,120(sp)
    5b88:	7446                	ld	s0,112(sp)
    5b8a:	74a6                	ld	s1,104(sp)
    5b8c:	7906                	ld	s2,96(sp)
    5b8e:	69e6                	ld	s3,88(sp)
    5b90:	6a46                	ld	s4,80(sp)
    5b92:	6aa6                	ld	s5,72(sp)
    5b94:	6b06                	ld	s6,64(sp)
    5b96:	7be2                	ld	s7,56(sp)
    5b98:	7c42                	ld	s8,48(sp)
    5b9a:	7ca2                	ld	s9,40(sp)
    5b9c:	7d02                	ld	s10,32(sp)
    5b9e:	6de2                	ld	s11,24(sp)
    5ba0:	6109                	addi	sp,sp,128
    5ba2:	8082                	ret

0000000000005ba4 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5ba4:	715d                	addi	sp,sp,-80
    5ba6:	ec06                	sd	ra,24(sp)
    5ba8:	e822                	sd	s0,16(sp)
    5baa:	1000                	addi	s0,sp,32
    5bac:	e010                	sd	a2,0(s0)
    5bae:	e414                	sd	a3,8(s0)
    5bb0:	e818                	sd	a4,16(s0)
    5bb2:	ec1c                	sd	a5,24(s0)
    5bb4:	03043023          	sd	a6,32(s0)
    5bb8:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5bbc:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5bc0:	8622                	mv	a2,s0
    5bc2:	00000097          	auipc	ra,0x0
    5bc6:	e04080e7          	jalr	-508(ra) # 59c6 <vprintf>
}
    5bca:	60e2                	ld	ra,24(sp)
    5bcc:	6442                	ld	s0,16(sp)
    5bce:	6161                	addi	sp,sp,80
    5bd0:	8082                	ret

0000000000005bd2 <printf>:

void
printf(const char *fmt, ...)
{
    5bd2:	711d                	addi	sp,sp,-96
    5bd4:	ec06                	sd	ra,24(sp)
    5bd6:	e822                	sd	s0,16(sp)
    5bd8:	1000                	addi	s0,sp,32
    5bda:	e40c                	sd	a1,8(s0)
    5bdc:	e810                	sd	a2,16(s0)
    5bde:	ec14                	sd	a3,24(s0)
    5be0:	f018                	sd	a4,32(s0)
    5be2:	f41c                	sd	a5,40(s0)
    5be4:	03043823          	sd	a6,48(s0)
    5be8:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5bec:	00840613          	addi	a2,s0,8
    5bf0:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5bf4:	85aa                	mv	a1,a0
    5bf6:	4505                	li	a0,1
    5bf8:	00000097          	auipc	ra,0x0
    5bfc:	dce080e7          	jalr	-562(ra) # 59c6 <vprintf>
}
    5c00:	60e2                	ld	ra,24(sp)
    5c02:	6442                	ld	s0,16(sp)
    5c04:	6125                	addi	sp,sp,96
    5c06:	8082                	ret

0000000000005c08 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    5c0a:	e422                	sd	s0,8(sp)
    5c0c:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c0e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c12:	00003797          	auipc	a5,0x3
    5c16:	9667b783          	ld	a5,-1690(a5) # 8578 <freep>
    5c1a:	a805                	j	5c4a <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c1c:	4618                	lw	a4,8(a2)
    5c1e:	9db9                	addw	a1,a1,a4
    5c20:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c24:	6398                	ld	a4,0(a5)
    5c26:	6318                	ld	a4,0(a4)
    5c28:	fee53823          	sd	a4,-16(a0)
    5c2c:	a091                	j	5c70 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c2e:	ff852703          	lw	a4,-8(a0)
    5c32:	9e39                	addw	a2,a2,a4
    5c34:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c36:	ff053703          	ld	a4,-16(a0)
    5c3a:	e398                	sd	a4,0(a5)
    5c3c:	a099                	j	5c82 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c3e:	6398                	ld	a4,0(a5)
    5c40:	00e7e463          	bltu	a5,a4,5c48 <free+0x40>
    5c44:	00e6ea63          	bltu	a3,a4,5c58 <free+0x50>
{
    5c48:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c4a:	fed7fae3          	bgeu	a5,a3,5c3e <free+0x36>
    5c4e:	6398                	ld	a4,0(a5)
    5c50:	00e6e463          	bltu	a3,a4,5c58 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c54:	fee7eae3          	bltu	a5,a4,5c48 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5c58:	ff852583          	lw	a1,-8(a0)
    5c5c:	6390                	ld	a2,0(a5)
    5c5e:	02059713          	slli	a4,a1,0x20
    5c62:	9301                	srli	a4,a4,0x20
    5c64:	0712                	slli	a4,a4,0x4
    5c66:	9736                	add	a4,a4,a3
    5c68:	fae60ae3          	beq	a2,a4,5c1c <free+0x14>
    bp->s.ptr = p->s.ptr;
    5c6c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c70:	4790                	lw	a2,8(a5)
    5c72:	02061713          	slli	a4,a2,0x20
    5c76:	9301                	srli	a4,a4,0x20
    5c78:	0712                	slli	a4,a4,0x4
    5c7a:	973e                	add	a4,a4,a5
    5c7c:	fae689e3          	beq	a3,a4,5c2e <free+0x26>
  } else
    p->s.ptr = bp;
    5c80:	e394                	sd	a3,0(a5)
  freep = p;
    5c82:	00003717          	auipc	a4,0x3
    5c86:	8ef73b23          	sd	a5,-1802(a4) # 8578 <freep>
}
    5c8a:	6422                	ld	s0,8(sp)
    5c8c:	0141                	addi	sp,sp,16
    5c8e:	8082                	ret

0000000000005c90 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5c9c:	e852                	sd	s4,16(sp)
    5c9e:	e456                	sd	s5,8(sp)
    5ca0:	e05a                	sd	s6,0(sp)
    5ca2:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5ca4:	02051493          	slli	s1,a0,0x20
    5ca8:	9081                	srli	s1,s1,0x20
    5caa:	04bd                	addi	s1,s1,15
    5cac:	8091                	srli	s1,s1,0x4
    5cae:	0014899b          	addiw	s3,s1,1
    5cb2:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5cb4:	00003517          	auipc	a0,0x3
    5cb8:	8c453503          	ld	a0,-1852(a0) # 8578 <freep>
    5cbc:	c515                	beqz	a0,5ce8 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5cbe:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5cc0:	4798                	lw	a4,8(a5)
    5cc2:	02977f63          	bgeu	a4,s1,5d00 <malloc+0x70>
    5cc6:	8a4e                	mv	s4,s3
    5cc8:	0009871b          	sext.w	a4,s3
    5ccc:	6685                	lui	a3,0x1
    5cce:	00d77363          	bgeu	a4,a3,5cd4 <malloc+0x44>
    5cd2:	6a05                	lui	s4,0x1
    5cd4:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cd8:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cdc:	00003917          	auipc	s2,0x3
    5ce0:	89c90913          	addi	s2,s2,-1892 # 8578 <freep>
  if(p == (char*)-1)
    5ce4:	5afd                	li	s5,-1
    5ce6:	a88d                	j	5d58 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5ce8:	00009797          	auipc	a5,0x9
    5cec:	0b078793          	addi	a5,a5,176 # ed98 <base>
    5cf0:	00003717          	auipc	a4,0x3
    5cf4:	88f73423          	sd	a5,-1912(a4) # 8578 <freep>
    5cf8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5cfa:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5cfe:	b7e1                	j	5cc6 <malloc+0x36>
      if(p->s.size == nunits)
    5d00:	02e48b63          	beq	s1,a4,5d36 <malloc+0xa6>
        p->s.size -= nunits;
    5d04:	4137073b          	subw	a4,a4,s3
    5d08:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d0a:	1702                	slli	a4,a4,0x20
    5d0c:	9301                	srli	a4,a4,0x20
    5d0e:	0712                	slli	a4,a4,0x4
    5d10:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d12:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d16:	00003717          	auipc	a4,0x3
    5d1a:	86a73123          	sd	a0,-1950(a4) # 8578 <freep>
      return (void*)(p + 1);
    5d1e:	01078513          	addi	a0,a5,16
    ...
    5d2c:	6a42                	ld	s4,16(sp)
    5d2e:	6aa2                	ld	s5,8(sp)
    5d30:	6b02                	ld	s6,0(sp)
    5d32:	6121                	addi	sp,sp,64
    5d34:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d36:	6398                	ld	a4,0(a5)
    5d38:	e118                	sd	a4,0(a0)
    5d3a:	bff1                	j	5d16 <malloc+0x86>
  hp->s.size = nu;
    5d3c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d40:	0541                	addi	a0,a0,16
    5d42:	00000097          	auipc	ra,0x0
    5d46:	ec6080e7          	jalr	-314(ra) # 5c08 <free>
  return freep;
    5d4a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d4e:	d971                	beqz	a0,5d22 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d50:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d52:	4798                	lw	a4,8(a5)
    5d54:	fa9776e3          	bgeu	a4,s1,5d00 <malloc+0x70>
    if(p == freep)
    5d58:	00093703          	ld	a4,0(s2)
    5d5c:	853e                	mv	a0,a5
    5d5e:	fef719e3          	bne	a4,a5,5d50 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5d62:	8552                	mv	a0,s4
    5d64:	00000097          	auipc	ra,0x0
    5d68:	b76080e7          	jalr	-1162(ra) # 58da <sbrk>
  if(p == (char*)-1)
    5d6c:	fd5518e3          	bne	a0,s5,5d3c <malloc+0xac>
        return 0;
    5d70:	4501                	li	a0,0
    5d72:	bf45                	j	5d22 <malloc+0x92>
