...
go(int which_child)
{
  ...
  int fd = -1;
     ...
     100:	5b4a0a13          	addi	s4,s4,1460 # 16b0 <buf.1243>
    ...
    if(what == 1){
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1243+0xcb>
...
0000000000000f16 <sched_statistics>:
