...
int main(int argc, char *argv[]){
  ...
  18:	35e080e7          	jalr	862(ra) # 372 <info>
	info(1);
  1c:	4505                	li	a0,1
  1e:	00000097          	auipc	ra,0x0
  22:	354080e7          	jalr	852(ra) # 372 <info>
	info(input);
  26:	8526                	mv	a0,s1
  28:	00000097          	auipc	ra,0x0
  2c:	34a080e7          	jalr	842(ra) # 372 <info>
	info(2);
  30:	4509                	li	a0,2
  32:	00000097          	auipc	ra,0x0
  36:	340080e7          	jalr	832(ra) # 372 <info>
	info(3);
  3a:	450d                	li	a0,3
  3c:	00000097          	auipc	ra,0x0
  40:	336080e7          	jalr	822(ra) # 372 <info>
	exit(0);
  44:	4501                	li	a0,0
  46:	00000097          	auipc	ra,0x0
  4a:	28c080e7          	jalr	652(ra) # 2d2 <exit>
	if (argc >= 2) input = atoi(argv[1]);
  4e:	6588                	ld	a0,8(a1)
  50:	00000097          	auipc	ra,0x0
  54:	182080e7          	jalr	386(ra) # 1d2 <atoi>
  58:	84aa                	mv	s1,a0
...
0000000000000382 <sched_statistics>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d2:	44250513          	addi	a0,a0,1090 # 810 <digits>
 3d6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49e:	376b8b93          	addi	s7,s7,886 # 810 <digits>
 ...
 5de:	22e90913          	addi	s2,s2,558 # 808 <malloc+0xe8>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a6:	1867b783          	ld	a5,390(a5) # 828 <freep>
 ...
 6d4:	00e6ea63          	bltu	a3,a4,6e8 <free+0x50>
{
 ...
 716:	10f73b23          	sd	a5,278(a4) # 828 <freep>
}
 71a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 748:	0e453503          	ld	a0,228(a0) # 828 <freep>
 ...
 770:	0bc90913          	addi	s2,s2,188 # 828 <freep>
  if(p == (char*)-1)
 774:	5afd                	li	s5,-1
 ...
 784:	0af73423          	sd	a5,168(a4) # 828 <freep>
 788:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7aa:	08a73123          	sd	a0,130(a4) # 828 <freep>
      return (void*)(p + 1);
